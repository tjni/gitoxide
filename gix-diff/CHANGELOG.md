 ...
 * **Uncategorized**
    ...
    - Merge pull request #2164 from GitoxideLabs/improvements ([`382dc5d`](https://github.com/yuki0iq/gitoxide/commit/382dc5dc02c3e0631489d7eed1431f5da1cb611c))
    - Make non-UTF8 unified diffs possible again. ([`e4eb98e`](https://github.com/yuki0iq/gitoxide/commit/e4eb98e2dc0d77d54e23b29113d0294e0e005553))
    ...
    - Compare symlinks with blobs as long as these aren't read from the worktree (without support) ([`f4e630f`](https://github.com/yuki0iq/gitoxide/commit/f4e630f3c6732144397b44763979a6e8f844872d))
    - Merge pull request #2102 from cruessler/split-unified-diff ([`f7f087c`](https://github.com/yuki0iq/gitoxide/commit/f7f087cb7b2d239688203f58d166fde42d4bde8c))
    - Refactor ([`91a611f`](https://github.com/yuki0iq/gitoxide/commit/91a611fbdb4005546eca814e4b62267798919994))
    - Add `DiffLineType` and `HunkHeader` ([`0924bd3`](https://github.com/yuki0iq/gitoxide/commit/0924bd30cbec5b47b604f159a1efee72032740a6))
    ...
    - Merge pull request #2085 from GitoxideLabs/improvements ([`9946611`](https://github.com/yuki0iq/gitoxide/commit/994661173b71f9a61c119d3ee22237a931a03ea9))
    - Textconf programs are now always run through a shell. ([`ec26d32`](https://github.com/yuki0iq/gitoxide/commit/ec26d3287f6b81daccf068d944966e216ea98d12))
...
<csr-read-only-do-not-edit/>
 ...
 - 1 unique issue was worked on: [#2011](https://github.com/yuki0iq/gitoxide/issues/2011)
 ...
 * **[#2011](https://github.com/yuki0iq/gitoxide/issues/2011)**
    - Remove `blob::GitDiff` Sink as it doesn't work concistently. ([`4f27179`](https://github.com/yuki0iq/gitoxide/commit/4f271796041655d80ab0435a76281446e21ad8cd))
 * **Uncategorized**
    ...
    - Merge pull request #2072 from GitoxideLabs/fix-unidiff ([`f87967d`](https://github.com/yuki0iq/gitoxide/commit/f87967d4983f96133d184eff9d689a333c819958))
    - Reproduce unified diff issue ([`5e64298`](https://github.com/yuki0iq/gitoxide/commit/5e64298ba4864636779ae72e301475e9cfe01ac8))
    - Thanks clippy ([`79b8f06`](https://github.com/yuki0iq/gitoxide/commit/79b8f0656e34e5099cf09ecd9a9bf569f24c7c0b))
    - Reference new methods in docs for `ChangeRef::field()` ([`fad0118`](https://github.com/yuki0iq/gitoxide/commit/fad0118b53dbd9a18ee80e76b16f2b732496ac73))
    - Add explicit accessors for common fields ([`bd01893`](https://github.com/yuki0iq/gitoxide/commit/bd0189360152325b3d0eb8a19a1c96af938071b1))
    - Merge pull request #2043 from GitoxideLabs/fix-unidiff ([`08e7777`](https://github.com/yuki0iq/gitoxide/commit/08e7777454bdce466363321fce7b168d425bb833))
    - `blob::UnifiedDiff` now produces non-overlapping hunks. ([`0d102f4`](https://github.com/yuki0iq/gitoxide/commit/0d102f4bdf1450f9c5f8d4176707c73b499bd665))
    - Merge pull request #2017 from GitoxideLabs/improvements ([`3094214`](https://github.com/yuki0iq/gitoxide/commit/309421424fa02037f7609fc4ca0c03a99909cdb6))
    - Improve rename tracking performance characteristics to make exponential runtime less likely. ([`0eaced9`](https://github.com/yuki0iq/gitoxide/commit/0eaced934a4d52d80d680222fc0c9f7aae74f056))
    - Merge pull request #2011 from blinxen/main ([`fd49eee`](https://github.com/yuki0iq/gitoxide/commit/fd49eeeb850ea3c3956ca15be2bf4e04a3d319ad))
    - Make `GitDiff` compatible to strings and bytes. ([`5505646`](https://github.com/yuki0iq/gitoxide/commit/55056467e8b1d2ee327e4f29df058224fb64db5e))
    - Refactor ([`5e699d2`](https://github.com/yuki0iq/gitoxide/commit/5e699d26846740ee098e780bb2b861fcae2d31ca))
    - Add `Sink` that implements git's diffing improvement heuristics ([`c84296b`](https://github.com/yuki0iq/gitoxide/commit/c84296b98876539e1b21072f32c0339932215f42))
    - Update `imara-diff` to the latest version. ([`732adb8`](https://github.com/yuki0iq/gitoxide/commit/732adb87c90283bd8f8fce6d633eacc25e10b353))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1913 from GitoxideLabs/improvements ([`5fa79d9`](https://github.com/yuki0iq/gitoxide/commit/5fa79d90ee97009e7368c359278f76f715518423))
    - Blob diff resources and outcomes now inform about the usage of text-conv filters. ([`c70d912`](https://github.com/yuki0iq/gitoxide/commit/c70d912fabfa7bbda185bc390fb3ea304173e5dc))
    ...
    - Make `blob::Platform::filter_mode` public. ([`807c2de`](https://github.com/yuki0iq/gitoxide/commit/807c2de44317cf4649684e0ce6ec26db8bea2136))
    ...
    - `blob::UnifiedDiff::new(...newline...)` is now an Enum. ([`1091e29`](https://github.com/yuki0iq/gitoxide/commit/1091e29c06a8682b761fe54bf18ae7e40121aa51))
    ...
    - Add `blob::UnifiedDiff` as Sink to build unified diffs. ([`1ccbeef`](https://github.com/yuki0iq/gitoxide/commit/1ccbeef894e92d770ac0207d92b8e0f6686c3360))
    - Add `imara-diff::UnifiedDiffBuilder` as basis. ([`df7a926`](https://github.com/yuki0iq/gitoxide/commit/df7a9261e146939846ce49c553172e23fbce471e))
 ...
 * **Uncategorized**
    ...
    - Remove `index::Change::Unmerged` as it doesn't matter to Git either. ([`0963abe`](https://github.com/yuki0iq/gitoxide/commit/0963abe3050ae1fdf807af3b74be62da8a5b0319))
    ...
    - Add `index()` to diff two indices ([`3b8c971`](https://github.com/yuki0iq/gitoxide/commit/3b8c9711dac45d317781b571062ae7448b076e50))
 ...
 * **Uncategorized**
    ...
    - Add support for not tracking single empty files. ([`d3f5f27`](https://github.com/yuki0iq/gitoxide/commit/d3f5f27732ec5dfb496a3f9d0dd17a3a79d408f3))
    - Enforce `diff.renamelimit` even for identical name matching ([`d281ba6`](https://github.com/yuki0iq/gitoxide/commit/d281ba6b180d052aa6df43f43696a84819218d4d))
 ...
 * **Uncategorized**
    ...
    - Add `tree_with_rewrites::Change(Ref)::source_mode_and_id|mode_and_id()` ([`5db2d2d`](https://github.com/yuki0iq/gitoxide/commit/5db2d2d8eef8570a42f9c040a7cdb341a71f7192))
    ...
    - `tree()` diffing now also recognizes merge mode changes as modification. ([`e00e454`](https://github.com/yuki0iq/gitoxide/commit/e00e454ed6d6152d7926e4bd23e1bc2fcc628de0))
    ...
    - Support rename tracking across changed directories ([`ba7b811`](https://github.com/yuki0iq/gitoxide/commit/ba7b811bdfc8cba7b3622360749bfc4d927d974c))
    - Add traits for partial equality comparison to `tree_with_rewrites::Change` types ([`6740520`](https://github.com/yuki0iq/gitoxide/commit/674052002a781889d9b308ebd782f4f3cf5f41e8))
    - Add `tree_with_rewrites::Change(Ref)::previous_location()` ([`76e6762`](https://github.com/yuki0iq/gitoxide/commit/76e6762db493e10883b2dd332c7715e6f5524fd0))
    - Allow access to `tree::State::buf1|2`. ([`eb55c00`](https://github.com/yuki0iq/gitoxide/commit/eb55c00be63960a7999978eef3f49d58bb10707c))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1628 from EliahKagan/update-git-cmp-rs-url ([`4cff32c`](https://github.com/yuki0iq/gitoxide/commit/4cff32cdca1197cd3ed442fc3d35770c2436bda8))
    - Update "cmp" links in `tree::function::diff` ([`991c939`](https://github.com/yuki0iq/gitoxide/commit/991c9391541d1a4ff3d3e135884139e706fa5f51))
    ...
    - Provide facilities to perform rewrite-tracking for tree-diffs in plumbing. ([`f2e813d`](https://github.com/yuki0iq/gitoxide/commit/f2e813d8712f245f7f93ecae2a3da768dd6dc2db))
    - Add `tree()` function to diff a tree. ([`989276f`](https://github.com/yuki0iq/gitoxide/commit/989276fa12cac8682fbcbdf52a945d41cb922a3f))
    ...
    - Better handling and tracking of directory renames ([`cebef0b`](https://github.com/yuki0iq/gitoxide/commit/cebef0bbfb6b64ce9c1a3ea3b8fd36e6121b1f1c))
    ...
    - Sketch the entire API surface to capture all parts of blob-merges ([`9efa09f`](https://github.com/yuki0iq/gitoxide/commit/9efa09f10d042dc4d5db4edf4589594450a30b31))
    - Add `blob::pipeline::WorktreeRoots::is_unset()` ([`fe7ecd0`](https://github.com/yuki0iq/gitoxide/commit/fe7ecd00c7c7091ea0225a5c437abeca85ce0dca))
...
<csr-read-only-do-not-edit/>
 ...
 - 2 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#1524](https://github.com/yuki0iq/gitoxide/issues/1524)
 ...
 * **Uncategorized**
    ...
    - Add `blob::Platform::clear_resource_cache_keep_allocation()`. ([`7f868d1`](https://github.com/yuki0iq/gitoxide/commit/7f868d1e808656179a4c996ab586abceee952093))
    ...
    - Set the minimal version of `imara-diff` to the one that fixes a potential issue with pointers ([`55cffe4`](https://github.com/yuki0iq/gitoxide/commit/55cffe4ecf78bfea76059b742fafaebe964a725f))
</details>
 ...
 * **Uncategorized**
    ...
    - Merge branch 'heredocs' ([`36f221b`](https://github.com/yuki0iq/gitoxide/commit/36f221b3157a82daf1c85dc3bc79e2b179a72458))
    - Update archive which apparently changed ([`e6c8cd6`](https://github.com/yuki0iq/gitoxide/commit/e6c8cd649b65b4474bb7c874196ce59df8ddf583))
 ...
 * **Uncategorized**
    ...
    - Revert a typo ([`9680e57`](https://github.com/yuki0iq/gitoxide/commit/9680e57952d8d6389c77bde6fa8de34592aa09a8))
 ...
 * **Uncategorized**
    ...
    - Provide more source information when emitting rewrites. ([`e20b6b1`](https://github.com/yuki0iq/gitoxide/commit/e20b6b1b9e767a07c5bc135c45cf7dccc878b99c))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 0 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#1224](https://github.com/yuki0iq/gitoxide/issues/1224)
 ...
 * **[#1224](https://github.com/yuki0iq/gitoxide/issues/1224)**
    - Adjust debug assertion to count blobs and executables ([`0878344`](https://github.com/yuki0iq/gitoxide/commit/08783444b1db885706e686d19bd9d55403c2df7f))
 * **Uncategorized**
 ...
 * **Uncategorized**
    ...
    - Fix dependency declaration of `gix-tempfile` in `gix-diff` ([`0afe927`](https://github.com/yuki0iq/gitoxide/commit/0afe927be49d3f44503534c2a0bdffcf133dd5aa))
 ...
 * **Uncategorized**
    ...
    - Assure binary-detection also works if ODB files are below the big-file threshold. ([`223278d`](https://github.com/yuki0iq/gitoxide/commit/223278d31dbad6308b1c49d583fbfcd02846820e))
    ...
    - Rewrite-tracker now uses blob diff-platform for correct and optimized diffing. ([`feca5d0`](https://github.com/yuki0iq/gitoxide/commit/feca5d0c1f56321d8fe15d59003195bf2f276c35))
    - Add `blob::Platform` and `blob::Pipeline` for diff-content conversions and caching. ([`ebe66db`](https://github.com/yuki0iq/gitoxide/commit/ebe66dbc5720bb47a6c3810333060e17d6b58085))
    ...
    - Provider new rename-tracking faciliites. ([`e2745fd`](https://github.com/yuki0iq/gitoxide/commit/e2745fd20203bf26a30b563f2817e342df7c4742))
    ...
    - Use `gix-object::Find` trait ([`2637f8f`](https://github.com/yuki0iq/gitoxide/commit/2637f8f7b169b3e0d925eee0c52c5cdb974f7411))
 ...
 * **Uncategorized**
    ...
    - Make blob-diffing a feature so it can be turned off by adding the `blob` feature (enabled by default) ([`7766cf9`](https://github.com/yuki0iq/gitoxide/commit/7766cf91d28fe9a602048bd15a49632752173604))
 ...
 * **Uncategorized**
    ...
    - Fix CI on windows ([`79ed875`](https://github.com/yuki0iq/gitoxide/commit/79ed8752451ce621cf1ee69d3ca15deae3416798))
</details>
 ...
 * **Uncategorized**
    ...
    - `tree::Recorder::track_location()` to track no location or filenames only. ([`2ad0e8b`](https://github.com/yuki0iq/gitoxide/commit/2ad0e8b984a874e0a591b01e9d46f2f24a541a97))
    - Add `tree::visit::Change::(oid_and_mode|mode)()` methods. ([`507196e`](https://github.com/yuki0iq/gitoxide/commit/507196e63875100e705573f3b4aab110b7876852))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 13 unique issues were worked on: [#198](https://github.com/yuki0iq/gitoxide/issues/198), [#222](https://github.com/yuki0iq/gitoxide/issues/222), [#254](https://github.com/yuki0iq/gitoxide/issues/254), [#266](https://github.com/yuki0iq/gitoxide/issues/266), [#279](https://github.com/yuki0iq/gitoxide/issues/279), [#298](https://github.com/yuki0iq/gitoxide/issues/298), [#301](https://github.com/yuki0iq/gitoxide/issues/301), [#364](https://github.com/yuki0iq/gitoxide/issues/364), [#384](https://github.com/yuki0iq/gitoxide/issues/384), [#450](https://github.com/yuki0iq/gitoxide/issues/450), [#470](https://github.com/yuki0iq/gitoxide/issues/470), [#691](https://github.com/yuki0iq/gitoxide/issues/691), [#XXX](https://github.com/yuki0iq/gitoxide/issues/XXX)
 ...
 * **[#279](https://github.com/yuki0iq/gitoxide/issues/279)**
    - Adapt to changes to `git-odb` ([`5b0e2b9`](https://github.com/yuki0iq/gitoxide/commit/5b0e2b927eac75548d5a9f3cf302aa5eda70a795))
 ...
 * **[#301](https://github.com/yuki0iq/gitoxide/issues/301)**
    ...
    - Adjust for different errors on windows when handling errors opening files… ([`9625829`](https://github.com/yuki0iq/gitoxide/commit/962582996bb8d53739393acfcd150e9aa5132bae))
 * **[#364](https://github.com/yuki0iq/gitoxide/issues/364)**
    ...
    - Adjust to breaking changes in `git-traverse` ([`d79b506`](https://github.com/yuki0iq/gitoxide/commit/d79b5064eab2d1bef445e6c9e62a53466a8d5225))
 ...
 * **[#450](https://github.com/yuki0iq/gitoxide/issues/450)**
    - Fix docs ([`60c136c`](https://github.com/yuki0iq/gitoxide/commit/60c136ca38c6ad0cd7e0ea5e3e0e83bb828a9c94))
 * **[#470](https://github.com/yuki0iq/gitoxide/issues/470)**
    ...
    - Forward line-diffing capabilities curtesy of the `similar` crate. ([`e164856`](https://github.com/yuki0iq/gitoxide/commit/e164856ab8d80c13b082a283b4c73b6fb31968f6))
    - Improved usability of the `Action` enum ([`d04807b`](https://github.com/yuki0iq/gitoxide/commit/d04807bc9a70ddb6139446356df5c1bdb902a497))
 ...
 * **Uncategorized**
    ...
    - Rename `git-diff` to `gix-diff` ([`95cce04`](https://github.com/yuki0iq/gitoxide/commit/95cce049a31e2f3cf57fa24ca7d17074eed294ec))
    ...
    - Unify test crate names to use the plural ([`234ec14`](https://github.com/yuki0iq/gitoxide/commit/234ec1458f20794502b02732513875547768280f))
    ...
    - Re-export the `imara-diff` crate as `git_diff::blob::*`. ([`16b5533`](https://github.com/yuki0iq/gitoxide/commit/16b553367518153b8f5b0bb6b23d2fcefcaac801))
    - Remove `text::with(…)` as it's not usable in practice. ([`68a3365`](https://github.com/yuki0iq/gitoxide/commit/68a336502351ce16b804e7c099479bc974c3787c))
    - Show how the current API isn't actually working well ([`bd971e7`](https://github.com/yuki0iq/gitoxide/commit/bd971e7aedc30285f183f4470b2fafba9236c6c4))
    - Refactor ([`395a590`](https://github.com/yuki0iq/gitoxide/commit/395a5902b803174e18a53df6079095d25cb2fc8e))
    ...
    - Adjust docs ([`381924c`](https://github.com/yuki0iq/gitoxide/commit/381924c3fc84277b6f9c4713540f8cda449e8ad2))
    ...
    - Merge branch 'imra-diff' ([`f53f942`](https://github.com/yuki0iq/gitoxide/commit/f53f9426f206686b30abd73a201a92b1405e782d))
    - Rename `lines` module to `text`. ([`fed47d4`](https://github.com/yuki0iq/gitoxide/commit/fed47d45b7e39958921a230b485b5b0384c8672f))
    - Replace `similar` with `imara-diff`. ([`ee26ddf`](https://github.com/yuki0iq/gitoxide/commit/ee26ddfe645ca39024795f85bb8e1cab6b6f5863))
    ...
    - More standard derives for `Change` type ([`8e46f54`](https://github.com/yuki0iq/gitoxide/commit/8e46f547f510a6453d0304a8a41eaf9bbf3b17a3))
    ...
    - Merge branch 'main' into filter-refs-by-spec ([`51dc828`](https://github.com/yuki0iq/gitoxide/commit/51dc8282fb77b519ff7d2c94c6bd73af306cfe8b))
    - Release git-diff v0.18.1, git-discover v0.4.2, git-traverse v0.16.4, git-repository v0.23.1 ([`2571831`](https://github.com/yuki0iq/gitoxide/commit/2571831e5939bf4ea6f19537b0c1ccd71dc99088))
    - Prepare changelog  prior to release ([`fc6b958`](https://github.com/yuki0iq/gitoxide/commit/fc6b9583d0534f70e0c8afdcad46e09a5001d62b))
    - Fix docs ([`34e899a`](https://github.com/yuki0iq/gitoxide/commit/34e899ae0e4a23bba6dc36dfd7429c0d572736bd))
    ...
    - Don't degenerate errors when accessing objects ([`6d9533d`](https://github.com/yuki0iq/gitoxide/commit/6d9533dd987241fe0ddf0e401512ca6bdf0d3ff0))
    - Use thiserror instead of quickerror ([`0661d48`](https://github.com/yuki0iq/gitoxide/commit/0661d4877978ce17117233f6116be1f7b512f449))
    - Fix docs ([`bfdcb13`](https://github.com/yuki0iq/gitoxide/commit/bfdcb13b11faae161c3e3f5d20c83d41a91b9de9))
    ...
    - Revert archive back to original ([`ef905d4`](https://github.com/yuki0iq/gitoxide/commit/ef905d41053e3f08c9eca9eeaac078d2d2650271))
    ...
    - Remove left-over attribute ([`27df580`](https://github.com/yuki0iq/gitoxide/commit/27df580b1f7b3a096f759763cda7042825abcfca))
    ...
    - Release git-diff v0.9.2 ([`17c411f`](https://github.com/yuki0iq/gitoxide/commit/17c411f7679f4386eb3225c56dac80084787ed2b))
    - Bump git-object v0.14.0 ([`d4fc81f`](https://github.com/yuki0iq/gitoxide/commit/d4fc81f6390443f8c8561d91ac27ea4a6318fb62))
    - Release git-diff v0.9.1 ([`cedae8d`](https://github.com/yuki0iq/gitoxide/commit/cedae8d61f44a2de46edbac8afe19b7d8fa15cbf))
    ...
    - Release git-diff v0.8.2 ([`3ad0829`](https://github.com/yuki0iq/gitoxide/commit/3ad082939c52cfd6d679ebefcbaea4b16b12cfdb))
    - Apply nightly rustfmt rules. ([`5e0edba`](https://github.com/yuki0iq/gitoxide/commit/5e0edbadb39673d4de640f112fa306349fb11814))
    - Release git-diff v0.8.1 ([`41b218f`](https://github.com/yuki0iq/gitoxide/commit/41b218f456ceea448d3b6a524e05970c478bdf6b))
    ...
    - (cargo-release) version 0.4.1 ([`9790c15`](https://github.com/yuki0iq/gitoxide/commit/9790c1590ec7180b76241b9f5ad7711d13abc7cc))
    ...
    - Refactor ([`a92f1e6`](https://github.com/yuki0iq/gitoxide/commit/a92f1e68beb0f946d0e117934b244d5aa1b6b5fc))
    ...
    - [git-traverse] fix potential lifetime issue ([`fcf2e8f`](https://github.com/yuki0iq/gitoxide/commit/fcf2e8fb5356e5d4fb541347a9ca37306362815a))
    - [git-diff] refactor ([`fa8b4e8`](https://github.com/yuki0iq/gitoxide/commit/fa8b4e8549c5992b8e622979aba3d11a6197bcc3))
    - [git-diff] refactor ([`9373cd6`](https://github.com/yuki0iq/gitoxide/commit/9373cd6281b679d556255893ab0252e33bb86e77))
    - [git-diff] refactor ([`087e853`](https://github.com/yuki0iq/gitoxide/commit/087e85367c27bb3684c6ad543c7eae46762e5e44))
    - (cargo-release) version 0.4.0 ([`c85d59a`](https://github.com/yuki0iq/gitoxide/commit/c85d59a9a63d3cb503d906dcbeff2e585e4397e4))
    - [git-diff] enforce greater restraint when using path-ids ([`ad89320`](https://github.com/yuki0iq/gitoxide/commit/ad893203912d60f382dab66bcd38e2fc312b7246))
    ...
    - (cargo-release) version 0.3.0 ([`3f2f8de`](https://github.com/yuki0iq/gitoxide/commit/3f2f8de01088f8bf09ff04443534db513c522f6c))
    - (cargo-release) version 0.2.0 ([`3fb8377`](https://github.com/yuki0iq/gitoxide/commit/3fb8377ff36422fe7607fb9172edf8bd5a4db995))
    - (cargo-release) version 0.9.0 ([`84897fd`](https://github.com/yuki0iq/gitoxide/commit/84897fd8e6e1b0269da0303d6a0de8f9e0eb58e5))
    - Refactor ([`082f8d0`](https://github.com/yuki0iq/gitoxide/commit/082f8d0a4219246050d4594ba8cf769c8f5cdc90))
    - [traverse-tree] one test to pin implementation down a little ([`f0aeee1`](https://github.com/yuki0iq/gitoxide/commit/f0aeee1ca3d9c0fd1290c1912226c7dae396e10b))
    - Refactor ([`cceff1c`](https://github.com/yuki0iq/gitoxide/commit/cceff1cf5297a6e507f8b44672181ba2600c748c))
    - (cargo-release) version 0.14.0 ([`d9514ee`](https://github.com/yuki0iq/gitoxide/commit/d9514eec64579ef77c9f2ac5dfe87cd302180eb9))
    - (cargo-release) version 0.2.0 ([`ca48e06`](https://github.com/yuki0iq/gitoxide/commit/ca48e06b19076db961d81f8759ae564d5a5b7f6c))
    ...
    - Refactor ([`6e6453d`](https://github.com/yuki0iq/gitoxide/commit/6e6453d9e044499c9ee0a85d79dd75906adb9fb8))
    - [traversal] Add remaining missing docs ([`2f573f3`](https://github.com/yuki0iq/gitoxide/commit/2f573f39c47879f7f318be9efa357e10a9e14ed2))
    - Refactor ([`c0318cf`](https://github.com/yuki0iq/gitoxide/commit/c0318cfa13dc32cf6c01879feae60158bc46d708))
    - Git-diff docs ([`76af15b`](https://github.com/yuki0iq/gitoxide/commit/76af15b708842fd0adaef6f685fd40101e8f7d72))
    ...
    - [traversal] experiment uses git-traverse ([`3609356`](https://github.com/yuki0iq/gitoxide/commit/360935640cbae5b691dcd976422bf00f9768e1c0))
    - [changes] more flexible handle of state ([`11db16b`](https://github.com/yuki0iq/gitoxide/commit/11db16b585e7551fa0d85644ee085b95a9dc2c1e))
    - A new crate: git-traverse ([`1a9af50`](https://github.com/yuki0iq/gitoxide/commit/1a9af50f1fca0e7e939f339b885c66dcb95e44e5))
    - Git-diff - fix include directive ([`c684382`](https://github.com/yuki0iq/gitoxide/commit/c684382f5cac8c667a0a19b9b2cc95bd32d025d5))
    ...
    - (cargo-release) version 0.1.0 ([`cb7b667`](https://github.com/yuki0iq/gitoxide/commit/cb7b667255eafb6e378569892f47574533a698dc))
    - [traversal] run libgit2 parallel first to have a chance to get data more quickly ([`0a3564d`](https://github.com/yuki0iq/gitoxide/commit/0a3564d5e949e328ee2923ee1b96a5d369102f9b))
    ...
    - [tree-diff] another test, but no new outcome except that it seems to work ([`e295b53`](https://github.com/yuki0iq/gitoxide/commit/e295b539df0bb3e4ae7093f09d6dcda8326029c5))
    - [tree-diff] And another test that showed something was indeed wrong ([`362680f`](https://github.com/yuki0iq/gitoxide/commit/362680ff77f00dd305939090cb903003ff7be679))
    - Refactor ([`85c5781`](https://github.com/yuki0iq/gitoxide/commit/85c5781def8b45b01d4e46af97bbf24e1aa6da88))
    - Refactor ([`109c4e0`](https://github.com/yuki0iq/gitoxide/commit/109c4e0bf2ecb307da882d42584f769da19db02d))
    - Refactor ([`e7a7ee8`](https://github.com/yuki0iq/gitoxide/commit/e7a7ee81b0b40336671b28b7eecbac6ce40c4c23))
    - [tree-diff] Beginning of more nested test-suite… ([`b8a90e7`](https://github.com/yuki0iq/gitoxide/commit/b8a90e7c9347b0eefdbef6f4c724cc0561cd79c9))
    - [tree-diff] the last todo, gone by test ([`d7418f3`](https://github.com/yuki0iq/gitoxide/commit/d7418f3342319a31b3f591ecfe1d5d9b1b198e9c))
    - [tree-diff] consider that windows does do symlinks differently ([`b1b6e00`](https://github.com/yuki0iq/gitoxide/commit/b1b6e0014dd02b66db538a262c4a0f7f891870e5))
    - [tree-diff] another green test ([`2627df0`](https://github.com/yuki0iq/gitoxide/commit/2627df0bbb9da9eb8a3d1bdbe725fe35bf24071e))
    - [tree-diff] be independent on commit hashes ([`05e8e4a`](https://github.com/yuki0iq/gitoxide/commit/05e8e4a060d8e47e6d98e188d8a93b01947f8035))
    - [tree-diff] another green test ([`1bfa9da`](https://github.com/yuki0iq/gitoxide/commit/1bfa9daa95bf5a5643f3b70fdb8031e757ae1506))
    - [tree-diff] another green test ([`9ca57fa`](https://github.com/yuki0iq/gitoxide/commit/9ca57fa9bc7a52170d109b323b1b1a74172604c1))
    - [tree-diff] a new failing test ([`c6eb677`](https://github.com/yuki0iq/gitoxide/commit/c6eb6773f6768f3b24a4267ba2e0d3e6ce0aaa14))
    - Tree-diff] another test ([`1eb961c`](https://github.com/yuki0iq/gitoxide/commit/1eb961c8f22e8dc4a1988da09ce6521ca26fbfb4))
    - [tree-diff] less todos (that break tests if present) ([`03f87fe`](https://github.com/yuki0iq/gitoxide/commit/03f87fe4bfa002aec57a074c64835ceab120fee9))
    - [tree-diff] another test ([`b23012e`](https://github.com/yuki0iq/gitoxide/commit/b23012ebb943a0382b5cc3c2757a763f9183dda8))
    - [tree-diff] looks like windows now does line ending conversions for us ([`ff32a8f`](https://github.com/yuki0iq/gitoxide/commit/ff32a8f98d96a7fa28c7e0f4021d4a7ed7e30787))
    - [tree-diff] another green test ([`ec681da`](https://github.com/yuki0iq/gitoxide/commit/ec681da870e1677efc6c97dba35c1ccf21ea4724))
    - Refactor ([`d550936`](https://github.com/yuki0iq/gitoxide/commit/d5509369f509feddb1c3c10bae8b65c5dd3da35f))
    ...
    - [tree-diff] ManuallyDrop turns of drop behaviour, and I think it's Ok… ([`b885805`](https://github.com/yuki0iq/gitoxide/commit/b885805e9d9cf5a02635b86cd5f86db5bbf57a4e))
    - [tree-diff] [FAIL] try to use peekable()… ([`0dcdc0e`](https://github.com/yuki0iq/gitoxide/commit/0dcdc0efd59dda8a14db38c8a064d7caca9d1e0d))
    - [tree-diff] a step towards catching up with rhs ([`bbe7beb`](https://github.com/yuki0iq/gitoxide/commit/bbe7beb606071610f1506ab1f29456eb79f56f8b))
    - [tree-diff] more tests (none of which hits new code paths) ([`791c429`](https://github.com/yuki0iq/gitoxide/commit/791c4291926fd3aa2ab413d1058b2257976e8d87))
    - [tree-diff] deletion of directory and replacing it with a file ([`28e3fdd`](https://github.com/yuki0iq/gitoxide/commit/28e3fdd54036dcd4a227062e9db01017196c20e0))
    - [tree-diff] test modification within a directory ([`ff82a82`](https://github.com/yuki0iq/gitoxide/commit/ff82a82c1bd1b884afddea5baffb7448437561d1))
    - Thanks clippy ([`c223e31`](https://github.com/yuki0iq/gitoxide/commit/c223e31074d989024e22e8331eeb4280fb01cfab))
    - [tree-diff] The first example of recursion works ([`f86566c`](https://github.com/yuki0iq/gitoxide/commit/f86566c646d8c9a1bb0304508faecc0e2eb163d8))
    - Step towards zero-alloc traversal ([`f554c77`](https://github.com/yuki0iq/gitoxide/commit/f554c77b8371deb987e2365381b85dd6d4325b74))
    - Refactor ([`ca13594`](https://github.com/yuki0iq/gitoxide/commit/ca1359414c6dc0ca3f9052299c7f088d83b38777))
    - Refactor ([`aa1897d`](https://github.com/yuki0iq/gitoxide/commit/aa1897d870df3fb76193f7e4f33e135760732288))
    - Refactor ([`a717dba`](https://github.com/yuki0iq/gitoxide/commit/a717dbaaafcbb0869bd189f1b625e5ff84a9ae72))
    - Refactor ([`8087ca3`](https://github.com/yuki0iq/gitoxide/commit/8087ca3e856f2c5a9c409a94ff8b54fcf295c894))
    - Refactor ([`46583c1`](https://github.com/yuki0iq/gitoxide/commit/46583c1fff415f742466b93c0821b21e7c9e7e1c))
    - Refactor ([`fdc8c79`](https://github.com/yuki0iq/gitoxide/commit/fdc8c7975a67b332eff995ca8046cafdb3bbeae2))
    ...
    - Refactor ([`9ce9832`](https://github.com/yuki0iq/gitoxide/commit/9ce98322bc578832495082e8a9c147d12542262b))
    ...
    - [tree-diff] actually windows might have a point, let's see ([`0020a7c`](https://github.com/yuki0iq/gitoxide/commit/0020a7cc368ffc5b62d6618f94a4cdec36c6d512))
    - [tree-diff] detect modifications ([`b87f2b4`](https://github.com/yuki0iq/gitoxide/commit/b87f2b46783152964c24d6e7566a1787be60a932))
    - [tree-diff] See if this works on windows ([`95db1de`](https://github.com/yuki0iq/gitoxide/commit/95db1de95a585ac1fa8a185b201300e86e5f34da))
    - [tree-diff] the first succeeding test - additions ([`619d4f0`](https://github.com/yuki0iq/gitoxide/commit/619d4f05516ca0e54016b7ee8ab0433d6839ef7f))
    - Refactor ([`a4d5f99`](https://github.com/yuki0iq/gitoxide/commit/a4d5f99c8dc99bf814790928a3bf9649cd99486b))
    - Refactor ([`11018e1`](https://github.com/yuki0iq/gitoxide/commit/11018e1453ba6b130403f6d9f699881a93955c06))
    - [tree-diff] The first proper test with an API I like ([`ae6944e`](https://github.com/yuki0iq/gitoxide/commit/ae6944eaf874a7d52f1f061e5d0d0a4d642c20b5))
    - Refactor ([`633cba7`](https://github.com/yuki0iq/gitoxide/commit/633cba7c1ff1f63c32613bedf963d1bd89afaee1))
    - Refactor ([`3c10d06`](https://github.com/yuki0iq/gitoxide/commit/3c10d0613ec00606a678c65e05ab1fda0ef742f7))
    - Delegate-based tree diff traversal for maximum flexibility and performance ([`cbacca0`](https://github.com/yuki0iq/gitoxide/commit/cbacca0be8bc8cb968b26438fc2caf48a447c542))
    - Maybe avoid even more allocations? At the expense of usability. ([`230ef04`](https://github.com/yuki0iq/gitoxide/commit/230ef0447a56e9acd28efc6b71c5406e1b43653c))
    - Probably a good idea to just use a graph for now to avoid a huge trap ([`6b43cdc`](https://github.com/yuki0iq/gitoxide/commit/6b43cdca4749840fd179492bf9b7d7b9fb595814))
    - Sketch of how changes could actually be returned. ([`a48db50`](https://github.com/yuki0iq/gitoxide/commit/a48db50049657f8299423c8eaacc1d44da0a5b34))
    - Refactor ([`03ee510`](https://github.com/yuki0iq/gitoxide/commit/03ee510a5f9c24b6acddaec1d30ea3ad39174603))
    - Second sketch of 'fluid' diff API that hopefullly makes clear how it works ([`ef6d469`](https://github.com/yuki0iq/gitoxide/commit/ef6d469dfe22b8cdc816960b1be717483e3cdf8f))
    ...
    - Make sure releases of 'git-diff' don't get too big ([`378dde7`](https://github.com/yuki0iq/gitoxide/commit/378dde703978812c6ffa39b51a4a7edd19a903ba))
    - Frame for testing tree(&tree) diffing ([`28c78f5`](https://github.com/yuki0iq/gitoxide/commit/28c78f558e625f1d61bfa455f43bf6701e71703b))
    ...
    - Add git-diff crate ([`42fdd8d`](https://github.com/yuki0iq/gitoxide/commit/42fdd8d94b6fb65c1900cfef4f44dad619f7f09d))
</details>
