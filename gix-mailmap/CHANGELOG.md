 ...
 * **Uncategorized**
    ...
    - Error handling ([`577c54e`](https://github.com/yuki0iq/gitoxide/commit/577c54eb4d643634a85136f0695ceb71cbfa7b37))
 ...
 * **Uncategorized**
    ...
    - Merge branch 'push-oqpkttmvqxvx' ([`b38c6ed`](https://github.com/yuki0iq/gitoxide/commit/b38c6ed6714b89b52c98e2a4bba3198e23055f6f))
    - Add `mailmap::Snapshot::iter()` ([`c083f86`](https://github.com/yuki0iq/gitoxide/commit/c083f861f95c495c508ac6ca1aaeec465bb266b5))
    - Add a baseline for `entries()` to know more about its ordering. ([`ae2b9ce`](https://github.com/yuki0iq/gitoxide/commit/ae2b9ce37509f8adcf3f5af2d9dad738f6ea50cf))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 2 days passed between releases.
 - 1 commit was understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#1424](https://github.com/yuki0iq/gitoxide/issues/1424)
 ...
 * **[#1424](https://github.com/yuki0iq/gitoxide/issues/1424)**
    - Add standard traits (Debug, Eq) to `Snapshot` ([`98007e6`](https://github.com/yuki0iq/gitoxide/commit/98007e600095fcd4df48a0a4e75d2b342ef906e2))
 * **Uncategorized**
...
<csr-read-only-do-not-edit/>
 ...
 - 1 commit was understood as [conventional](https://www.conventionalcommits.org).
 - 2 unique issues were worked on: [#1416](https://github.com/yuki0iq/gitoxide/issues/1416), [#1417](https://github.com/yuki0iq/gitoxide/issues/1417)
 ...
 * **[#1416](https://github.com/yuki0iq/gitoxide/issues/1416)**
    - Reproduce mailmap parsing issue ([`8802c55`](https://github.com/yuki0iq/gitoxide/commit/8802c55087e6cfe9cb408e52f8a1eb1a6e2b4651))
 * **[#1417](https://github.com/yuki0iq/gitoxide/issues/1417)**
    - Allow mailmaps to change the email by name and email ([`ca05471`](https://github.com/yuki0iq/gitoxide/commit/ca054713f5aed6c66d55d612a58786eb0b439fb4))
 * **Uncategorized**
    ...
    - Merge branch 'fix-mailmap' ([`f107014`](https://github.com/yuki0iq/gitoxide/commit/f107014022a62271f02790a83336aed186ad38a3))
 ...
 * **Uncategorized**
    ...
    - Replace `quick-error` with `thiserror` ([`d09656b`](https://github.com/yuki0iq/gitoxide/commit/d09656bf1eeff0449ecd53b68988dc142a97193f))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 6 unique issues were worked on: [#301](https://github.com/yuki0iq/gitoxide/issues/301), [#364](https://github.com/yuki0iq/gitoxide/issues/364), [#366](https://github.com/yuki0iq/gitoxide/issues/366), [#450](https://github.com/yuki0iq/gitoxide/issues/450), [#470](https://github.com/yuki0iq/gitoxide/issues/470), [#691](https://github.com/yuki0iq/gitoxide/issues/691)
 ...
 * **[#364](https://github.com/yuki0iq/gitoxide/issues/364)**
    - More aggressive mailmap substitution for better results ([`600eb69`](https://github.com/yuki0iq/gitoxide/commit/600eb69132c24e15fde88ac5724ee5d2105be8df))
    - Adjust to changes in git-actor ([`e5c0200`](https://github.com/yuki0iq/gitoxide/commit/e5c02002467a6ad2ab2330cf6f38bcebabf4ba7c))
 * **[#366](https://github.com/yuki0iq/gitoxide/issues/366)**
    - `gix repository mailmap entries` ([`d2388d8`](https://github.com/yuki0iq/gitoxide/commit/d2388d8d80f379eccc9ee84ebe07acd67d154630))
    - Gix mailmap verify can now detect collisions ([`f89fe2f`](https://github.com/yuki0iq/gitoxide/commit/f89fe2f867fa792db5d9e003ce342a337a6ac973))
    - Verify universal line-endings are supported ([`f498dac`](https://github.com/yuki0iq/gitoxide/commit/f498dacfc34c3d0b7c3bdbf100e456ad3ade419e))
    - Fix email-only case ([`e31754d`](https://github.com/yuki0iq/gitoxide/commit/e31754d3d9c58f82ff4fad11ed7985dffc99b586))
    - Add all docs ([`1c768a5`](https://github.com/yuki0iq/gitoxide/commit/1c768a5511ba4e2f7f860b48429ddd3930a6b501))
    - Another test to validate correct merging and overwriting ([`deaeb7d`](https://github.com/yuki0iq/gitoxide/commit/deaeb7d1730d90d06789c47adad0e25f9b74fd13))
    - Add method to return borrowed values for new name/email ([`87fb932`](https://github.com/yuki0iq/gitoxide/commit/87fb932239e5f5a55046f8edb073373cd4957422))
    - Actual lookup and tests, all seems to be working ([`8116664`](https://github.com/yuki0iq/gitoxide/commit/81166646e3ecc9ab7383de62a0a216d0229c90bd))
    - Sketch `Snapshot` API to implement map building and signature resolution ([`1890db7`](https://github.com/yuki0iq/gitoxide/commit/1890db73b5fd66467c66efd9ddc365871041c7c3))
    - `Time::default()` ([`77ef2cb`](https://github.com/yuki0iq/gitoxide/commit/77ef2cb819f21ddc5d1ee9e94b5961e3ca5b3139))
    - Sketch of mailmap snapshot for lookups ([`d71d067`](https://github.com/yuki0iq/gitoxide/commit/d71d0670cd89a2dac2ea84cbc538f67fef3ee451))
    - Add typical malmap example ([`b67b0f9`](https://github.com/yuki0iq/gitoxide/commit/b67b0f90dd947508ab9ab0b7d68ce0093ae415ae))
    - Quickfix for unintentionally using 'unicode' feature of bytecode ([`fb5593a`](https://github.com/yuki0iq/gitoxide/commit/fb5593a7272498ae042b6c8c7605faa3d253fa10))
    - All tests (so far) green ([`67a2050`](https://github.com/yuki0iq/gitoxide/commit/67a2050156cc809767ca026f467f35b552bea043))
    - High-level parsing to deal with allowed mailmap lines ([`f458817`](https://github.com/yuki0iq/gitoxide/commit/f458817005b884e966bcc894a0cf7c9958882ba4))
    - Fix serde support ([`2fb4310`](https://github.com/yuki0iq/gitoxide/commit/2fb43102cf8bbfa9c26877d81d8fd3208fc5e183))
    - Basic testing of common cases for mailmap ([`903c526`](https://github.com/yuki0iq/gitoxide/commit/903c5263a26d9a57d9fa9dc6649ef4ad0a6e2a94))
    - The first empty test ([`fc47c49`](https://github.com/yuki0iq/gitoxide/commit/fc47c497f992e0f3fbef2f55d0e3b0909cac8290))
    - Empty git-mailmap crate ([`a30a5da`](https://github.com/yuki0iq/gitoxide/commit/a30a5da60d67a4e52ba69727318edb9832b7cae2))
 ...
 * **Uncategorized**
    ...
    - Rename `git-mailmap` to `gix-mailmap` ([`501231f`](https://github.com/yuki0iq/gitoxide/commit/501231fe0da6fdb62d644376e12d1947c6c133b5))
    ...
    - Thanks clippy ([`3925298`](https://github.com/yuki0iq/gitoxide/commit/39252985ff28d6801d09ef1d30e0e462c8277f8b))
    - Refactor ([`2f7ae74`](https://github.com/yuki0iq/gitoxide/commit/2f7ae74ff5f7d758da9e8edd4d805f5b58f01a00))
    - `Snapshot::resolve_cow()` allows to copy fields only if they change. ([`bd8f50b`](https://github.com/yuki0iq/gitoxide/commit/bd8f50bf56d98843a3e0d3c6e349451b623c51ae))
    ...
    - Thanks clippy ([`1038dab`](https://github.com/yuki0iq/gitoxide/commit/1038dab842b32ec1359a53236b241a91427ccb65))
    ...
    - Thanks clippy ([`9449bc7`](https://github.com/yuki0iq/gitoxide/commit/9449bc7243c15b3cba88f02a3742784d6fe6b363))
    - Refactor ([`3e78ff5`](https://github.com/yuki0iq/gitoxide/commit/3e78ff53125be2a75142534b6fd6f356b6bc8c5f))
    - Release git-mailmap v0.0.0 ([`c43af35`](https://github.com/yuki0iq/gitoxide/commit/c43af35c92e5093349cdabd89f655b26070e6f84))
</details>
