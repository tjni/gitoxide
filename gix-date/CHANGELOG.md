 ...
 * **Uncategorized**
    ...
    - Refactor ([`ca7800c`](https://github.com/yuki0iq/gitoxide/commit/ca7800c7a6756fc42dc5ca64c5bf3759792568b9))
    - Add parse_raw() ([`9c28f33`](https://github.com/yuki0iq/gitoxide/commit/9c28f3363c648e0fed88f5d63b2fac3aa4a545cf))
...
<csr-read-only-do-not-edit/>
 ...
 - 1 commit was understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#2095](https://github.com/yuki0iq/gitoxide/issues/2095)
 ...
 * **[#2095](https://github.com/yuki0iq/gitoxide/issues/2095)**
    - Don't parse any number as timestamp in `parse_header()` ([`ad67ab5`](https://github.com/yuki0iq/gitoxide/commit/ad67ab5bdea74f3c90c9670c8043f8b642a274d4))
 * **Uncategorized**
...
<csr-read-only-do-not-edit/>
 ...
 - 0 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 2 unique issues were worked on: [#1979](https://github.com/yuki0iq/gitoxide/issues/1979), [#1984](https://github.com/yuki0iq/gitoxide/issues/1984)
 ...
 * **[#1979](https://github.com/yuki0iq/gitoxide/issues/1979)**
    - Reproduce fuzz-failure ([`6bf1be6`](https://github.com/yuki0iq/gitoxide/commit/6bf1be67ba93c1b8e467e3c3127438d1eb43897e))
 * **[#1984](https://github.com/yuki0iq/gitoxide/issues/1984)**
    - Further upgrade `jiff` to fix fuzz failures ([`0be4dd4`](https://github.com/yuki0iq/gitoxide/commit/0be4dd4e037e8a3080ef335913e06bc2584fd96d))
 * **Uncategorized**
    ...
    - Merge pull request #1984 from GitoxideLabs/fuzz ([`f965540`](https://github.com/yuki0iq/gitoxide/commit/f965540c162ed3e23bd0d7ad9083093033647e51))
 ...
 * **Uncategorized**
    ...
    - Remove `Time::sign` field as it's not needed anymore to round-trip. ([`d559fa7`](https://github.com/yuki0iq/gitoxide/commit/d559fa7d96a06372855fdef3c7ab3a7083ba7172))
    ...
    - Turn `SignatureRef::time` field into `&str`. ([`57366d3`](https://github.com/yuki0iq/gitoxide/commit/57366d3ebd622af8927bb0e199ab8a3c0eafee99))
    - Apply feedback from discussion ([`70097c0`](https://github.com/yuki0iq/gitoxide/commit/70097c0feb481541ed96358842de96d6b1af24a9))
    - Expose parsing for Time ([`37367d7`](https://github.com/yuki0iq/gitoxide/commit/37367d708e0aea72bf3cef00808ab0069be0a606))
 ...
 * **Uncategorized**
    ...
    - Add regenerated `generate_git_date_baseline` archive ([`2dbd7ba`](https://github.com/yuki0iq/gitoxide/commit/2dbd7ba901245ec17ec9a966e435922fc859292a))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1702 from EliahKagan/run-ci/duration-units ([`b34d14e`](https://github.com/yuki0iq/gitoxide/commit/b34d14e83e546cbe423b12c63d5d80b3fedc42d2))
    - Add support for 'any' unit, when parsing `<count> <unit> ago`. ([`34d2fce`](https://github.com/yuki0iq/gitoxide/commit/34d2fce57e2836f758387b6cb54ee1f11bebd473))
    - Fix test expection for UTC relative dates ([`856b385`](https://github.com/yuki0iq/gitoxide/commit/856b38587afb7683d7d18837d9b88dd3debcc683))
    - Parse relative months and years ([`c95135b`](https://github.com/yuki0iq/gitoxide/commit/c95135b0d0168393f4ccca9863ade7efac8b3379))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1697 from EliahKagan/run-ci/duration ([`438ee47`](https://github.com/yuki0iq/gitoxide/commit/438ee4718b67d0eba8f4c6ebdfac64bd39f68ec7))
    - Test 12-week increments from 2 to 50 ([`ac17b62`](https://github.com/yuki0iq/gitoxide/commit/ac17b62a5c9d63606e9c161c1533cdbebf2de977))
    - Add even longer duration to test; run `cargo fmt` ([`5d51bd1`](https://github.com/yuki0iq/gitoxide/commit/5d51bd10f67bf4099ca832a5ca13de4e87fe0681))
    - Let `time::parse::relative::various` fail more often ([`04c82ca`](https://github.com/yuki0iq/gitoxide/commit/04c82cacfe9ee1a5a775c47c19361a0a5f0343a3))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1638 from tisonkun/allow-contructCustomFormat ([`bcdce6e`](https://github.com/yuki0iq/gitoxide/commit/bcdce6e873904e4dd77070d7b4e75f969b9f0bea))
    - Refactor ([`4910912`](https://github.com/yuki0iq/gitoxide/commit/4910912e2b4957350a7ab8169ba9de956e8d8325))
    - Add `CustomFormat::new()` to allow construction. ([`4b20bd1`](https://github.com/yuki0iq/gitoxide/commit/4b20bd1a8da30eb2ed88adb390e5cf7994779556))
...
<csr-read-only-do-not-edit/>
 ...
 - 1 unique issue was worked on: [#1485](https://github.com/yuki0iq/gitoxide/issues/1485)
 ...
 * **[#1485](https://github.com/yuki0iq/gitoxide/issues/1485)**
    - Don't panic on dates too far in the past when parsing them. ([`a729c4b`](https://github.com/yuki0iq/gitoxide/commit/a729c4b52242b9a8b02f3d0879bd481f23a3d719))
    - Reproduce fuzzer failure in `gix-date` ([`3a8b9e2`](https://github.com/yuki0iq/gitoxide/commit/3a8b9e2a8456985b4b444be421e9f0f61b08b7f1))
 * **Uncategorized**
    ...
    - Merge branch 'fix-fuzz' ([`3604a3b`](https://github.com/yuki0iq/gitoxide/commit/3604a3b519d76db367084ca49d395f6ec4094cf7))
    - Merge branch 'improvements' ([`12313f2`](https://github.com/yuki0iq/gitoxide/commit/12313f2720bb509cb8fa5d7033560823beafb91c))
    - Add more (but technically duplicate) tests for time parsing and formatting ([`9d5d8a6`](https://github.com/yuki0iq/gitoxide/commit/9d5d8a6551310f3ec28fc0cb3f0dd0bad4ffcde0))
    ...
    - Switch from `time` to `jiff` ([`28ac657`](https://github.com/yuki0iq/gitoxide/commit/28ac6572722f7ea31795dc0417521c70bcb6ec8f))
    - Bump MSRV to Rust 1.70 ([`1b9c30d`](https://github.com/yuki0iq/gitoxide/commit/1b9c30dfb43373a76f3b65ae90a74dc99a892821))
 ...
 * **Uncategorized**
    ...
    - Prepare release of `gix-mailmap` ([`14c3396`](https://github.com/yuki0iq/gitoxide/commit/14c339614b76706dfbf77fe97319f0c3452390e6))
...
<csr-read-only-do-not-edit/>
 ...
 - 2 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#1367](https://github.com/yuki0iq/gitoxide/issues/1367)
 ...
 * **[#1367](https://github.com/yuki0iq/gitoxide/issues/1367)**
    - Assure writing invalid dates doesn't panic. ([`3448fd9`](https://github.com/yuki0iq/gitoxide/commit/3448fd9cc0edc93d7a5b511fd4ec0a8e84b87e51))
 * **Uncategorized**
    ...
    - Make clear that `Time::seconds` is UTC. ([`8d610ab`](https://github.com/yuki0iq/gitoxide/commit/8d610ab8de7d3f62116632de6975f00c845dc842))
</details>
 ...
 * **Uncategorized**
    ...
    - For good measure, use `unsigned_abs()` for a variant that can't panic. ([`045dd9d`](https://github.com/yuki0iq/gitoxide/commit/045dd9db06e30e3852904651ac29cf82b2792066))
...
<csr-read-only-do-not-edit/>
 ...
 - 15 days passed between releases.
 - 0 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#961](https://github.com/yuki0iq/gitoxide/issues/961)
 ...
 * **[#961](https://github.com/yuki0iq/gitoxide/issues/961)**
    - Add another fuzz-failure that doesn't fail ([`90ec770`](https://github.com/yuki0iq/gitoxide/commit/90ec77057fa8a7d191c959e2f3a3c958270803eb))
 * **Uncategorized**
...
<csr-read-only-do-not-edit/>
 ...
 - 7 unique issues were worked on: [#331](https://github.com/yuki0iq/gitoxide/issues/331), [#427](https://github.com/yuki0iq/gitoxide/issues/427), [#450](https://github.com/yuki0iq/gitoxide/issues/450), [#470](https://github.com/yuki0iq/gitoxide/issues/470), [#691](https://github.com/yuki0iq/gitoxide/issues/691), [#711](https://github.com/yuki0iq/gitoxide/issues/711), [#720](https://github.com/yuki0iq/gitoxide/issues/720)
 ...
 * **[#331](https://github.com/yuki0iq/gitoxide/issues/331)**
    ...
    - `Time::is_set()` to see if the time is more than just the default. ([`aeda76e`](https://github.com/yuki0iq/gitoxide/commit/aeda76ed500d2edba62747d667227f2664edd267))
    - Frame for git-date ([`37e8ef8`](https://github.com/yuki0iq/gitoxide/commit/37e8ef890305db0798059919290a0d27a9a39194))
 * **[#427](https://github.com/yuki0iq/gitoxide/issues/427)**
    ...
    - Git-style disambiguation errors ([`5717194`](https://github.com/yuki0iq/gitoxide/commit/57171946081c03da98f3d33f5b963c3bc4b2d6d9))
    ...
    - Add `Time` type. ([`cfb6a72`](https://github.com/yuki0iq/gitoxide/commit/cfb6a726ddb763f7c22688f8ef309e719c2dfce4))
 ...
 * **[#711](https://github.com/yuki0iq/gitoxide/issues/711)**
    - Assure we get the latest version of the `time` crate ([`cb31cd1`](https://github.com/yuki0iq/gitoxide/commit/cb31cd16bc4a6e749c298cfbc7e0dad05b11b96c))
 ...
 * **Uncategorized**
    ...
    - Rename `git-date` to `gix-date` ([`2b0a966`](https://github.com/yuki0iq/gitoxide/commit/2b0a9662acf7c74f594138963e2efd8f576799f3))
    ...
    - Merge branch 'fix-git-date-panics' ([`56f5593`](https://github.com/yuki0iq/gitoxide/commit/56f5593b25e300d21c380c5fb5a184445ff26183))
    - Panic in `parse_raw()` (as found by fuzzer) ([`3d6c810`](https://github.com/yuki0iq/gitoxide/commit/3d6c81000559df91b17834ec5e9830b085277af8))
    - Fix warnings, don't track Cargo.lock to use compatible latest dependencies ([`96a56a9`](https://github.com/yuki0iq/gitoxide/commit/96a56a9d1d76e5832a4bf505152985a74c6c7357))
    - Merge pull request #714 from silvergasp/fuzz-git-date ([`a52c54e`](https://github.com/yuki0iq/gitoxide/commit/a52c54e97698c1b61ff70884378338f63b4d1a27))
    - Adds fuzzer for date parser ([`fe04934`](https://github.com/yuki0iq/gitoxide/commit/fe04934d783e4c53a79fae2e0d3b0c5802ea1809))
    ...
    - Return the time that failed to parse in the error ([`f5c9aa8`](https://github.com/yuki0iq/gitoxide/commit/f5c9aa827e3b9ffb82a52ad7f840c58aa0d654ed))
    ...
    - `time::format::GIT_DEFAULT` -> `*::DEFAULT` and `*::DEFAULT` -> `*::GITOXIDE`. ([`41fc2bb`](https://github.com/yuki0iq/gitoxide/commit/41fc2bb20e6a926ffc3638c0fac21d733fdc2e3c))
    - Merge branch 'strict-raw-dates' ([`c65ce7e`](https://github.com/yuki0iq/gitoxide/commit/c65ce7e3031b036d3a76b6e8a6c9ead39390261c))
    - Stricter raw date parsing ([`046af94`](https://github.com/yuki0iq/gitoxide/commit/046af94f005a6e095f0d3616c0b57ef1f556f734))
    - Merge branch 'issue-679' ([`a910d9e`](https://github.com/yuki0iq/gitoxide/commit/a910d9e7dcb2ba1979660165fa5b8cb0a2dce594))
    - Refactor ([`26597b9`](https://github.com/yuki0iq/gitoxide/commit/26597b983d401a1efcd13b3e69aad6a39581ec0b))
    - Support git default date format ([`4066ac7`](https://github.com/yuki0iq/gitoxide/commit/4066ac7367d8e870522746429513fb7a357a2cc6))
    - Format git-style RFC 2822 date strings ([`8094351`](https://github.com/yuki0iq/gitoxide/commit/8094351fe547a0f6756b0ed29dc87a0e6b9ceec1))
    - Parse git-styled RFC 2822 date strings ([`dff0aa0`](https://github.com/yuki0iq/gitoxide/commit/dff0aa0be600b9cd9518184fefa9b3c8fdb510f2))
    ...
    - Merge branch 'bugfix/system-time-correct-offset-sign' ([`6e40433`](https://github.com/yuki0iq/gitoxide/commit/6e40433f6f607888e8f8a6c36e53a68b91fcf671))
    - Add non-isolated test that, depending on region, would catch the invalid-sign bug. ([`b649965`](https://github.com/yuki0iq/gitoxide/commit/b6499653b71e79f17a7304c6e83d2e1776ff5d5e))
    - Negative system timezone offsets should be serialized as such ([`39655f5`](https://github.com/yuki0iq/gitoxide/commit/39655f5f6fa39a55c4420f672e866c483f9b85ed))
    ...
    - Merge branch 'bugfix/signed-raw-time' ([`f50b9f5`](https://github.com/yuki0iq/gitoxide/commit/f50b9f54425e64461a31d00e082470aa5042be74))
    - Thanks clippy ([`75d6e88`](https://github.com/yuki0iq/gitoxide/commit/75d6e882cea823100f2ad5bf26a4f1082287d80b))
    - Refactor ([`f4e8051`](https://github.com/yuki0iq/gitoxide/commit/f4e8051fbc8cde9ba25fb1185c9e32f6aed4c0fb))
    - Correctly parse raw dates with negative timezone offsets ([`f4ea59d`](https://github.com/yuki0iq/gitoxide/commit/f4ea59db0a429801ab40b1294da4bffd9e0f80b3))
    - Extend git-date's baseline tests to also re-format the parsed dates ([`9f95f7f`](https://github.com/yuki0iq/gitoxide/commit/9f95f7fbbe5b56e65c00c26f580bf67a4001e146))
    - Merge branch 'bugfix/timestamp-to-datetime-conversion' ([`be0bbf5`](https://github.com/yuki0iq/gitoxide/commit/be0bbf519c4a6687c305717ec0c12215a5836f58))
    - Always consider timestamps as UTC when loading from commits ([`be603f5`](https://github.com/yuki0iq/gitoxide/commit/be603f593055309b74685bc2aebb8e35e6de2d59))
    ...
    - Merge branch 'git_date_relative' ([`83a3832`](https://github.com/yuki0iq/gitoxide/commit/83a38329c59e9ebc057221da832fd8320bbeddb1))
    - Refactor ([`c5c6bf6`](https://github.com/yuki0iq/gitoxide/commit/c5c6bf6ef3f0c9c12389bb638ab4d32b61839dec))
    - Refactor ([`956613f`](https://github.com/yuki0iq/gitoxide/commit/956613fcdb33a845526fa9743aa0e7f80b3badfa))
    - Refactor ([`1026b7c`](https://github.com/yuki0iq/gitoxide/commit/1026b7c613a3a8b46a27dd7cd5e3520043b21ab7))
    - WIP. ([`79d82d4`](https://github.com/yuki0iq/gitoxide/commit/79d82d46613c83280d2401ef4d72a35010a70b87))
    - Parse the output while parsing the baseline file. ([`70fe59f`](https://github.com/yuki0iq/gitoxide/commit/70fe59f4a1cad25f687397206ee2cbe50e643181))
    ...
    - Parse now takes the current time `parse(…, Option<time>)` as parameter. ([`c24ea67`](https://github.com/yuki0iq/gitoxide/commit/c24ea67f84aa48953949682672114715bee67432))
    - Merge branch 'git_date_parse' ([`75591fb`](https://github.com/yuki0iq/gitoxide/commit/75591fb108ce440ba2f920bebf99158b407e3046))
    - Thanks clippy ([`590fcc9`](https://github.com/yuki0iq/gitoxide/commit/590fcc9f3fc768802fd09f4e73036e225ec5c363))
    - A sample on how to more easily test relative date parsing ([`c585c9b`](https://github.com/yuki0iq/gitoxide/commit/c585c9b2b0e628914169bbfba55aa5130da51a83))
    - Add test to check times before unix epoch ([`eb304ea`](https://github.com/yuki0iq/gitoxide/commit/eb304ea91f857070380ef4e4dbdff6b8ab89cee1))
    - Refactor ([`0e231eb`](https://github.com/yuki0iq/gitoxide/commit/0e231ebeeb41306b1075bc06c78b45dc65ded5fa))
    - Refactor ([`5793465`](https://github.com/yuki0iq/gitoxide/commit/5793465b0f19b284a4615290e2b08203e969e9bb))
    - Refactor; add failing test to see invalid date error in action ([`90008aa`](https://github.com/yuki0iq/gitoxide/commit/90008aa4e59f78cfe2ecd5a7ee851bb56f7b0d33))
    ...
    - PR comments. ([`1eac4de`](https://github.com/yuki0iq/gitoxide/commit/1eac4de99de250e770b48054fd5bc6b806418e4d))
    - `parse` is pure function. ([`9ad1a5f`](https://github.com/yuki0iq/gitoxide/commit/9ad1a5fa2ce54e978396ff3eaa7061a8edd10d4a))
    - Fallible timestamp cast i64 -> u32. ([`cce7616`](https://github.com/yuki0iq/gitoxide/commit/cce7616835f1dff29b2c74bd96b5238d55167d5f))
    - `parse()` returns Result. ([`206f392`](https://github.com/yuki0iq/gitoxide/commit/206f3923f5da2e9e26677e917550e6e5baa2913a))
    - Add output to baseline. ([`5c3b733`](https://github.com/yuki0iq/gitoxide/commit/5c3b7334289ef71a9dbcc021f1989eb8e021fc7f))
    - `parse` returns Result. ([`67c8c6a`](https://github.com/yuki0iq/gitoxide/commit/67c8c6a9666161a3a0cd01203e0fb1da22336939))
    - Add fixtures. ([`6c40ac1`](https://github.com/yuki0iq/gitoxide/commit/6c40ac1e39fbefba640fc9cb4fd3ef419a149e99))
    - Add git baseline. ([`b747a60`](https://github.com/yuki0iq/gitoxide/commit/b747a60b62c533b3919124e628f31e6bbef9c838))
    - Refactor ([`3e6e0f9`](https://github.com/yuki0iq/gitoxide/commit/3e6e0f9ebdf7ab87c689be074ae1eecfea4485f0))
    - Draft. ([`95b4902`](https://github.com/yuki0iq/gitoxide/commit/95b490230ebfbd4c2f04edd7074d5a0f5e2429ec))
    - Draft. ([`43b6c06`](https://github.com/yuki0iq/gitoxide/commit/43b6c064bfa407d1a2cabf09aad1cc8334dec651))
    ...
    - Bump version to 1.0 to prevent accidental inclusions downstream ([`034c8dc`](https://github.com/yuki0iq/gitoxide/commit/034c8dc4437c06dc8af702fbe9b86ec903c73a18))
    ...
    - Merge pull request #497 from svetli-n/patch-2 ([`bd02b39`](https://github.com/yuki0iq/gitoxide/commit/bd02b392734d8074adedc504a2cf69952d6fa980))
    - Fix doc comment ([`51cd9ce`](https://github.com/yuki0iq/gitoxide/commit/51cd9ceda6a8a0127a18802dc2cc49861013a65d))
    ...
    - Update changelogs prior to release ([`1b5fd86`](https://github.com/yuki0iq/gitoxide/commit/1b5fd86d121634f8567e8442f125377e460032c6))
    ...
    - Merge branch 'add_common_git_formats' ([`c53e5a4`](https://github.com/yuki0iq/gitoxide/commit/c53e5a4c521fbae7d74ad8323f79ced4dfe4f037))
    - Raw and Unix formats. ([`8f7f9ce`](https://github.com/yuki0iq/gitoxide/commit/8f7f9ce2b06ec884220b8cd5010b3df04b1ff0bc))
    - Foundation for custom formats that aren't easily done with `time` formatting ([`b74eaf8`](https://github.com/yuki0iq/gitoxide/commit/b74eaf85d41e1ec67d8c84cc8484702514c3e7cd))
    - Add ISO-strict format ([`4b0c219`](https://github.com/yuki0iq/gitoxide/commit/4b0c2198f9d5b28584c717123c7cfb1b27724605))
    - Refinements ([`b1fea0f`](https://github.com/yuki0iq/gitoxide/commit/b1fea0fe76bd94850c7da34ee9504525ad667748))
    - Add common git date formats. ([`090795b`](https://github.com/yuki0iq/gitoxide/commit/090795b4040e2dad995390e502f87c2ced8045f8))
    ...
    - Refactor ([`11a5fa2`](https://github.com/yuki0iq/gitoxide/commit/11a5fa29615d47c24f78446a1c3f5d3b8acf2f93))
    - Refactor ([`8e6f4a9`](https://github.com/yuki0iq/gitoxide/commit/8e6f4a921b6b45945e711aaf5858b7714371fb41))
    - Merge branch 'format_git_date_time' ([`99e12be`](https://github.com/yuki0iq/gitoxide/commit/99e12bee16ab3f344c71818bfd1c95cf50e1721b))
    - Thanks clipppy ([`b139d70`](https://github.com/yuki0iq/gitoxide/commit/b139d7043fbbbe5b933d96e83544059fe2a7bdd8))
    - Refactor ([`bd64387`](https://github.com/yuki0iq/gitoxide/commit/bd64387d8ad3377571755dff14577cc3c53ee9cc))
    - Use time format strings. ([`f84e8f5`](https://github.com/yuki0iq/gitoxide/commit/f84e8f5f16ec2197d1967fb1cc06e9609ea52c16))
    - Refactor ([`556dd8c`](https://github.com/yuki0iq/gitoxide/commit/556dd8cb78ea9321031984e2c6b4f9bc415f1be5))
    - Refactor ([`5bbcbcd`](https://github.com/yuki0iq/gitoxide/commit/5bbcbcd75d1ab26746da7a927390ff3b6cc19a85))
    - Format `git-date::Time` with `time::format_description`. ([`d4243bc`](https://github.com/yuki0iq/gitoxide/commit/d4243bc4feb994bde99156ba77fff63bc9c875e9))
    ...
    - Release git-date v0.0.0 ([`2bc2f76`](https://github.com/yuki0iq/gitoxide/commit/2bc2f765dc4f8a4779c132f7729fb782c66c0d99))
</details>
