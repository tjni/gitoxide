 ...
 * **Uncategorized**
    ...
    - Merge pull request #2219 from cruessler/use-split-at-checked ([`12b3257`](https://github.com/yuki0iq/gitoxide/commit/12b32572eb57451f1f704b46dbe10c2dd03620b0))
    - Replace split_at_pos by split_at_checked ([`027b3ef`](https://github.com/yuki0iq/gitoxide/commit/027b3ef17da944a01f6ded6044d7dce91b395934))
    ...
    - Merge pull request #2145 from GitoxideLabs/dependabot/cargo/cargo-2a6d70b8ef ([`8d8dba2`](https://github.com/yuki0iq/gitoxide/commit/8d8dba212f62820c98601ab2d7e0f6daa0fd21b0))
    - Bump the cargo group with 3 updates ([`074ca1e`](https://github.com/yuki0iq/gitoxide/commit/074ca1ef986622b09db011fd65e7f885429f70fb))
    ...
    - Add `PartialEq, Eq, PartialOrd, Ord` to more types. ([`66158d2`](https://github.com/yuki0iq/gitoxide/commit/66158d283553787217c722f0cd9f1b87ca588a96))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2047 from blinxen/update-hashbrown ([`00bd1fa`](https://github.com/yuki0iq/gitoxide/commit/00bd1fac8753a98fd0d4cdd8cf239b34e62b7d80))
    - Update `hashbrown` to 0.15. ([`6f569ce`](https://github.com/yuki0iq/gitoxide/commit/6f569cea08297501f332f4d7114065df38fa98f7))
    ...
    - Prefer the actual state over following `core.symlinks` in `entry::Mode` ([`c85b92d`](https://github.com/yuki0iq/gitoxide/commit/c85b92d991a91bb1044fe5f784524f568e72c45b))
 ...
 * **Uncategorized**
    ...
    - Prepare changelogs prior to release of `gix-index` ([`bfc4880`](https://github.com/yuki0iq/gitoxide/commit/bfc48801bf3ed39cdf7ec02e01aa3cfb6181705f))
    - Merge pull request #2005 from 0-wiz-0/main ([`33c4d6b`](https://github.com/yuki0iq/gitoxide/commit/33c4d6b6656c994ed090f2fddd70e014401baf30))
    - Fix build on NetBSD ([`00e8934`](https://github.com/yuki0iq/gitoxide/commit/00e89341cd89f58d031eee8a4e60f6ebdcd53185))
 ...
 * **Uncategorized**
    ...
    - Prepare `gix-index` end-of-index extension parsing for SHA256. ([`f879654`](https://github.com/yuki0iq/gitoxide/commit/f8796547213c5fe15efa35ee947223ee0ebe6c12))
    ...
    - Add `From<gix_object::tree::EntryKind> for entry::Mode` ([`de4375a`](https://github.com/yuki0iq/gitoxide/commit/de4375a13fad109d97cac65a84073a538f3611f2))
    - Add `State::remove_(tree|resolve_undo)()` to remove possibly outdated extensions. ([`668cb12`](https://github.com/yuki0iq/gitoxide/commit/668cb12815bf07857f8ab54f79954af031edd426))
    - Add `State::remove_entry_at_index(pos)` by position. ([`8173096`](https://github.com/yuki0iq/gitoxide/commit/81730967d60298a149a597915885dab63bdcd069))
    - Merge pull request #1818 from EliahKagan/from-fs-doc ([`14d6b8d`](https://github.com/yuki0iq/gitoxide/commit/14d6b8d98e814bc466f689b5b896a86aa0174b7f))
    - Expand `from_fs` doc ([`426c669`](https://github.com/yuki0iq/gitoxide/commit/426c669d58231ca22cd900f6fd86d59138d6a6ea))
 ...
 * **Uncategorized**
    ...
    - Slightly improve docs of `entry::Mode::change_to_match_fs()` ([`18b2a97`](https://github.com/yuki0iq/gitoxide/commit/18b2a97544d779694ff3cdb27734513547d1cec2))
    ...
    - `State::from_tree()` is now faster. ([`4989cda`](https://github.com/yuki0iq/gitoxide/commit/4989cda067c3c1e33e2525d9e30022aa2c61c275))
 ...
 * **Uncategorized**
    ...
    - `entry::Stage` can now be converted into `entry::Flags`. ([`63978f6`](https://github.com/yuki0iq/gitoxide/commit/63978f6e54cf48e7b5afe65dede851890a163ebd))
    ...
    - Regenerate gix-index fixture archive ([`eab6735`](https://github.com/yuki0iq/gitoxide/commit/eab67358c135597936448f6b9faf85cd52bb3400))
    - Set +x in index in v2_all_file_kinds and v2_deeper_tree fixtures ([`f72ff21`](https://github.com/yuki0iq/gitoxide/commit/f72ff21abf95603e18d4c2dfdfd8f81af924624e))
    - Merge pull request #1648 from EliahKagan/run-ci/touch-next ([`417bf95`](https://github.com/yuki0iq/gitoxide/commit/417bf95fda7c947c88aa2c9fed7c2a8845bb901d))
    - Make `touch` logic in `file_metadata.sh` more portable ([`c430897`](https://github.com/yuki0iq/gitoxide/commit/c430897f0b4b78ff74f3c8e6f9946f55f022f499))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1496 from EliahKagan/touch ([`9b72c61`](https://github.com/yuki0iq/gitoxide/commit/9b72c61f0164f9d549e7dea12fc7686721694433))
    - Have `touch` in test fixture fall back to portable format ([`bbbd1eb`](https://github.com/yuki0iq/gitoxide/commit/bbbd1eb0d246b7cd2d7afaa33c17102f97a37355))
</details>
 ...
 * **Uncategorized**
    ...
    - Add more standard traits to `Change` type. ([`b3973e4`](https://github.com/yuki0iq/gitoxide/commit/b3973e4bd5e0ea1bf40a5b12ef44647021392d55))
    ...
    - Merge pull request #1425 from EliahKagan/strange-symlink-targets ([`6df6e84`](https://github.com/yuki0iq/gitoxide/commit/6df6e845e0d16ad3305f88157999a9564848d04f))
    - Add missing executable bits on two fixture scripts ([`d944598`](https://github.com/yuki0iq/gitoxide/commit/d944598d17e8663e3aca2fecf993e433aff07f8b))
    ...
    - Merge pull request #1383 from sthibaul/hurd ([`e8b6bc2`](https://github.com/yuki0iq/gitoxide/commit/e8b6bc257311cb7e3f5d88b2454ac306cc03d381))
    - Fix accessing st_[mc]time ([`daf3844`](https://github.com/yuki0iq/gitoxide/commit/daf3844c8f5ce6d0812e35677b1a46d568e226db))
</details>
 ...
 * **Uncategorized**
    ...
    - `State::from_tree()` now performs name validation. ([`2ea87f0`](https://github.com/yuki0iq/gitoxide/commit/2ea87f0060fd796961a2173569f16f362ed61617))
    ...
    - Make clear that indices can contain invalid or dangerous paths. ([`b6a67d7`](https://github.com/yuki0iq/gitoxide/commit/b6a67d7fe3b5645fccb785af01d72919c6761c52))
    - Add `From<gix_object::tree::Mode> for gix_index::entry::Mode`. ([`9564699`](https://github.com/yuki0iq/gitoxide/commit/956469944d14bc0e5b16e3f95d407bb8b2282903))
...
<csr-read-only-do-not-edit/>
 ...
 - 1 commit was understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#1330](https://github.com/yuki0iq/gitoxide/issues/1330)
 ...
 * **[#1330](https://github.com/yuki0iq/gitoxide/issues/1330)**
    - Fix unread-fields warnings on latest nightly ([`2e06a00`](https://github.com/yuki0iq/gitoxide/commit/2e06a00800418a6f571ba1731ffe05074565af03))
 * **Uncategorized**
    ...
    - Turn `entry::Stage` into an `enum`. ([`a6cc781`](https://github.com/yuki0iq/gitoxide/commit/a6cc78176c5b399c363bb6ee776cb16d6f5d3dad))
</details>
 ...
 * **Uncategorized**
    ...
    - Remove a TODO as it doesn't make sense anymore. ([`b05af9f`](https://github.com/yuki0iq/gitoxide/commit/b05af9f86119ba5c71a19d632312fd66edb30a0e))
</details>
 ...
 * **Uncategorized**
    ...
    - Fix usage of tracing span (which now is just a message) ([`259b38e`](https://github.com/yuki0iq/gitoxide/commit/259b38e629807e887442ca6140a14cefcd672699))
</details>
 ...
 * **Uncategorized**
    ...
    - Provide information about whether or not EOIE and IEOT extensions were available. ([`ec37db4`](https://github.com/yuki0iq/gitoxide/commit/ec37db42f0c22268cf400ae193cfb04466f45b0e))
    - Refactor ignore-case functionality to actually work. ([`cbda06d`](https://github.com/yuki0iq/gitoxide/commit/cbda06d7673c3461b82f5999295d3b00a7c273ef))
 ...
 * **Uncategorized**
    ...
    - Merge branch 'fix-stat-with-negative-times' ([`08e6ca8`](https://github.com/yuki0iq/gitoxide/commit/08e6ca8241047f75b84c1123f9f911625a2014fb))
    - Assure negative nanoseconds on MacOS are handled ([`bf49cd4`](https://github.com/yuki0iq/gitoxide/commit/bf49cd4508433dba6aacf963f49662516b3a960c))
    - Fix stat on files with timestamps before the epoch ([`f4a29dc`](https://github.com/yuki0iq/gitoxide/commit/f4a29dc17e60b208c515b921ba504acd7290e85c))
    - Add test for file metadata handling with extreme values ([`5c57c6b`](https://github.com/yuki0iq/gitoxide/commit/5c57c6b9c4353dac657370cbc93e69ae38df7acd))
    - Merge pull request #1249 from joshtriplett/simplify-cfg-within-function ([`dfb7b0f`](https://github.com/yuki0iq/gitoxide/commit/dfb7b0f717b76dd60f0dda7d7adf041ca13d2059))
    ...
    - Avoid using #[cfg] on multiple individual function arguments ([`6fc27ee`](https://github.com/yuki0iq/gitoxide/commit/6fc27ee8f5ae7ce9fe7e6d07c5c31719cb6b7b1b))
    ...
    - Add directory lookup, as well as ignore-case capabilities. ([`7c2eeb0`](https://github.com/yuki0iq/gitoxide/commit/7c2eeb07ed0184a6c271f4a54604cba7d2abe811))
</details>
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1194 from ecnelises/aix_stattime ([`940e3ca`](https://github.com/yuki0iq/gitoxide/commit/940e3ca568f4546bd1055a2179f4b8ccc22ea2a9))
    - Use correct fields for ctime and mtime on AIX ([`569caa0`](https://github.com/yuki0iq/gitoxide/commit/569caa0314599c93651d9116d00fde64b81d2ace))
 ...
 * **Uncategorized**
    ...
    - Prepare changelog for `gix-index` release ([`b3ecbb7`](https://github.com/yuki0iq/gitoxide/commit/b3ecbb7e27bbd088733c70a319a57a9e963f8bd0))
    - Merge pull request #1170 from weihanglo/netbsd ([`523692b`](https://github.com/yuki0iq/gitoxide/commit/523692b6d9d403d0e10f36f382ce7728f3ae2ad4))
    - NetBSD doesn't have `st_mtime_nsec` and `st_ctime_nsec` ([`03fa7ac`](https://github.com/yuki0iq/gitoxide/commit/03fa7ac64c99abc804252630c03b5b9085e9ea81))
    - Merge branch '32bit' ([`ff1542c`](https://github.com/yuki0iq/gitoxide/commit/ff1542cedf3072a8c7c493d454aef5cc61de6d4c))
    - Builds on 32bit android now work. ([`e2e17c6`](https://github.com/yuki0iq/gitoxide/commit/e2e17c60008f287796c6c10e1fa8a64a3d4a9105))
</details>
 ...
 * **Uncategorized**
    ...
    - Impl `From<entry::Mode> for gix_object::tree::EntryMode`. ([`21bea0f`](https://github.com/yuki0iq/gitoxide/commit/21bea0f5496a0db607356c803a545358e766fa92))
    ...
    - Add git-style metadata support. ([`3c8421f`](https://github.com/yuki0iq/gitoxide/commit/3c8421f003bc3a5f2f51cee1b5cb6a526d5e0f38))
    ...
    - Use new `gix-object::Find` trait ([`1165de0`](https://github.com/yuki0iq/gitoxide/commit/1165de0d00b99a85387868d1ebb6423fd0e89b6b))
    - Use `gix-object::Find` trait ([`806ea47`](https://github.com/yuki0iq/gitoxide/commit/806ea473e6e3ca3bf929f7d46c6f087296fceb09))
 ...
 * **Uncategorized**
    ...
    - Merge branch 'fix-input' ([`a899f74`](https://github.com/yuki0iq/gitoxide/commit/a899f74a20c3e9a40f456387d71b48ca9187af17))
    - Assure a prefixed entries range is never empty. ([`357ba13`](https://github.com/yuki0iq/gitoxide/commit/357ba137fe63e4b3f92732d665870085be888223))
    ...
    - Use `PathStorageRef` in place of `&PathStorage` ([`a1794b5`](https://github.com/yuki0iq/gitoxide/commit/a1794b537c036e5469f7c2808d460bffcc6eeb5a))
    - Add more traces to potentially longer-running operations ([`1568948`](https://github.com/yuki0iq/gitoxide/commit/15689482351691079652d7b9b80b5aaecb7da863))
 ...
 * **Uncategorized**
    ...
    - Make time conversion more robust ([`fd034e0`](https://github.com/yuki0iq/gitoxide/commit/fd034e03b5a05dcc7a01014ce6a97b7cf93086be))
    - Add trace for `State::from_tree()` as it's rather time-consuming ([`959dc17`](https://github.com/yuki0iq/gitoxide/commit/959dc175b7925e0a7952c23ad92f83a32ad9609c))
</details>
 ...
 * **Uncategorized**
    ...
    - `prefixed_entries_range()` now works correctly with directory prefixes. ([`6a8314b`](https://github.com/yuki0iq/gitoxide/commit/6a8314bb99099e2a3f5364a5761a5254aa36393a))
</details>
 ...
 * **Uncategorized**
    ...
    - Prepare `gix-index` release ([`6fdbc66`](https://github.com/yuki0iq/gitoxide/commit/6fdbc667c20f10734390341b435c15c73b7cd227))
    - Add `State::prefixed_range()` to obtain a range of entries matching a prefix. ([`cfbfa43`](https://github.com/yuki0iq/gitoxide/commit/cfbfa43069c8d82fbd74b8296f63fc050a5ba02a))
    - Add `State::remove_entries()` and `entry_range()`. ([`8b689c2`](https://github.com/yuki0iq/gitoxide/commit/8b689c222668b0c35c508f1907b03cbd4ba09bba))
    - `gix-index` prefix matching should now work correctly with conflicting files. ([`6169325`](https://github.com/yuki0iq/gitoxide/commit/616932516d122a24e29fb42c60147fe43c5cead9))
    - Merge branch 'fixes' ([`4bfd1cc`](https://github.com/yuki0iq/gitoxide/commit/4bfd1cc8f7922a8c4de6b9d078d54b93e78f51ff))
    - Check the hash when reading via `File::at()` just like `git`, or skip the check. ([`61c2e34`](https://github.com/yuki0iq/gitoxide/commit/61c2e34b10c2ad5c92edd4ec1d5d1be2317ac481))
    - Add support for `write::Options::skip_hash`. ([`2f42132`](https://github.com/yuki0iq/gitoxide/commit/2f42132410ef47a7c274030811452ef40701c8a0))
    - Skip the null-hash when validating the index. ([`b310d04`](https://github.com/yuki0iq/gitoxide/commit/b310d044ac5c2bb1c874d0cfe701411e4aef47be))
 ...
 * **Uncategorized**
    ...
    - Add `entry::Mode::is_submodule()` ([`5fd6364`](https://github.com/yuki0iq/gitoxide/commit/5fd63646a643df0f30e24d0bcdec9edfd3176b50))
    - Merge branch 'pathspec-matching' ([`9f4dfe0`](https://github.com/yuki0iq/gitoxide/commit/9f4dfe0f0b948280692916b596923959ea2fd9da))
    - Add `State::prefixed_entries()` returning a range of entries with a given prefix. ([`05ed965`](https://github.com/yuki0iq/gitoxide/commit/05ed96548da9c1ec04592df24bdd2133df62e16d))
 ...
 * **Uncategorized**
    ...
    - Use new `gix-fs` capabilities ([`1c1d19b`](https://github.com/yuki0iq/gitoxide/commit/1c1d19b715b4c3e716ebcde643cad9a75912e5fc))
 ...
 * **Uncategorized**
    ...
    - `State::entry_by_path_ours()` to find an entry which is either stage 0 or stage 2. ([`20c0d25`](https://github.com/yuki0iq/gitoxide/commit/20c0d2517aad9fc83a3e48a9b0ce6aa9e8b6fded))
</details>
 ...
 * **Uncategorized**
    ...
    - Add more tasks to gather a little more information ([`891a061`](https://github.com/yuki0iq/gitoxide/commit/891a06107883b4a21796facf046a0cd697dc2134))
 ...
 * **Uncategorized**
    ...
    - Add `State::into_entries()`. ([`973bf70`](https://github.com/yuki0iq/gitoxide/commit/973bf7065e6da2b3ea690c9e3f0077f4bbc546b8))
</details>
 ...
 * **Uncategorized**
    ...
    - Docs.rs builds work again by correctly specifying `serde` dependency. ([`4d82ea2`](https://github.com/yuki0iq/gitoxide/commit/4d82ea261547a936fa9bedc8d11470ca8f929939))
</details>
 ...
 * **Uncategorized**
    ...
    - Add a test for --intend-to-add and clarify what this flag means. ([`27471e7`](https://github.com/yuki0iq/gitoxide/commit/27471e7f421446cc8f6d4543bdf85fe4e753b944))
    - Add `Index::entries_mut_and_pathbacking()`. ([`9af47c3`](https://github.com/yuki0iq/gitoxide/commit/9af47c3971fdb744dbc38c1920430975e4a9ba84))
    - Refactor ([`691758a`](https://github.com/yuki0iq/gitoxide/commit/691758a4491f8430b61e418dad33d8d901f89361))
    - Improve documentation of gix_index::entry::Stat::matches ([`1e19760`](https://github.com/yuki0iq/gitoxide/commit/1e19760ad32722e89a928a3d2f9cb91e48e63973))
    - Clarify Stat::is_racy documentation ([`4736b60`](https://github.com/yuki0iq/gitoxide/commit/4736b6061acd28abfe8872a10f803f42e0591e35))
    - Improve Mode::change_to_match_fs documentation ([`bf8a7a4`](https://github.com/yuki0iq/gitoxide/commit/bf8a7a493645254365bc69f85b0aa0e0ea884a3e))
    - Cleanup entry::mode API ([`9cb76e9`](https://github.com/yuki0iq/gitoxide/commit/9cb76e9f46e40d64e154f44ca08d52443cd81300))
    - Update index::entry::stat tests ([`f2a9b3f`](https://github.com/yuki0iq/gitoxide/commit/f2a9b3fb87013ce55cb519d047340035d1e20530))
    ...
    - Allow access to index timestamp ([`c49f12d`](https://github.com/yuki0iq/gitoxide/commit/c49f12d8940a3b0d8b4ca1fcb3c40119cd8167dc))
    ...
    - Update to latest `bitflags` version. ([`594cca5`](https://github.com/yuki0iq/gitoxide/commit/594cca51840c00654af05acc7f7c7d01fe699067))
</details>
 ...
 * **Uncategorized**
    ...
    - Merge branch 'adjustments-for-cargo' ([`04ab852`](https://github.com/yuki0iq/gitoxide/commit/04ab852f3be76bdf151affa25cf4b999b127bdfe))
    - Adjust to changes in `git-features` ([`726b2cd`](https://github.com/yuki0iq/gitoxide/commit/726b2cd7bee7e9c5854bcac9ef0cd56ed0542f0d))
</details>
 ...
 * **Uncategorized**
    ...
    - Use `btoi` instead of `atoi`. ([`41c8151`](https://github.com/yuki0iq/gitoxide/commit/41c8151451d55b47c0784e4799aec102e6ab9f29))
...
<csr-read-only-do-not-edit/>
 ...
 - 11 unique issues were worked on: [#293](https://github.com/yuki0iq/gitoxide/issues/293), [#298](https://github.com/yuki0iq/gitoxide/issues/298), [#301](https://github.com/yuki0iq/gitoxide/issues/301), [#329](https://github.com/yuki0iq/gitoxide/issues/329), [#333](https://github.com/yuki0iq/gitoxide/issues/333), [#384](https://github.com/yuki0iq/gitoxide/issues/384), [#427](https://github.com/yuki0iq/gitoxide/issues/427), [#450](https://github.com/yuki0iq/gitoxide/issues/450), [#470](https://github.com/yuki0iq/gitoxide/issues/470), [#691](https://github.com/yuki0iq/gitoxide/issues/691), [#XXX](https://github.com/yuki0iq/gitoxide/issues/XXX)
 ...
 * **[#293](https://github.com/yuki0iq/gitoxide/issues/293)**
    - Remove performance bottleneck when reading TREE extension ([`50411c8`](https://github.com/yuki0iq/gitoxide/commit/50411c8031e3103bb84da46b94b8faf92c597df9))
    - Assert store tree cache matches actual source objects ([`b062bec`](https://github.com/yuki0iq/gitoxide/commit/b062becd01058f5c519538f89d9d8fec8342114d))
    - Sketch a surprisingly difficult way of loading objects in verify_extension() ([`3baeab4`](https://github.com/yuki0iq/gitoxide/commit/3baeab4ab216132536d5c182b3e316ce65095085))
    - Properly sort cache tree entries upon load ([`421d1ba`](https://github.com/yuki0iq/gitoxide/commit/421d1ba853a75560f59cb0ce2b353087db0dff56))
    - Tree-ordering validation shows something wrong ([`5fb2857`](https://github.com/yuki0iq/gitoxide/commit/5fb2857e9f970c150f5221ca721506e7bc046ef4))
    - First stab at tree verification ([`f928350`](https://github.com/yuki0iq/gitoxide/commit/f9283500e8316ab949fc0ff9c2fc13a498380873))
    - Verify entry order ([`2d101eb`](https://github.com/yuki0iq/gitoxide/commit/2d101ebbd36e000ffec0e965012081fec2e234f7))
    - Refactor ([`017e915`](https://github.com/yuki0iq/gitoxide/commit/017e9153aaaa1cdd6788d9f61ff1ffbd61bc1b30))
    - Basic index file checksum verification ([`c644565`](https://github.com/yuki0iq/gitoxide/commit/c644565d5b8d9ae3991ee82a7ffa5e21a2705f91))
    - At least check for the presence of extensions ([`28c056c`](https://github.com/yuki0iq/gitoxide/commit/28c056c6d2bbfb16a826238fd6879adecbeb1171))
    - Thorough checking of Tree extension ([`d1063aa`](https://github.com/yuki0iq/gitoxide/commit/d1063aa20bfcefb064ba08089f095baef1299dcd))
    - Refactor ([`d0725bd`](https://github.com/yuki0iq/gitoxide/commit/d0725bd40f0b9af0e0af34ffe77c2d8406c6d24c))
    - Fix tree-extension loading for empty trees ([`2e13989`](https://github.com/yuki0iq/gitoxide/commit/2e1398985edfaf9e62ff5643cf4756d9d9717862))
    - Now we are able to load indices correctly ([`762efa3`](https://github.com/yuki0iq/gitoxide/commit/762efa3f5e4ebda4d3bcc6a9bba43c6cdb407937))
    - Add breaking test with conflicting file in index ([`791a9f8`](https://github.com/yuki0iq/gitoxide/commit/791a9f84ff8871c7beb0e2100a4dcba0e9384737))
    - Print extension names instead of count ([`1cc07e0`](https://github.com/yuki0iq/gitoxide/commit/1cc07e0cfdae74e388abb29d7acb9c6f643278b4))
    - Print basic index information, including the tree extension ([`9277cf8`](https://github.com/yuki0iq/gitoxide/commit/9277cf877e1f2276dcad1efdeb97e0e3d96ed3f0))
    - Lower rust edition to 2018 ([`0b1543d`](https://github.com/yuki0iq/gitoxide/commit/0b1543d481337ed51dcfdeb907af21f0bc98dcb9))
    - Lower MSRV to 1.52 ([`c2cc939`](https://github.com/yuki0iq/gitoxide/commit/c2cc939d131a278c177c5f44d3b26127c65bd352))
    - Prepare changelogs for git-index and dependencies ([`f54bf4b`](https://github.com/yuki0iq/gitoxide/commit/f54bf4bde92b892b6d425987a6a37e10319c4635))
    - Test for extra-long paths ([`3d61afe`](https://github.com/yuki0iq/gitoxide/commit/3d61afe615227e2af96525eba5b0e8e2f94207f3))
    - Test for extended flags ([`ae3b697`](https://github.com/yuki0iq/gitoxide/commit/ae3b69710cf316cb8164120d4b98f051eef363bc))
    - Use bitflags for Flags (in-memory and at-rest) ([`ea86eb0`](https://github.com/yuki0iq/gitoxide/commit/ea86eb0bebb0f067fc8710779c2c296632451c54))
    - Use bitflags for entry Mode ([`53df605`](https://github.com/yuki0iq/gitoxide/commit/53df6057a8c50007716d89e08f1efe70435f8613))
    - FSMN V2 decoding ([`04279bf`](https://github.com/yuki0iq/gitoxide/commit/04279bffc8bd43abe85f559634436be789782829))
    - Failing test for fs-monitor V1 ([`625b89a`](https://github.com/yuki0iq/gitoxide/commit/625b89a7786fe9de29c9ad2ca41a734174f53128))
    - Validate UNTR with exclude-file oids ([`20ebb81`](https://github.com/yuki0iq/gitoxide/commit/20ebb81c9ece6c2d693edd6243eaa730fa7cf44c))
    - Read remaining pieces of UNTR ([`9d9cc95`](https://github.com/yuki0iq/gitoxide/commit/9d9cc95a24d86cf5f66f1746c09ece032640a892))
    - Make stat parsing more general/reusable ([`c41b933`](https://github.com/yuki0iq/gitoxide/commit/c41b933d14f2e4538928e4fbd682e1017702e69c))
    - Refactor ([`a1dc8de`](https://github.com/yuki0iq/gitoxide/commit/a1dc8dedc5d9e1712295131d2332c21f3df4ac45))
    - Simplify UNTR directory indexing ([`7857d08`](https://github.com/yuki0iq/gitoxide/commit/7857d08a25eac1c7d4a91f04eb80a83ec5677d1b))
    - Flatten UNTR directory list for later access via bitmaps ([`2e39184`](https://github.com/yuki0iq/gitoxide/commit/2e391841af52f88b7a0472179e5dda89cc6c9808))
    - Read UNTR directory blocks and bitmaps ([`59f46fe`](https://github.com/yuki0iq/gitoxide/commit/59f46fe134e8619f501c79da4290cadd5548751c))
    - First portion of reading the untracked cache ([`ed2fe5d`](https://github.com/yuki0iq/gitoxide/commit/ed2fe5dbfbcf79ffdcdceed90f6321792cff076d))
    - Failing test for UNTR extension ([`223f2cc`](https://github.com/yuki0iq/gitoxide/commit/223f2cc1c88f76dc75ca6706f1f61514ab52e496))
    - Add UNTR extension fixture ([`3c7ba24`](https://github.com/yuki0iq/gitoxide/commit/3c7ba247a3fdab114d9d549de50d6143c7fcce0a))
    - REUC reading works ([`29c1af9`](https://github.com/yuki0iq/gitoxide/commit/29c1af9b2d7b9879a806fc84cfc89ed6c0d7f083))
    - Frame and test for REUC exstension ([`229cabe`](https://github.com/yuki0iq/gitoxide/commit/229cabe8de9e1bd244d56d24327b05e3d80dfb6e))
    - Add git index with REUC exstension ([`8359fdb`](https://github.com/yuki0iq/gitoxide/commit/8359fdb6c49b263bc7ac2f3105254b83eac47638))
    - Support for 'sdir' extension ([`a38c3b8`](https://github.com/yuki0iq/gitoxide/commit/a38c3b889cfbf1447c87d489d3eb9902e757aa4b))
    - Turn git-bitmap Array into Vec, as it will be able to adjust its size ([`9e99e01`](https://github.com/yuki0iq/gitoxide/commit/9e99e016c17f0d5bcd2ab645261dfac58cb48be5))
    - First stab at decoding ewah bitmaps ([`353a53c`](https://github.com/yuki0iq/gitoxide/commit/353a53ccab5af990e7c384b74b38e5429417d449))
    - 'link' extension decoding to the point where bitmaps are needed ([`e18a2fd`](https://github.com/yuki0iq/gitoxide/commit/e18a2fd68e1c7c06fe2ff9cd1634704313822b5c))
    - Support for errors in extensions ([`8971991`](https://github.com/yuki0iq/gitoxide/commit/8971991808b1497b9584b52270259d3c625fa970))
    - Failing test for link decoding ([`e1daf18`](https://github.com/yuki0iq/gitoxide/commit/e1daf18041862570fdfe53ff88d879d0c3cb7182))
    - Don't forget to fail on unknown mandatory extension ([`f7e2bdd`](https://github.com/yuki0iq/gitoxide/commit/f7e2bdd7dcb21600d2aca7d29d131eefe43f0f4f))
    - Aggregation for index entries loaded in parallel ([`995994a`](https://github.com/yuki0iq/gitoxide/commit/995994a895a6faa4537ae1a6564edc005be96a1a))
    - Parallel loading of entries right before reducing them ([`de84a3a`](https://github.com/yuki0iq/gitoxide/commit/de84a3a03bcc9dc3ff71810e35c869f9b73dd38f))
    - Frame for using the new 'scoped threads' feature in git-features ([`6fea17d`](https://github.com/yuki0iq/gitoxide/commit/6fea17d1306679d0454d01aa59adf12cd83c7973))
    - Single and multi-threaded index tests ([`a22cb0f`](https://github.com/yuki0iq/gitoxide/commit/a22cb0f1ead9a2f32e43eb2fb378281e592a4ed3))
    - Prepare decode options for better control of threads ([`30de988`](https://github.com/yuki0iq/gitoxide/commit/30de988f6a97177fcb32ffce37f4c80f46306a20))
    - Cleanup ([`99d7224`](https://github.com/yuki0iq/gitoxide/commit/99d7224baa04c199a7eb7aa2675b39657b0aef6a))
    - Basic IEOT parsing ([`35bdee4`](https://github.com/yuki0iq/gitoxide/commit/35bdee4bf77787bcbe6c3dd715a677e2e46a8ad1))
    - Refactor ([`6f04f8b`](https://github.com/yuki0iq/gitoxide/commit/6f04f8b8276de9c6b649642fb7c95eb5ffad77e4))
    - Parse V4 delta-paths ([`06640e3`](https://github.com/yuki0iq/gitoxide/commit/06640e3f98f25e9502db7ac68e1967d9fd25e8b2))
    - More thorough tests for more complex repo with more entries ([`273853f`](https://github.com/yuki0iq/gitoxide/commit/273853f1614a0106c60d3d73c3bf72fb57b405e8))
    - The first test to validate an entry ([`f865ef6`](https://github.com/yuki0iq/gitoxide/commit/f865ef6c626c9db39a09416333b6465fdd12c734))
    - Now with counting of consumed bytes in extensions ([`77a062c`](https://github.com/yuki0iq/gitoxide/commit/77a062cdaff1bdf80556301f1e1aa41002af9cef))
    - Use correct post-header slice when parsing entries ([`da556b0`](https://github.com/yuki0iq/gitoxide/commit/da556b0a64ac9ca8eaee62cab163789b55903b3d))
    - All code needed to load extensions… ([`0a03f19`](https://github.com/yuki0iq/gitoxide/commit/0a03f196b7ec4dc1e0e2377c729467781c9e6c2c))
    - A step towards pasing V2 paths ([`01036ad`](https://github.com/yuki0iq/gitoxide/commit/01036ad1bafb6a830734a9dd4f4e2949b8981a30))
    - Most of the entry decoding, name is still missing ([`53e2d75`](https://github.com/yuki0iq/gitoxide/commit/53e2d754262d9752d3b106f7991543986ad5426f))
    - Extensions are optional, and so is their iteration ([`620d2e6`](https://github.com/yuki0iq/gitoxide/commit/620d2e6bd4ef6d3281c096aaf344669bcf49e723))
    - Prepare a more complex test for tree parsing, requires entry parsing ([`e7e0679`](https://github.com/yuki0iq/gitoxide/commit/e7e067977ef440cf3edb8812c0d614b5d8213b58))
    - Parse TREE chunk ([`a2ea498`](https://github.com/yuki0iq/gitoxide/commit/a2ea49841a333c8af18fd258781a649214a0ae0b))
    - Get closer to implementing a simple TREE extension decoding ([`49fcb6f`](https://github.com/yuki0iq/gitoxide/commit/49fcb6f6ae9d6ed47e7c0c3ea2aa644d4e8cd264))
    - Refactor ([`07e8fb2`](https://github.com/yuki0iq/gitoxide/commit/07e8fb2cb6b7819eb34676ede57808b845298674))
    - The first actual assetion ([`c17240d`](https://github.com/yuki0iq/gitoxide/commit/c17240d0cbd6134a77a69359611789f4eebc727d))
    - Refactor ([`d4b3a07`](https://github.com/yuki0iq/gitoxide/commit/d4b3a07489703fb6d5e9b9fb9328741172826db9))
    - Refactor ([`9fdd34b`](https://github.com/yuki0iq/gitoxide/commit/9fdd34b634f4f15eb6cf5c2e7912bdc32dd61de6))
    - Fix counting issue, checksum matches now ([`cc33752`](https://github.com/yuki0iq/gitoxide/commit/cc337526365a04a23571123531f1ae565d386bcf))
    - Another big step, even though EOIE checksum is still bugged ([`9ffd523`](https://github.com/yuki0iq/gitoxide/commit/9ffd5231c582a3870c6d25ea870c005e77e32276))
    - Right before implementing a traversal over extension chunks ([`79ca582`](https://github.com/yuki0iq/gitoxide/commit/79ca582045dd03434737c779b84c991acf1b0823))
    - Refactor ([`9b28b18`](https://github.com/yuki0iq/gitoxide/commit/9b28b18262c763608d60fba65e91fcb9ca3ddb3e))
    - First step towards reading the EOIE extension ([`068c716`](https://github.com/yuki0iq/gitoxide/commit/068c716b46699234d6ad1db70be34b894e61d76a))
    - Parse index header ([`5c731f8`](https://github.com/yuki0iq/gitoxide/commit/5c731f831d007a4fe099cadc4ecaab113ab7e08a))
    - First stab at basic index file parsing ([`826ca0c`](https://github.com/yuki0iq/gitoxide/commit/826ca0c6a6801ec2a67ca73ac17092e5f85fe9ce))
    - Refactor ([`494ed46`](https://github.com/yuki0iq/gitoxide/commit/494ed46acc54bd342f891416918032a2c4848cf1))
    - Git-index uses memmap2 ([`fbfea28`](https://github.com/yuki0iq/gitoxide/commit/fbfea28d2c9ed92e270c6a5aa603d3c84769ae8f))
    - The realization that FileBuffer really shouldn't be used anymore ([`b481f13`](https://github.com/yuki0iq/gitoxide/commit/b481f136c4084b8839ebecb604dea5aa30d3a44e))
    - Base setup for index testing ([`aa60fdf`](https://github.com/yuki0iq/gitoxide/commit/aa60fdf3d86e08877c88f9e4973f546642ed1370))
    - Notes on how test indices have been created ([`3040857`](https://github.com/yuki0iq/gitoxide/commit/3040857ec4d2e0557b4920eaa77ddc4292d9adae))
 * **[#298](https://github.com/yuki0iq/gitoxide/issues/298)**
    - Upgrade git-index->atoi to 1.0 ([`728dd65`](https://github.com/yuki0iq/gitoxide/commit/728dd6501b86b12e1d0237256f94059a7ead14a9))
    ...
    - Also print stage of entries ([`003515f`](https://github.com/yuki0iq/gitoxide/commit/003515f3c90a49fbe9db9b84987233486711beb8))
    - Simple printing of basic entry information ([`329538b`](https://github.com/yuki0iq/gitoxide/commit/329538b9c3f44bb8e70a4567ba90dc3b594c2dfc))
 * **[#301](https://github.com/yuki0iq/gitoxide/issues/301)**
    ...
    - Differentiate between owned and ref'ed path storage ([`c71b2bb`](https://github.com/yuki0iq/gitoxide/commit/c71b2bb944c3066e7e44fbdd8a2e511a5a5d944a))
    - `State::path_backing()`. ([`8ab219a`](https://github.com/yuki0iq/gitoxide/commit/8ab219ac47ca67f2478b8715d7820fd6171c0db2))
    - Sketch `open_index()` on `Worktree`, but… ([`ff76261`](https://github.com/yuki0iq/gitoxide/commit/ff76261f568f6b717a93b1f2dcf5d8e8b63acfca))
    - Support for separating lifetimes of entries and path-backing ([`645ed50`](https://github.com/yuki0iq/gitoxide/commit/645ed50dc2ae5ded2df0c09daf4fe366b90cf47e))
 ...
 * **[#427](https://github.com/yuki0iq/gitoxide/issues/427)**
    ...
    - Fix docs ([`5a0d6b7`](https://github.com/yuki0iq/gitoxide/commit/5a0d6b76205d6e021348a930a5a17820e5dc4458))
    - `Stage::entry_index_by_path_and_stage()`, now with `::entry_by_path_and_stage()` ([`6d8d5e6`](https://github.com/yuki0iq/gitoxide/commit/6d8d5e6198dfb4d648061807ed4f96868a36ee52))
    - `State::entry_by_path_and_stage()` to find entries. ([`55363ea`](https://github.com/yuki0iq/gitoxide/commit/55363ea650001b7717545b4d2968419707a3b8c6))
    - Refactor; prepare for entry-lookup by path ([`92de081`](https://github.com/yuki0iq/gitoxide/commit/92de081dc9ab5660cb18fa750452345dd63550ea))
    - `Debug` and `Clone` for `File` ([`40e6bde`](https://github.com/yuki0iq/gitoxide/commit/40e6bde125778e3b50999331c4ed5a4b119937fa))
 * **[#450](https://github.com/yuki0iq/gitoxide/issues/450)**
    - Clnoe for `File` ([`458e1bc`](https://github.com/yuki0iq/gitoxide/commit/458e1bcbd7043f0759f7445bfa46189910baff54))
 ...
 * **[#XXX](https://github.com/yuki0iq/gitoxide/issues/XXX)**
    - Add tests to run into long-paths special case ([`d7a8a7d`](https://github.com/yuki0iq/gitoxide/commit/d7a8a7dfe3089e35fca249af7a3482a893f91111))
 * **Uncategorized**
    ...
    - Fix link in docs for `sort_entries_by` ([`eb48b16`](https://github.com/yuki0iq/gitoxide/commit/eb48b162c3f9c449de0fabfc2e8a33001a2d14d0))
    ...
    - Rename `git-index` to `gix-index` ([`ecd3541`](https://github.com/yuki0iq/gitoxide/commit/ecd354119c3a8b150a06df7205ddf022a825d6cd))
    ...
    - Make error handling of split index to seemingly be en-par with 'git' ([`cec2547`](https://github.com/yuki0iq/gitoxide/commit/cec2547758b91fa340130d55a3920445b75b3636))
    - Read shared indices by dissolving them into the current one. ([`5dc408f`](https://github.com/yuki0iq/gitoxide/commit/5dc408f726d6f0f480438348eb5d713776329710))
    - Inline bounds checks ([`dc3fd48`](https://github.com/yuki0iq/gitoxide/commit/dc3fd48327a16bf8599eaf70b55ab6c1d754e4bb))
    - Remove `VerifiedBitmaps` structure… ([`49cf105`](https://github.com/yuki0iq/gitoxide/commit/49cf105329c7f84c314c11e50fdb039984fa94b3))
    ...
    - Move error handling into its own function ([`2b22d91`](https://github.com/yuki0iq/gitoxide/commit/2b22d91f4b4f3aceab25cd54aa09aadff085d6ee))
    - Release git-index v0.12.1 ([`8aa5c1d`](https://github.com/yuki0iq/gitoxide/commit/8aa5c1db9e342cc49dfa588d5b4b9f893067dbf7))
    - Merge branch 'various-improvements' ([`f191c1a`](https://github.com/yuki0iq/gitoxide/commit/f191c1af14e512967ccb788fe997dafc5bb0e111))
    - Add `impl Debug for State` to print all entries in a digestible form. ([`6d8eb9f`](https://github.com/yuki0iq/gitoxide/commit/6d8eb9f267ac7ef8db0f3a277c8c991df5ce8164))
    - Add `State::sort_entries_by(...)` to allow comparing by additional criteria. ([`7c8ba2c`](https://github.com/yuki0iq/gitoxide/commit/7c8ba2c945d6313d27569f04b83ebf9a2387e6a2))
    - Update documentation to make users of `State::dangerously_push_entry()` more aware. ([`b56de39`](https://github.com/yuki0iq/gitoxide/commit/b56de392c632e9137091b7720208c38b162db7e7))
    ...
    - Merge branch 'various-improvements' ([`9eee8fe`](https://github.com/yuki0iq/gitoxide/commit/9eee8fe1bed116b7a5a4f552982fa49da83ee92c))
    - `entry::Time` can convert from and to system time. ([`1e3341a`](https://github.com/yuki0iq/gitoxide/commit/1e3341a77c089e6d80c271fca46b774b01b01386))
    - Add `State::sort_entries()` and `State::dangerously_push_entry()`. ([`654bd8f`](https://github.com/yuki0iq/gitoxide/commit/654bd8f62d5546b0f57e82d1be8211431685c7ce))
    - Improved error handling - panicing version ([`9509891`](https://github.com/yuki0iq/gitoxide/commit/9509891a63a0e2291818943366be6a085b9dd198))
    - Add `State::entry_mut_by_path_and_stage()` ([`aa1b6ee`](https://github.com/yuki0iq/gitoxide/commit/aa1b6ee1edeaebae1237184c635f69fdbb23ffee))
    - `State::write_to()` respects the `REMOVED` flag. ([`3ebe2d4`](https://github.com/yuki0iq/gitoxide/commit/3ebe2d490b2dbdcb6fe0115b06f205f1c4008fff))
    - Expose `git_hash` as `hash` in the root of the crate. ([`ec36586`](https://github.com/yuki0iq/gitoxide/commit/ec365866c746247b7d5d47b88d51d9cc255724fb))
    - Add `File::at_or_default(...)` to easily open or create an empty in-memory index. ([`5cc3a15`](https://github.com/yuki0iq/gitoxide/commit/5cc3a15a8085a67701fc1f2d3ba0e55f71d0a4c0))
    - Add `State::new()` to create a new empty in-memory index. ([`0b40951`](https://github.com/yuki0iq/gitoxide/commit/0b40951f0fb9ee354a83751264ed89d0608111f8))
    - Remove `File::into_state()` in favor of `From<File> for State`. ([`3753ad5`](https://github.com/yuki0iq/gitoxide/commit/3753ad58a8303fbf325b07757b2b97c34253bca4))
    - Add `File::set_path()` to allow setting the location of an index file on disk. ([`a7183e2`](https://github.com/yuki0iq/gitoxide/commit/a7183e28513fa1e1a1a784b759677f0e4b4db5f4))
    ...
    - Assure recursive shared indices (possibly malicious) don't crash us ([`ede718c`](https://github.com/yuki0iq/gitoxide/commit/ede718c24a5a5000bd41f49faabc7f2b19979e15))
    - Refactor ([`d6ba366`](https://github.com/yuki0iq/gitoxide/commit/d6ba3669f175e869060c97d359918e4901bde989))
    - Refactor ([`c840c0d`](https://github.com/yuki0iq/gitoxide/commit/c840c0d80aef8b4aadbd119108d2fb4c95a2503b))
    ...
    - Upload missing fixture archive ([`5cab553`](https://github.com/yuki0iq/gitoxide/commit/5cab5530350c9d2792f3aea6cb8591a0602efee2))
    - Fix failing test… ([`1057ee4`](https://github.com/yuki0iq/gitoxide/commit/1057ee4309dfd44d9a160b799c0d704eaa8cce64))
    - Refactor ([`dfd00e5`](https://github.com/yuki0iq/gitoxide/commit/dfd00e52e288e4253527b3bd3559484acc45d3c6))
    - Test is green ([`800fc2b`](https://github.com/yuki0iq/gitoxide/commit/800fc2b7b6e802dacebf905ed72d5028d807758e))
    - Sketch `resolve_link_extension` function ([`c62a25b`](https://github.com/yuki0iq/gitoxide/commit/c62a25b9001cf6363314b6f90eab22b17ab7aff1))
    - Add test that compares split index with regular index ([`fc89517`](https://github.com/yuki0iq/gitoxide/commit/fc89517dffeb51ac56a33fdfe7ff1402136d488a))
    ...
    - Upgrade atoi from 1 to 2 ([`be6c65c`](https://github.com/yuki0iq/gitoxide/commit/be6c65cb0fb056ae918b28050440946d0c2c9ada))
    ...
    - Merge branch 'named-threads' ([`726dd87`](https://github.com/yuki0iq/gitoxide/commit/726dd87b5db45c333ccad898338a1cacea9e3269))
    - Name spawned threads ([`fd2dd3a`](https://github.com/yuki0iq/gitoxide/commit/fd2dd3a74c8d64407c1c27f29a2914389ded3bd6))
    ...
    - Merge branch 'fixes-for-crates-index-diff' ([`255be4d`](https://github.com/yuki0iq/gitoxide/commit/255be4ddcd6cbca0a89f286eeecdd19ff70e000f))
    - Remove unused import; fix docs ([`efe0a51`](https://github.com/yuki0iq/gitoxide/commit/efe0a51931fc7e42c82563575e3068dd6e401409))
    ...
    - Merge branch 'write-sparse-index' ([`ba17db0`](https://github.com/yuki0iq/gitoxide/commit/ba17db03e4e832db724ab3e08e3df05eb61dd401))
    - Thanks clippy ([`49b539b`](https://github.com/yuki0iq/gitoxide/commit/49b539baf1be88961a9e2934ee714090f94ac57f))
    - Remove tests and scaffolding code that probably won't be implemented soon. ([`177d1c8`](https://github.com/yuki0iq/gitoxide/commit/177d1c8be2b73ab0e7534d8ba9a47c451e02cfbb))
    - Refactor ([`0a74625`](https://github.com/yuki0iq/gitoxide/commit/0a7462568c65057fb92b3824d0a73218c5184b2a))
    - Act like git and write a sparse index even if it contains no dir entries anymore. ([`53af48c`](https://github.com/yuki0iq/gitoxide/commit/53af48cff26542b4acf1510862f7ac0e94b24b2b))
    - Bake knowledge about sparse related config parameters into types. ([`e61957e`](https://github.com/yuki0iq/gitoxide/commit/e61957e16eefe61d222997c69c1ae4c8ea0a8b5f))
    ...
    - Add and use `checked_is_sparse()` instead of cached `is_sparse` flag ([`e41ad0f`](https://github.com/yuki0iq/gitoxide/commit/e41ad0fe585699b3d6cf3b3106567073e0a5ed5d))
    - Refactor ([`3683963`](https://github.com/yuki0iq/gitoxide/commit/36839630f1471bd73a13276652f3a6ddd1286faa))
    - Thanks clippy ([`646b868`](https://github.com/yuki0iq/gitoxide/commit/646b86802a669469b8cdfc228594a373a41e0f37))
    - Added fixture, adjusted tests, refactor ([`3173c0b`](https://github.com/yuki0iq/gitoxide/commit/3173c0b2f79fbba7d73e391cc5667ca35a56a3a1))
    - Make clear in code that mandatory extensions will always be written… ([`3e37443`](https://github.com/yuki0iq/gitoxide/commit/3e3744301c3a80f98751551f779c3105262b3fec))
    - Respect the current 'is_sparse()` state when writing. ([`2012b27`](https://github.com/yuki0iq/gitoxide/commit/2012b27246e8835b19725862409d2df23a2638c6))
    - Refactor ([`a929bcf`](https://github.com/yuki0iq/gitoxide/commit/a929bcf4ff5a2e383218cce6b12776e40c553b83))
    - Thanks clippy ([`5bfd947`](https://github.com/yuki0iq/gitoxide/commit/5bfd94711568174afe3a344514745dcd6a4992a4))
    - Sketch out how a write implementation could work ([`4a6d46f`](https://github.com/yuki0iq/gitoxide/commit/4a6d46f3ab3d15eb851c92f7e49eb6772bc4023b))
    - Regenerated archive ([`cd1c752`](https://github.com/yuki0iq/gitoxide/commit/cd1c752fde943804689039684b60ae4ddffee3f1))
    - Updated docs ([`77a9d42`](https://github.com/yuki0iq/gitoxide/commit/77a9d42ec4f5b5f0b4fcbb31fdf2e5eb57bb578b))
    - Added first tests and implementation for writing the `sdir` extension ([`66a675f`](https://github.com/yuki0iq/gitoxide/commit/66a675f68e46e6eaf7464912d2fb8af976c18565))
    - Capability to write `sdir`extension ([`762e4cb`](https://github.com/yuki0iq/gitoxide/commit/762e4cb2a55728f6b82a97164c4ac4b59035d2e8))
    - Added tests for reading sparse indexes ([`ddaa003`](https://github.com/yuki0iq/gitoxide/commit/ddaa003246fce16578b455077d98519ac05c6dae))
    - Add temporary sparse index playground testfile ([`5589a7f`](https://github.com/yuki0iq/gitoxide/commit/5589a7fb4df6650214b7210bd89257ecaf9cabd0))
    - Add sparse index text fixtures ([`8a8a53e`](https://github.com/yuki0iq/gitoxide/commit/8a8a53e8432af7a96fd7eff9af0bd241c7b3facd))
    - Add `is_sparse` access method for `State` ([`7f012cf`](https://github.com/yuki0iq/gitoxide/commit/7f012cf5f85634bd520065ecb39bb1bd19a987fa))
    ...
    - `write::Options::object_hash` is now implied by the `State` itself. ([`59f6791`](https://github.com/yuki0iq/gitoxide/commit/59f679126aba6f8a432aeb53f0bbd5d136ec1deb))
    - `decode::Options::object_hash` is now a parameter to methods. ([`908163a`](https://github.com/yuki0iq/gitoxide/commit/908163ab2f86a1b603e69f04cd857fbf52e5abfb))
    - `decode::Options::default_from_object_hash()` ([`9e03110`](https://github.com/yuki0iq/gitoxide/commit/9e03110578bd93da3f1a91c5bcd9fde942c81ac4))
    - Refactor ([`6fb3255`](https://github.com/yuki0iq/gitoxide/commit/6fb3255fb94758c025ed9edd971bdde54f409e77))
    - Seal `File` members to preserve consistency better. ([`92dda50`](https://github.com/yuki0iq/gitoxide/commit/92dda50e2d9c584b0e110026f59fb715ec41600a))
    - `decode::Options::default()` - remove `Default` impl. ([`bd312ac`](https://github.com/yuki0iq/gitoxide/commit/bd312acf5ceba28edf2508aef6011c037eb0a377))
    - Fix tests ([`fc5cee1`](https://github.com/yuki0iq/gitoxide/commit/fc5cee1d4f757b634856b9d91df1b4455a63f860))
    - Assure we also write V3 files, validate auto-version discovery ([`abc3cf8`](https://github.com/yuki0iq/gitoxide/commit/abc3cf894f18f1a3c04de7967748add15b2e040e))
    - Loose fixtures are usable more easily now ([`b86012b`](https://github.com/yuki0iq/gitoxide/commit/b86012bd5407e67159c2cc86ce97525d92189284))
    - Remove `write::Options::default()`. ([`2da5a62`](https://github.com/yuki0iq/gitoxide/commit/2da5a62432350ede6b816254c894863d14aa4ba1))
    - `File::write()` for secure and complete writing of index files. ([`eedcffa`](https://github.com/yuki0iq/gitoxide/commit/eedcffa728c7e895da51d5298db28f3fef05f7da))
    - Prepare test for writing a complete index file from arbitrary state ([`281f5b8`](https://github.com/yuki0iq/gitoxide/commit/281f5b828a2dbabd751e214b420e37d1d1e3a028))
    - Merge branch 'gix-index-from-tree' ([`8c24386`](https://github.com/yuki0iq/gitoxide/commit/8c24386f1874cd94f78fefbe434963f772878b1f))
    - Refactor ([`08d5c0b`](https://github.com/yuki0iq/gitoxide/commit/08d5c0b051572b7e7b51eb7bd7dd804b1fa6a1ab))
    ...
    - Remove the .insert() call… ([`4bb3e8b`](https://github.com/yuki0iq/gitoxide/commit/4bb3e8bd50958ddbfdee72247025a80a2ca850a8))
    ...
    - Fix docs ([`87f6db7`](https://github.com/yuki0iq/gitoxide/commit/87f6db7a7dc1561d06747135be206f700b75257c))
    - Merge branch 'index-from-tree' ([`172f73c`](https://github.com/yuki0iq/gitoxide/commit/172f73cf26878d153d51790fa01853fa4ba6beb7))
    - Refactor ([`c40528e`](https://github.com/yuki0iq/gitoxide/commit/c40528e86353fefe317d2b1ad33ff1236e589523))
    - Refactor ([`b2835cc`](https://github.com/yuki0iq/gitoxide/commit/b2835cc28e10907eb375b2beb400cf408fa5a3e0))
    - Remove depthfirst traversal todo ([`5ca7945`](https://github.com/yuki0iq/gitoxide/commit/5ca79458b11e0ead0027c64eecbc259b95f35ed5))
    - Add test fixture and adjust ([`e153340`](https://github.com/yuki0iq/gitoxide/commit/e153340f52bc13a980f347b215bc1337417bbbb4))
    - Overwrite duplicate entries (like 'git')… ([`16d8944`](https://github.com/yuki0iq/gitoxide/commit/16d8944b492f9f70a2a29403f2ac1e1a3e50f450))
    - Refactor ([`49dc4a6`](https://github.com/yuki0iq/gitoxide/commit/49dc4a6967912df68bc4394f331b3a5242cf52e9))
    - Refactor ([`c2524a6`](https://github.com/yuki0iq/gitoxide/commit/c2524a635627449f5bcdd51b37a1dcd55ee0c193))
    - Refactor ([`6683081`](https://github.com/yuki0iq/gitoxide/commit/668308139e5981094ed2b059a97f1c1245b04dc1))
    - Compare individual entries more thoroughly ([`1c9b703`](https://github.com/yuki0iq/gitoxide/commit/1c9b703db10aa01e127f2a0eafe24f2aa1fefee7))
    - Thanks clippy ([`878593e`](https://github.com/yuki0iq/gitoxide/commit/878593e4d0a5e74df267ac7d0bdaf827b7588043))
    - Refactor... ([`dce45e6`](https://github.com/yuki0iq/gitoxide/commit/dce45e6ffdfe0031349bfff006e5e7140c2f515c))
    - :init module ([`6c17f96`](https://github.com/yuki0iq/gitoxide/commit/6c17f96fcee9e2935b464c8ffbd30b253d9f5a6c))
    - Refactor `Entry::cmp` ([`3a58c3e`](https://github.com/yuki0iq/gitoxide/commit/3a58c3eb0b2802cd9acf05d8104a1b3a1dbc09bd))
    ...
    - Refactor ([`bba180d`](https://github.com/yuki0iq/gitoxide/commit/bba180d78c182c873cc968bfd40186876dfde671))
    ...
    - Added more fixtures to test ([`adf5e54`](https://github.com/yuki0iq/gitoxide/commit/adf5e5422a871ea435bb0ec320744b63f53d3159))
    - Initial test and implementation for State::from_tree ([`14694a4`](https://github.com/yuki0iq/gitoxide/commit/14694a4aeff7f05818aa7851e0e2fa56e911322c))
    ...
    - Fix CI for good ([`e0c0b8c`](https://github.com/yuki0iq/gitoxide/commit/e0c0b8c7c1898b2bc11a915e8e4fb8426295ccbb))
    - Fix CI ([`2433be1`](https://github.com/yuki0iq/gitoxide/commit/2433be173c2145198f7891dc7a1f7c4acf215b11))
    - Merge branch 'index-write-refactor' ([`805f432`](https://github.com/yuki0iq/gitoxide/commit/805f432bf8e9d2dd9ede56caf959de386d5d80c7))
    - Refactor ([`3af5121`](https://github.com/yuki0iq/gitoxide/commit/3af5121330ae96aec32d0360c8b2e24a8860a2e8))
    - Refactor ([`b41d93a`](https://github.com/yuki0iq/gitoxide/commit/b41d93ac604b9807c24d93c6849f852489f512c0))
    - Thanks clippy ([`4390c32`](https://github.com/yuki0iq/gitoxide/commit/4390c32f9ea0683561a78349456c87329fef3b41))
    - Run tests against all input files we have ([`de8abe6`](https://github.com/yuki0iq/gitoxide/commit/de8abe6923b01563db812ba007ea65b7f193082d))
    - Combine more tests into one to reduce duplication ([`933ad9e`](https://github.com/yuki0iq/gitoxide/commit/933ad9e8ff0d58ad2590907cf84b43bc424e3219))
    - Assure that extended flags receive version 3; make `version` an implementation detail ([`6d810a1`](https://github.com/yuki0iq/gitoxide/commit/6d810a135eeb71b8b04f7d9cb6c5f115587c2a63))
    - Support for extended flags, and V3 as it's a requirements. ([`417d90e`](https://github.com/yuki0iq/gitoxide/commit/417d90eb267dd74a5372f1c7d8feb7cb4e98d2a1))
    - Refcator ([`27993c0`](https://github.com/yuki0iq/gitoxide/commit/27993c01a1533d561629635336c5cedf53dd0efc))
    - Fix tree ext reading and writing; round-trip with long path works now ([`f93febe`](https://github.com/yuki0iq/gitoxide/commit/f93febe2d2c55938ac8f698b57144583caab54ef))
    - First PoC for writing long paths, even though it doens't produce the entire file yet ([`581cbd7`](https://github.com/yuki0iq/gitoxide/commit/581cbd7afeac0f7654611c83deacae802ef5da6f))
    - Make it more explicit to write all available extensions by default ([`fbe9815`](https://github.com/yuki0iq/gitoxide/commit/fbe981519446e55c4020e95841e7bff7e54e358e))
    - Fix docs ([`9861a6c`](https://github.com/yuki0iq/gitoxide/commit/9861a6ce8abc438a1e0739aa6d55ced450a4465b))
    - Thanks clippy ([`834be93`](https://github.com/yuki0iq/gitoxide/commit/834be93e6db84bb9160dd4677b7e9d63213c23cd))
    - Thanks clippy ([`9b3a940`](https://github.com/yuki0iq/gitoxide/commit/9b3a940d9f4694912f32cb86752f3f7507882010))
    - Generalize extension writing so that writing more will be easier ([`8ef5378`](https://github.com/yuki0iq/gitoxide/commit/8ef5378dfaefe2d562d16b861fb4bb0fa4fdfe93))
    - Generalize EOIE exstension writing ([`18b722e`](https://github.com/yuki0iq/gitoxide/commit/18b722e06bfb8bbbf0ada7438266e31a4317f2d4))
    - Provide a stand-alone way of writing end-of-index extensions ([`7ca297a`](https://github.com/yuki0iq/gitoxide/commit/7ca297af400e50d42cffcaab54b1684f6810eb4f))
    - Refactor ([`a5b2ef9`](https://github.com/yuki0iq/gitoxide/commit/a5b2ef9a33720312a6b30b7cdae564bf759b0218))
    - Additional validation ([`ee7b5bb`](https://github.com/yuki0iq/gitoxide/commit/ee7b5bba09bc20e1531cb733b5b2aac8232e7674))
    - Refactor ([`e35aac6`](https://github.com/yuki0iq/gitoxide/commit/e35aac66079464a9494744c201355ab2faa0a2b3))
    - Refactor ([`52386f4`](https://github.com/yuki0iq/gitoxide/commit/52386f4a8ee11b0d2858412b4b5ec4b73544ba30))
    - Refactor ([`75a2338`](https://github.com/yuki0iq/gitoxide/commit/75a2338fe9cfac478164b7b575c0f3c2b910111d))
    - Refactor ([`f6f2861`](https://github.com/yuki0iq/gitoxide/commit/f6f2861f57be8ad4c795c90ae6fc7e568aeb12da))
    - Refactor ([`6cf9277`](https://github.com/yuki0iq/gitoxide/commit/6cf92776b0349bf735c28b6275fdf551ce236d4d))
    - Refactor ([`a6354c0`](https://github.com/yuki0iq/gitoxide/commit/a6354c076b2967ff31feb30e7b73f0a6eb92a459))
    - Fill in all remaining documentation, raise `git-index` to 'usable' state ([`3568ae3`](https://github.com/yuki0iq/gitoxide/commit/3568ae3a1ed7c2d0c9b7e1dc690b055b4f43bdd2))
    - First step towards everything being documented ([`919923c`](https://github.com/yuki0iq/gitoxide/commit/919923c08b641ca148c2f25d193d65bb068cc787))
    - Remove quickerror in favor of thiserror ([`dd7ce3f`](https://github.com/yuki0iq/gitoxide/commit/dd7ce3f77c868f81196103b021957ace54ca2b9c))
    - Refactor ([`618736b`](https://github.com/yuki0iq/gitoxide/commit/618736b614330d9576e58c5bb9b3696de3f76d84))
    - Refactor ([`4dda27e`](https://github.com/yuki0iq/gitoxide/commit/4dda27e716927a506e16da9d6cd50547de1fc84e))
    - Added test for eoie extension ([`a433c0d`](https://github.com/yuki0iq/gitoxide/commit/a433c0d7feebebdf17e9d362894a6fa38221b402))
    - Estimate vector size for tree entries ([`74455e6`](https://github.com/yuki0iq/gitoxide/commit/74455e65e3ef48ce55fa40b7d9ef050a8e0e9b84))
    - Implemented File::write_to for hashed write ([`6b6db34`](https://github.com/yuki0iq/gitoxide/commit/6b6db340b351836f055d8ab74ed3d3f370cca7be))
    - Refactor and add more tests ([`6b32bcf`](https://github.com/yuki0iq/gitoxide/commit/6b32bcfde1af3ada67a6fa0448611d0ecca2f605))
    - Merge branch 'write-index-files' into write-index-v2 ([`cddc2ca`](https://github.com/yuki0iq/gitoxide/commit/cddc2ca06f63f66e887ff821452d1f56fb08fe6a))
    - Thanks clippy ([`a66403c`](https://github.com/yuki0iq/gitoxide/commit/a66403c8e14716023455d606e1c63787ac40f4f4))
    - Write wrapper to count written bytes ([`b147090`](https://github.com/yuki0iq/gitoxide/commit/b147090bafd22da07f475a167bb921f3e0fa0017))
    - Refactor test ([`33a3009`](https://github.com/yuki0iq/gitoxide/commit/33a3009c4d851fae9156cb3bdb664c05118ef442))
    ...
    - Refactor... ([`81eef35`](https://github.com/yuki0iq/gitoxide/commit/81eef353f8f2add26720e3dd3981ce1b790f996c))
    - Refactor tests... ([`3a9b51b`](https://github.com/yuki0iq/gitoxide/commit/3a9b51b0fe812d454378c8ac887bba11740a81ee))
    - Convert 'in-memory' flags to 'storage' flags ([`017377d`](https://github.com/yuki0iq/gitoxide/commit/017377d8c49c236bb3ab240794dbd7a714efb7e1))
    - Merge branch 'write-index-files' into rev-parse-delegate ([`370110d`](https://github.com/yuki0iq/gitoxide/commit/370110d3356528af38150c2280ed505354ceca5b))
    - Small improvements ([`e5cb6d9`](https://github.com/yuki0iq/gitoxide/commit/e5cb6d94ef31e007847a6072ead8962b16eba105))
    - Fix pathname in test ([`1f18e19`](https://github.com/yuki0iq/gitoxide/commit/1f18e19fd3c07b540d56c86afa4cb708ad1126ac))
    - Thanks clippy ([`3f72180`](https://github.com/yuki0iq/gitoxide/commit/3f7218044fdc9d24693c04e0c1c97069c9a3f698))
    - Sucesfully writing the first basic index files ([`a9c6f22`](https://github.com/yuki0iq/gitoxide/commit/a9c6f2260e96928d678b29a765c26e88f0ff5908))
    ...
    - Setup and refactor tests ([`7eed237`](https://github.com/yuki0iq/gitoxide/commit/7eed2375a3f076e6fdf9dde4673733e85d5612aa))
    - Generate index header ([`f1d7c1c`](https://github.com/yuki0iq/gitoxide/commit/f1d7c1c137c712ecca76b8e69b11481bf0f1a860))
    ...
    - Refactor ([`afdeca1`](https://github.com/yuki0iq/gitoxide/commit/afdeca1e5ec119607c5d1f5ccec5d216fc7d5261))
    - Thanks clippy ([`2f25bf1`](https://github.com/yuki0iq/gitoxide/commit/2f25bf1ebf44aef8c4886eaefb3e87836d535f61))
    - Thanks clippy ([`d721019`](https://github.com/yuki0iq/gitoxide/commit/d721019aebe5b01ddb15c9b1aab279647069452a))
    - Merge branch 'index-information' ([`025f157`](https://github.com/yuki0iq/gitoxide/commit/025f157de10a509a4b36a9aed41de80487e8c15c))
    ...
    - Upgrade to tui 0.17 and prodash 18 ([`eba101a`](https://github.com/yuki0iq/gitoxide/commit/eba101a576ecb7bc0f63357d0dd81eb817b94be4))
    - Dependency update ([`ca59e44`](https://github.com/yuki0iq/gitoxide/commit/ca59e448061698dd559db43123fe676ae61129a0))
    ...
    - Thanks clippy ([`09df2bc`](https://github.com/yuki0iq/gitoxide/commit/09df2bcb4b45f72742d139530907be8aa4dc36f8))
    - Thanks clippy ([`93c3d23`](https://github.com/yuki0iq/gitoxide/commit/93c3d23d255a02d65b5404c2f62f96d94e36f33d))
    - Fix index without extension test & thanks clippy ([`066464d`](https://github.com/yuki0iq/gitoxide/commit/066464d2ad2833012fa196fe41e93a54ab05457f))
    - Thanks clippy ([`f477032`](https://github.com/yuki0iq/gitoxide/commit/f47703256fe6a5c68ed3af6705bcdf01262500d6))
    - Thanks clippy ([`5526020`](https://github.com/yuki0iq/gitoxide/commit/552602074a99dc536624f0c6295e807caf32f58b))
    - Thanks clippy ([`591511a`](https://github.com/yuki0iq/gitoxide/commit/591511a739f91c5e8ff4243059ac98052a44c914))
    ...
    - Add placeholder for git-index crate ([`52ff13c`](https://github.com/yuki0iq/gitoxide/commit/52ff13cf260b53423faf59e5c666ff1565bde947))
</details>
