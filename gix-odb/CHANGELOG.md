 ...
 * **Uncategorized**
    ...
    - Improve error message for when there is too many packs. ([`a773854`](https://github.com/yuki0iq/gitoxide/commit/a773854a798bb2315dcce347d86b856b8fac8dc9))
 ...
 * **Uncategorized**
    ...
    - Various minor changes ([`5fd0ab9`](https://github.com/yuki0iq/gitoxide/commit/5fd0ab90e3fbdc7c82b390520e007e258d7d0ce8))
 ...
 * **Uncategorized**
    ...
    - Improve handling of overflows when there are more pack than we can hold. ([`724601d`](https://github.com/yuki0iq/gitoxide/commit/724601d474ce4acd30ee482e77fd96be2fe3425b))
    ...
    - Adapt to changes in `gix-hash` ([`201e853`](https://github.com/yuki0iq/gitoxide/commit/201e853b151983502377b1f04d821c07d159014f))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `gix-object` ([`528f549`](https://github.com/yuki0iq/gitoxide/commit/528f549a3572eabb2ad137707a2ef5051d6414a4))
    ...
    - Add `InMemoryPassThrough` implementation. ([`ca5294a`](https://github.com/yuki0iq/gitoxide/commit/ca5294af0971da372c5d5a5c7a569810dd53de93))
 ...
 * **Uncategorized**
    ...
    - More robustness in the face of a trampling-herd of threads loading a single index. ([`addf446`](https://github.com/yuki0iq/gitoxide/commit/addf446f052ff74edcdb083f2b2968b313daa940))
    - Use `tempfile` permissions support to set the correct mode on unix. ([`7b3dc92`](https://github.com/yuki0iq/gitoxide/commit/7b3dc92d04e5240a7bdbcdaa4019ac93cec6eaa3))
</details>
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `gix-object` (Find::try_header()) ([`336d161`](https://github.com/yuki0iq/gitoxide/commit/336d161a4a291b5cb03c08e637c6f47a05731996))
    ...
    - Adapt to changes in `gix-pack` ([`40e7440`](https://github.com/yuki0iq/gitoxide/commit/40e74404e87e44b0b2a5fe3d294f3ddc5ed2ba88))
    - Remove `Find` trait (as it's now living in `gix-odb`) ([`fad2982`](https://github.com/yuki0iq/gitoxide/commit/fad298228ca91298abe42af41defb8f6c89c3cc9))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `gix-object` ([`ffcb110`](https://github.com/yuki0iq/gitoxide/commit/ffcb110135e4597d8953b97da3db9ecc3cf12e34))
</details>
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `gix-pack` ([`46a4d4d`](https://github.com/yuki0iq/gitoxide/commit/46a4d4d873610ba88d51bce865404b904b2b7cb3))
 ...
 * **Uncategorized**
    ...
    - Remove version specifications from dev dependencies ([`e80ed04`](https://github.com/yuki0iq/gitoxide/commit/e80ed04f1cc065c5f4ddf196e780a8a8511a8069))
    ...
    - Reorganize tests to get rid of feature toggles that are for internal testing only ([`01c6ef6`](https://github.com/yuki0iq/gitoxide/commit/01c6ef62e260246f1623bdf05f49c03eff14ac69))
 ...
 * **Uncategorized**
    ...
    - Add note go ODB initialization in preparation for dealing with many small packs. ([`090357e`](https://github.com/yuki0iq/gitoxide/commit/090357ee7b36ead5c622b13b1fabab5174499d82))
</details>
 ...
 * **Uncategorized**
    ...
    - Add `Store::alternate_db_paths()`. ([`8c72a23`](https://github.com/yuki0iq/gitoxide/commit/8c72a236dbeb71a4aead45bf82010f1c89829540))
    ...
    - Implement `Clone` for `Sink`. ([`3db18c4`](https://github.com/yuki0iq/gitoxide/commit/3db18c45e8b26243907521ffd11156afed28a0a3))
...
<csr-read-only-do-not-edit/>
 ...
 - 27 days passed between releases.
 - 3 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 2 unique issues were worked on: [#814](https://github.com/yuki0iq/gitoxide/issues/814), [#819](https://github.com/yuki0iq/gitoxide/issues/819)
 ...
 * **[#819](https://github.com/yuki0iq/gitoxide/issues/819)**
    - Collisions of newly written object's don't trigger collisions anymore. ([`416cecc`](https://github.com/yuki0iq/gitoxide/commit/416ceccf7eaf1946efed5a2c95461a2690ae367a))
 * **Uncategorized**
    ...
    - Set permissions of newly written loose objects to be similar to `git`. ([`07e11cf`](https://github.com/yuki0iq/gitoxide/commit/07e11cf210682337f777f1cbbc0d25794c1179ca))
    - Make empty `sink` module non-public. ([`45a0ac1`](https://github.com/yuki0iq/gitoxide/commit/45a0ac192dd15500d577838e850edb56187f42c2))
 ...
 * **Uncategorized**
    ...
    - Remove `num_cpus` dependency in favor of `std::thread::available_parallelism()` ([`9567102`](https://github.com/yuki0iq/gitoxide/commit/9567102d4e1a729f7f9882f688365784b9813ac6))
...
<csr-read-only-do-not-edit/>
 ...
 - 26 unique issues were worked on: [#198](https://github.com/yuki0iq/gitoxide/issues/198), [#222](https://github.com/yuki0iq/gitoxide/issues/222), [#250](https://github.com/yuki0iq/gitoxide/issues/250), [#254](https://github.com/yuki0iq/gitoxide/issues/254), [#259](https://github.com/yuki0iq/gitoxide/issues/259), [#260](https://github.com/yuki0iq/gitoxide/issues/260), [#266](https://github.com/yuki0iq/gitoxide/issues/266), [#279](https://github.com/yuki0iq/gitoxide/issues/279), [#287](https://github.com/yuki0iq/gitoxide/issues/287), [#293](https://github.com/yuki0iq/gitoxide/issues/293), [#298](https://github.com/yuki0iq/gitoxide/issues/298), [#301](https://github.com/yuki0iq/gitoxide/issues/301), [#329](https://github.com/yuki0iq/gitoxide/issues/329), [#331](https://github.com/yuki0iq/gitoxide/issues/331), [#333](https://github.com/yuki0iq/gitoxide/issues/333), [#364](https://github.com/yuki0iq/gitoxide/issues/364), [#384](https://github.com/yuki0iq/gitoxide/issues/384), [#427](https://github.com/yuki0iq/gitoxide/issues/427), [#470](https://github.com/yuki0iq/gitoxide/issues/470), [#536](https://github.com/yuki0iq/gitoxide/issues/536), [#59](https://github.com/yuki0iq/gitoxide/issues/59), [#63](https://github.com/yuki0iq/gitoxide/issues/63), [#67](https://github.com/yuki0iq/gitoxide/issues/67), [#691](https://github.com/yuki0iq/gitoxide/issues/691), [#724](https://github.com/yuki0iq/gitoxide/issues/724), [#XXX](https://github.com/yuki0iq/gitoxide/issues/XXX)
 ...
 * **[#266](https://github.com/yuki0iq/gitoxide/issues/266)**
    - More explicit information about how much garbaged is in the slotmap ([`cfd36ee`](https://github.com/yuki0iq/gitoxide/commit/cfd36ee60172a13d147dea06c9ad5db76501053a))
    - Assure stable handles can actually access the indices hey need ([`9474a43`](https://github.com/yuki0iq/gitoxide/commit/9474a439dd884d4d7a54e87beab212a0b0ced030))
    - A failing test to show the handle-stability doesn't quite work yet ([`5562e88`](https://github.com/yuki0iq/gitoxide/commit/5562e8888cd8ac8fc3d89a41f8e8cc5cec7b8ca6))
    - Refactor ([`c499843`](https://github.com/yuki0iq/gitoxide/commit/c499843485a8af102cb4d3594c4e6014976c5aa0))
    - Docs for dynamic object store ([`2c2a2e9`](https://github.com/yuki0iq/gitoxide/commit/2c2a2e9d69e917983518ee91c66c96e90d34850e))
    - Default handle refresh mode is the least surprising, with option to configure ([`1b74c14`](https://github.com/yuki0iq/gitoxide/commit/1b74c14c99a3076753f166dc1a6a4451bca490d2))
    ...
    - Refactor ([`3da91ce`](https://github.com/yuki0iq/gitoxide/commit/3da91ce78ae582989cc1da136a1884dfe21de2b3))
    - Move `sink::Sink` to the top-level exclusively ([`ab4e726`](https://github.com/yuki0iq/gitoxide/commit/ab4e726fcec65871a81056a9c69af8ea3f56b2a3))
    - Dynamic store module cleanu ([`494772c`](https://github.com/yuki0iq/gitoxide/commit/494772cec65a5c29d0c45e4f130cc9a8ee2023b9))
    - Adapt to changes in git-odb ([`a44dd4b`](https://github.com/yuki0iq/gitoxide/commit/a44dd4b5d1910856d7a21e156e7bca3138c04484))
    - Move `loose::iter::Iter` to `loose::Iter` ([`8bb5c9a`](https://github.com/yuki0iq/gitoxide/commit/8bb5c9a75cd91ae0d888bc8e93707cfc9cc08090))
    - Minor improvements to module layout, docs ([`0364f48`](https://github.com/yuki0iq/gitoxide/commit/0364f48ff4cd25bd4e73524651b68e65694bb5f7))
    - Fix docs ([`360bf9d`](https://github.com/yuki0iq/gitoxide/commit/360bf9d759e724b164a38f8f59423bf0b63d2d0c))
    ...
    - A more suitable iterator implementation for general store ([`af0cc5f`](https://github.com/yuki0iq/gitoxide/commit/af0cc5f27488df497bc929492bb13386aa88cc2a))
    - A quick and dirty version index iteration ([`0384007`](https://github.com/yuki0iq/gitoxide/commit/0384007cd9e813cf4bfb13642adef8a602d219ad))
    - Use new store in git-repository ([`2f9e342`](https://github.com/yuki0iq/gitoxide/commit/2f9e342b63f9e5c925d8e85ebc0a0be693ca0901))
    ...
    - Remaining methods of git-pack::Find ([`92b9764`](https://github.com/yuki0iq/gitoxide/commit/92b97644e9828ab84727135d42fdab5101340a3f))
    ...
    - It shows that we can't return anything referenced from the interior-mutable handle ([`b9f308b`](https://github.com/yuki0iq/gitoxide/commit/b9f308b6f3e5961b7ebeffbbc412cc9398fa0e2a))
    - Refactor ([`6cb474e`](https://github.com/yuki0iq/gitoxide/commit/6cb474ec2e50e0a7cc5bfaff49a1e866279e8269))
    - Prepare implementation of location-dependent methods ([`5de29f4`](https://github.com/yuki0iq/gitoxide/commit/5de29f4440bb0258bf2262ee210e1a511b74a4d3))
    - Refactor ([`2c23f42`](https://github.com/yuki0iq/gitoxide/commit/2c23f42dc8b965aca5043652355aecb978084fa5))
    - Impl git_odb::Write for general::Handle ([`b7a6ab7`](https://github.com/yuki0iq/gitoxide/commit/b7a6ab71788643039313193869e96b4e9364d7ba))
    - Cleanup ([`a4f3670`](https://github.com/yuki0iq/gitoxide/commit/a4f36704e0243555c3d021f2925fbb15c396a026))
    - A way to predict the amount of slots needed for smooth operation ([`a3a16d6`](https://github.com/yuki0iq/gitoxide/commit/a3a16d6abfb245654353aaf1df0c9d932b250bf3))
    - Finding objects and dynamically loading packs seems to work ([`8f58c30`](https://github.com/yuki0iq/gitoxide/commit/8f58c30e3a6251b318514e468fc03d743d85e4f3))
    - First sketch of looking up objects with pack cache ([`a0aae84`](https://github.com/yuki0iq/gitoxide/commit/a0aae843d32bc0ebf672e5fe268e4fd1fd1fc51e))
    - Add contains checks for libgit2 ([`c64a45a`](https://github.com/yuki0iq/gitoxide/commit/c64a45a6453d72227260839cd93b8e8fa54d7357))
    - Add MRU to contains() even faster contains checks ([`6525847`](https://github.com/yuki0iq/gitoxide/commit/65258476dfc4ce35c30dbb48066f510f3de08073))
    - Load an index right after refreshing items from disk ([`0c40eb3`](https://github.com/yuki0iq/gitoxide/commit/0c40eb3f73c10eb58f7704e2a3f1fb3171bc4300))
    - Some more assertions for contains() regarding refresh mode ([`3f8c540`](https://github.com/yuki0iq/gitoxide/commit/3f8c540625a14c33f26eece6f1b89997db5abab9))
    - Try reusing mappings, but no LRU ([`bb602e8`](https://github.com/yuki0iq/gitoxide/commit/bb602e8ab22bfb48043e26d2ecfd5380056582c5))
    - Try LRU-like contains implementation ([`2d6960f`](https://github.com/yuki0iq/gitoxide/commit/2d6960f886c1165f0bdb6f2d653388e1e0b57a2d))
    - Don't abort run into assertion unnecessarily… ([`4e87a56`](https://github.com/yuki0iq/gitoxide/commit/4e87a56cef4644e592d93999e064adbc436e3cec))
    - Adjust object-acess to test new contains method ([`8488b41`](https://github.com/yuki0iq/gitoxide/commit/8488b41651751d9177f53a23233b7ddd655dd696))
    - Looks like 'contains()' is implemented well enough ([`c24015a`](https://github.com/yuki0iq/gitoxide/commit/c24015a076963ed0feceadf9269c52f7910ad033))
    - First successful loading of indices… ([`8cbef57`](https://github.com/yuki0iq/gitoxide/commit/8cbef57aa2ad82591521dd9ff7e529e3171f6153))
    - First stab at loading indices while dealing with inherent raciness ([`94be3a0`](https://github.com/yuki0iq/gitoxide/commit/94be3a0f3e51a3377e8a263e4e3b638c9b64cf0e))
    - Assure loops can't happen anymore ([`f04ff80`](https://github.com/yuki0iq/gitoxide/commit/f04ff8011198b7f6c45c2094530903316c6e91ea))
    - The first green test for loose object lookup ([`0c6b7b1`](https://github.com/yuki0iq/gitoxide/commit/0c6b7b13dd532350d649d932e93ff016170a1860))
    - More clarity around generations; actually trash slots or unset them ([`7bce101`](https://github.com/yuki0iq/gitoxide/commit/7bce101ac4e085b3d035069f51ea99f945961990))
    - Create a new index snapshot and store it ([`41d91f9`](https://github.com/yuki0iq/gitoxide/commit/41d91f96cfc6ca41902a268537b6865f7df867fa))
    - Sort out race condition around slots that change identity ([`6e678e7`](https://github.com/yuki0iq/gitoxide/commit/6e678e705172c988de2a849352b4b83f898eeaa4))
    - Uncover slightly disturbing races which make it hard to ever release/unload maps ([`cbf2d13`](https://github.com/yuki0iq/gitoxide/commit/cbf2d13afaee11cd835872c60063bac885829751))
    - Remaining comments about multi-pack-index handling ([`569c40b`](https://github.com/yuki0iq/gitoxide/commit/569c40b7b8c468901266e24c4b8dbde0d0365912))
    - Handling of multi-pack index slot-map moves as they change ([`456f1e7`](https://github.com/yuki0iq/gitoxide/commit/456f1e7f1bb72a28c31aa3ff80e488cd81888900))
    - Prepare correct handling of multi-pack indices when the time comes ([`6388ba2`](https://github.com/yuki0iq/gitoxide/commit/6388ba2f82adced3f3f268f248063b9cb5a6d269))
    - More thoughts about how to continue a search… ([`eac8c45`](https://github.com/yuki0iq/gitoxide/commit/eac8c45ae5961cc6a19d803b589c5f816fddcc5e))
    - Get closer to actually setting up slots ([`55645ae`](https://github.com/yuki0iq/gitoxide/commit/55645ae8a9d3f7666f5c6f9d28302b7afeb355ed))
    - Add load-pack method frame to not forget ([`e1ec535`](https://github.com/yuki0iq/gitoxide/commit/e1ec535ed16010c7d8d4dec659d0b3d6ab8863e5))
    - Some steps towards recording the disk state in the slot-map ([`5074f4c`](https://github.com/yuki0iq/gitoxide/commit/5074f4ce711e443cc456ddb7e6ce978610331ded))
    - Better errors for disk consolidation; setup loose object dbs ([`4c13e14`](https://github.com/yuki0iq/gitoxide/commit/4c13e149bdd111cf7ddb171881c8ac95c88f3808))
    - Detail the load-indices flow more ([`11d3325`](https://github.com/yuki0iq/gitoxide/commit/11d3325dec84b50dab41ed12ba52a1b939ac3003))
    - Make slot-count configurable ([`c910af5`](https://github.com/yuki0iq/gitoxide/commit/c910af59806aa65e2b56a81357fd3b21e877791c))
    - Provide handle with a snapshot of the store's state ([`6e0cd6d`](https://github.com/yuki0iq/gitoxide/commit/6e0cd6d38c5df874990ace6c2c3c0b39342c4d05))
    - Refactor ([`d5565da`](https://github.com/yuki0iq/gitoxide/commit/d5565daf9ece760af99e6b6c7c711440b95cd359))
    - Support for metrics in general store handle ([`11b98b8`](https://github.com/yuki0iq/gitoxide/commit/11b98b8d2a0ecafaf6b57efafa3ed8ac40b00298))
    - First test to trigger all major code-paths ([`25b56c5`](https://github.com/yuki0iq/gitoxide/commit/25b56c5257230db296453a2ac74f73e694d0af77))
    - More trustworthy state-id hashing ([`4eb43d0`](https://github.com/yuki0iq/gitoxide/commit/4eb43d03e4954fa6d4ab4afb5f13ad5e801ba58a))
    - Use handle registration to avoid unloading packs; fix state-id hash ([`a1070de`](https://github.com/yuki0iq/gitoxide/commit/a1070de8b750acbbaf14925d827574465ea69804))
    - Handle registration ([`df4e4eb`](https://github.com/yuki0iq/gitoxide/commit/df4e4ebd116d0d80e6a8b09bb5ea30ecfdbfbae9))
    - Bring in the slotmap ([`3a5cb5f`](https://github.com/yuki0iq/gitoxide/commit/3a5cb5ffd326dba8e1f8d6ca725c4d2815864a9b))
    - Put down more types for loading of indices and refresh logic ([`9909eaf`](https://github.com/yuki0iq/gitoxide/commit/9909eaf363e8681454ea1dd2b953fe8757c23463))
    - Add all types the handle would have to store ([`e2f0cb0`](https://github.com/yuki0iq/gitoxide/commit/e2f0cb07b9c23360ee3cc68b7093fc742ecef16d))
    - Rename `Handle` to `Cache` ([`580e96c`](https://github.com/yuki0iq/gitoxide/commit/580e96c1b2d9782a2e8cf9d1123f6d53a5376a3d))
    - First sketch of general store ([`fc1b640`](https://github.com/yuki0iq/gitoxide/commit/fc1b6409380256b73cf271c105802f4494dbb8c5))
    - More affirmative notes about multi-pack indices ([`dceaea2`](https://github.com/yuki0iq/gitoxide/commit/dceaea2486afcfce053eac1ad41851cddce9c5e7))
    ...
    - Adjust to new name/place of `bundle::Location` ([`1f8954d`](https://github.com/yuki0iq/gitoxide/commit/1f8954d7b7567990055fe7d1752599c6a0a90931))
    - Add docs for handle-related functions ([`cf1b1e6`](https://github.com/yuki0iq/gitoxide/commit/cf1b1e6d82f691ab17975e4f1479d93720368803))
    - Impl Write for Arc, Rc and shared borrows ([`5cdc27d`](https://github.com/yuki0iq/gitoxide/commit/5cdc27df2f5a25668f5c8bce4cbe1dcb0262ccc1))
    - Adapt to changes in git-repository ([`3ab9b03`](https://github.com/yuki0iq/gitoxide/commit/3ab9b03eee7d449b7bb87cb7dcbf164fdbe4ca48))
    - Also use object cache if there is no pack-cache ([`3e1ae25`](https://github.com/yuki0iq/gitoxide/commit/3e1ae256d380eca1cb66f9348287bcf9bdfcefca))
    ...
    - Cache-creators are indeed shared across threads, must be sync ([`c326cb3`](https://github.com/yuki0iq/gitoxide/commit/c326cb35cc684a5751e007c0ece3f02edf162ecc))
    - Try to make Handle usable for pack creation ([`424c9b3`](https://github.com/yuki0iq/gitoxide/commit/424c9b3a2b467f5a1e339700257cd4ab72e2e692))
    - Make all handle caches and cache creators optional ([`3c30769`](https://github.com/yuki0iq/gitoxide/commit/3c307694708532a9903ce7ff7138d0d4ab17dba5))
    - Make odb handle more general ([`2be6725`](https://github.com/yuki0iq/gitoxide/commit/2be6725b76b5f4a10dbadc73b2a7dfc3c1537223))
    - :Find for Arc and Rc ([`b1c82a7`](https://github.com/yuki0iq/gitoxide/commit/b1c82a7959fba1541642fc8dfae46b27848f2ba3))
    ...
    - Construct a handle from a linked store ([`9702ed4`](https://github.com/yuki0iq/gitoxide/commit/9702ed492114a64c8dab0fedc3e251c9e059a753))
    - Refactor ([`ab14f70`](https://github.com/yuki0iq/gitoxide/commit/ab14f70202a5a80369a640eff809003925bccb58))
    - A first tiny stab at Handle for linked store ([`ef08f7f`](https://github.com/yuki0iq/gitoxide/commit/ef08f7fd186dca5ff0d02e8b57c8d14e6b584e65))
    - Refactor ([`1361c31`](https://github.com/yuki0iq/gitoxide/commit/1361c31d43438cb14723003194236fe7d1fdc201))
    - Refactor ([`3310d8f`](https://github.com/yuki0iq/gitoxide/commit/3310d8f271f74fc6084e33dd9bd4c5f01b54e432))
    - :Find implementation for linked::Store ([`9235106`](https://github.com/yuki0iq/gitoxide/commit/9235106986e14551a28693bfe4ea92f046c65406))
    - Add linked::Store::rc_iter() ([`36fde72`](https://github.com/yuki0iq/gitoxide/commit/36fde720c34e02429a810ddd43b894a37516f51a))
    - Use `Deref` instead of Borrow in linked ODB iterator ([`a96b1e5`](https://github.com/yuki0iq/gitoxide/commit/a96b1e5e626f58bc4d79d44132b4f03bd3a7cfd1))
    ...
    - Linked::Store sorts bundles by modification date, newest first ([`a81b333`](https://github.com/yuki0iq/gitoxide/commit/a81b33359a4394a66f854195445f8f9aa0a46179))
 ...
 * **[#279](https://github.com/yuki0iq/gitoxide/issues/279)**
    ...
    - Another test to validate index stability ([`1fb08df`](https://github.com/yuki0iq/gitoxide/commit/1fb08dfb00e951c0851aaf8b0d9b64bcdf5a3e3e))
    - Refactor ([`a4ad5bf`](https://github.com/yuki0iq/gitoxide/commit/a4ad5bf948f405bdf00847859a95aa50082e0615))
    - Handle 'move' of multi-pack indices ([`aec0895`](https://github.com/yuki0iq/gitoxide/commit/aec0895c1d4a47727e530b1e80b5289db966ab91))
    - Trigger last portion of multi-index logic ([`b46979b`](https://github.com/yuki0iq/gitoxide/commit/b46979b9aa57b718ed38acbaf9ca5cd7b775a6fc))
    - Load slots early to avoid races with the 'generation' field ([`10bc3ab`](https://github.com/yuki0iq/gitoxide/commit/10bc3ab6c4407fa1fdb966d3fc880aa772c490d3))
    - Only open multi-pack indices if the mtime changed ([`efe2579`](https://github.com/yuki0iq/gitoxide/commit/efe2579b70c078f42b65077461a63abe1f1b6950))
    - Add remaining Store docs ([`e440bcd`](https://github.com/yuki0iq/gitoxide/commit/e440bcdd7525e7f79a889b55610f64ff00827a2c))
    - First odb lookup with multi-index works ([`a8773df`](https://github.com/yuki0iq/gitoxide/commit/a8773dfd728a0e996a5d4853508e5560e3bbb03d))
    - Generalize intra-pack offset lookup ([`dff05ef`](https://github.com/yuki0iq/gitoxide/commit/dff05ef0c242a05e234d441d044f9b294ebefe0c))
    ...
    - A rough implementation of everything multi-index support would need… ([`56f174f`](https://github.com/yuki0iq/gitoxide/commit/56f174f37e1a0fa671bc54be2a8d16878eab75a6))
    - Make opened multi-pack indices representable ([`28e648d`](https://github.com/yuki0iq/gitoxide/commit/28e648d642c89422fdc23292582d601b79601262))
    - First sketch towards reading in multi-indices ([`25eb157`](https://github.com/yuki0iq/gitoxide/commit/25eb157ccb9f02b404e66f0d953228cd56424436))
    - `Cache::inner` removed in favor of `Deref/Mut` and `into_inner()` ([`bf73a94`](https://github.com/yuki0iq/gitoxide/commit/bf73a94b43288b6634dbb33f2433656987a73baf))
    - Cargo fmt ([`8b9da35`](https://github.com/yuki0iq/gitoxide/commit/8b9da35b3e0d3458efcac150f7062c9d7382a6c4))
    ...
    - Consistently use `object_hash` instead of `hash_kind` ([`49998cc`](https://github.com/yuki0iq/gitoxide/commit/49998cce419a27f3928ec4ac39da5e3b500e5cb2))
    - Refactor ([`7331e99`](https://github.com/yuki0iq/gitoxide/commit/7331e99cb88df19f7b1e04b1468584e9c7c79913))
    - Adapt to changes in git-pack ([`28dba20`](https://github.com/yuki0iq/gitoxide/commit/28dba20d0ba6197d02e1c9b665279392dad8d707))
    - Adjust to changes in git-pack ([`b8f109e`](https://github.com/yuki0iq/gitoxide/commit/b8f109efa3bf3b9f37033bddd841fdf55e450dd4))
    - Refactor ([`9b5451a`](https://github.com/yuki0iq/gitoxide/commit/9b5451a071ea303216c750dc94f2f646fc3c366f))
    - Loose object iteration respects hash kind ([`72eb9da`](https://github.com/yuki0iq/gitoxide/commit/72eb9da4e2aa543ea902c49e0477274bd631c7c3))
    - Remove `Write::*(…, hash_kind)` ([`67c42fb`](https://github.com/yuki0iq/gitoxide/commit/67c42fbf5f88f8dc42a9ebd7c6276d57ba1d4624))
    - Various changes to the `loose::Store` ([`ad1b9ea`](https://github.com/yuki0iq/gitoxide/commit/ad1b9ea17eb4b98ebd2fddebe82a8fee1d63e9dd))
    - Loose odb doesn't hard-code sha1 anymore for `find()` and `contains()` ([`68f1031`](https://github.com/yuki0iq/gitoxide/commit/68f1031732cfb8f50fa582ced834f7d4fd9da2ae))
    ...
    - Respect `core.multiPackIndex` option ([`1495efc`](https://github.com/yuki0iq/gitoxide/commit/1495efcc914449f9680f9141805d60b1f3188001))
    - Only load multi-pack indices if allowed ([`b22e146`](https://github.com/yuki0iq/gitoxide/commit/b22e14663dd0237a0ee1f5283782953ec8442a16))
 * **[#287](https://github.com/yuki0iq/gitoxide/issues/287)**
    - Basic output for 'repo verify' json only ([`9f8d61f`](https://github.com/yuki0iq/gitoxide/commit/9f8d61f164fb3fbdb76cc44fbd634ca5db35b3b8))
    ...
    - Better verify progress printing ([`4a464f2`](https://github.com/yuki0iq/gitoxide/commit/4a464f26bb4dae236bcc845e353e25dd5d936f8f))
    ...
    - Support for loose object statistics in odb store ([`53d835a`](https://github.com/yuki0iq/gitoxide/commit/53d835a4a8a2830c56a354a3e7f5c1790ee40ad1))
    - Bare-bones loose object integrity check ([`3dfec81`](https://github.com/yuki0iq/gitoxide/commit/3dfec817e4980b19a3d0eb1301d8f33296b2fbcf))
    - Frame for loose-db validation ([`a24307d`](https://github.com/yuki0iq/gitoxide/commit/a24307dfd0b7322472f85ec83687a04488d28cff))
    - First basic validation of all packs within an odb store ([`d63176f`](https://github.com/yuki0iq/gitoxide/commit/d63176f2cf0a869285a7434311a8adfdfbf552c7))
    - Don't reset generations, instead make them match the current one ([`1d995ef`](https://github.com/yuki0iq/gitoxide/commit/1d995ef672e7bfcb142a369ac034a802e02ad124))
    - Frame for interity check on object store ([`b5dd059`](https://github.com/yuki0iq/gitoxide/commit/b5dd059343f0545c77129595f3801a946cfe8c5f))
 ...
 * **[#298](https://github.com/yuki0iq/gitoxide/issues/298)**
    - Handle::packed_object_count() ([`84ec54e`](https://github.com/yuki0iq/gitoxide/commit/84ec54e904378c5b3d7da9efff66b02e88b16916))
    - Docs ([`a45f378`](https://github.com/yuki0iq/gitoxide/commit/a45f3789696078848e2e96ddb8a55570c941dd53))
    - Implement ODB::disambiguate_prefix(…) ([`7d4d281`](https://github.com/yuki0iq/gitoxide/commit/7d4d2818395cfe0c31117f8736471d4a707e3feb))
    - Add missing docs ([`c7cd4ab`](https://github.com/yuki0iq/gitoxide/commit/c7cd4ab9a2ba2674be2dcd97a16f549e14679149))
    - Refactor ([`4455af3`](https://github.com/yuki0iq/gitoxide/commit/4455af376a583fe524855d9199faa0a374b2ab31))
    - Refactor ([`fe87704`](https://github.com/yuki0iq/gitoxide/commit/fe87704d037ae4cef5d48abd7dfc152f37a43c97))
    - Lookup_prefix for ODB ([`a4ccd18`](https://github.com/yuki0iq/gitoxide/commit/a4ccd18fb3662f9fa38f73693abe9364c77df3d3))
    - Base for testing git_odb::Handle::lookup_prefix() ([`6244c06`](https://github.com/yuki0iq/gitoxide/commit/6244c06900a1c66b2d62bd12015aaae86ac1c842))
    - Basics for ODB lookup prefix ([`5c228e1`](https://github.com/yuki0iq/gitoxide/commit/5c228e1596b0ace28a1261ca271c3f1d93eb3970))
    - Add docs to `loose::Store::lookup_prefix(…)` ([`9fa4817`](https://github.com/yuki0iq/gitoxide/commit/9fa4817f24ad1d31e20da92e307c853cdae758c1))
    - Loose::Store::lookup_prefix(…) ([`996bfb3`](https://github.com/yuki0iq/gitoxide/commit/996bfb3061fd9ee2cf38c93f39e0d4c7c6163386))
    - Simplify error of loose::Iter ([`622abd7`](https://github.com/yuki0iq/gitoxide/commit/622abd756c4d950076974e91dbe1a144b61ca3b1))
    ...
    - Support Rust 1.52 ([`9c14de3`](https://github.com/yuki0iq/gitoxide/commit/9c14de391a1a9f1055922164d1757c9aa9720807))
 * **[#301](https://github.com/yuki0iq/gitoxide/issues/301)**
    ...
    - Adapt to changes in git-quote ([`ba48629`](https://github.com/yuki0iq/gitoxide/commit/ba486297114154c334e0c38cd883504608973f3c))
    - Use git-quote crate in git-odb alternate parsing ([`8e49aa6`](https://github.com/yuki0iq/gitoxide/commit/8e49aa6090c1c361e3ddd44798754c44c179ab49))
    - All path-related tests are green ([`81d2bf2`](https://github.com/yuki0iq/gitoxide/commit/81d2bf2ec5f571245d56eb853306d07ede3010a2))
    - Update git-odb changelog to include information about bugfix ([`055b117`](https://github.com/yuki0iq/gitoxide/commit/055b1170b9a96c9c6067a588fcd9679b618d9530))
    - Fix the first race-condition around initialization in ODB ([`a891315`](https://github.com/yuki0iq/gitoxide/commit/a89131517fd4805211c4037396d9411ee41363d1))
    ...
    - Less restrictive ref-delta-base resolution ([`917480b`](https://github.com/yuki0iq/gitoxide/commit/917480b6626363555ba818c8e1c4e18cb944aa40))
    - More safety around recursion and invariants when resolving ref-deltas ([`dddb4a5`](https://github.com/yuki0iq/gitoxide/commit/dddb4a51f417ff84a53da64959ad668ab26ebd93))
    - Allow delta base objects to be out-of-pack in general odb ([`d4f1590`](https://github.com/yuki0iq/gitoxide/commit/d4f1590a6afe25fbd6659002c420098c57e1824a))
    - Elaborate odb info and simple entries printing ([`0f65282`](https://github.com/yuki0iq/gitoxide/commit/0f65282fd2719234f745473e33bd42637be5fd3b))
    - A first sketch of access odb information using a sub-command ([`89b628a`](https://github.com/yuki0iq/gitoxide/commit/89b628ab5b833a34f0b426b3a399bb182e63f3f4))
 ...
 * **[#364](https://github.com/yuki0iq/gitoxide/issues/364)**
    - A statement about replacement objects ([`2d32f4d`](https://github.com/yuki0iq/gitoxide/commit/2d32f4d77efc6861323ec7de827cfe8db2c3c7a1))
    - Implement object replacement ([`b16d5e9`](https://github.com/yuki0iq/gitoxide/commit/b16d5e9a5dcc5d3ad8275a8c793df50bb112eb3e))
    ...
    - An API and a test for replacement configuration ([`f2d6db1`](https://github.com/yuki0iq/gitoxide/commit/f2d6db16f89bc70f1d167975cbd88937c4d38cfb))
    - Initial test to assure we don't replace objects by default ([`6cb9ecc`](https://github.com/yuki0iq/gitoxide/commit/6cb9ecc4ef2602606a90880880ea7deccaaa0729))
 ...
 * **[#427](https://github.com/yuki0iq/gitoxide/issues/427)**
    ...
    - Add `Cache::has_object_cache()` and `Cache::has_pack_cache()` methods. ([`81e1a9d`](https://github.com/yuki0iq/gitoxide/commit/81e1a9d38aac9e6dd0618266ff826593e038cce8))
    - Improve error messages when objects aren't found ([`41d4943`](https://github.com/yuki0iq/gitoxide/commit/41d494365d281056c5e9466860db808bd85143e9))
    - Fix: incorrect desired object kind if retrieved object doesn't have the expected kind ([`87f974e`](https://github.com/yuki0iq/gitoxide/commit/87f974eea2cf7c6e3405b2816d3ef2bd058fc3dc))
    ...
    - `loose::Db` and `Store` can return all candidate objects for a single prefix ([`92d8be1`](https://github.com/yuki0iq/gitoxide/commit/92d8be1101a7e76e70cd90db6a943b9e31e20802))
    - The first successful disambiguation test ([`6bc6337`](https://github.com/yuki0iq/gitoxide/commit/6bc6337037708243346afeee07ad24a02565894b))
 ...
 * **[#536](https://github.com/yuki0iq/gitoxide/issues/536)**
    - Try even harder to find the original index during recursive base object resolution. ([`bae3ea9`](https://github.com/yuki0iq/gitoxide/commit/bae3ea954af560de871fa7d506146e70041b5fca))
    - Try to recreate multi-threaded panic, without success. ([`53b5086`](https://github.com/yuki0iq/gitoxide/commit/53b50866bcf9785904f1d8f809375edae9cee6f1))
    - Only run single-threaded these when respective toggle is set (when multi-threading is requested) ([`730384d`](https://github.com/yuki0iq/gitoxide/commit/730384d6c8908ab8b44e9b499f3f7d678143e8ed))
 * **[#59](https://github.com/yuki0iq/gitoxide/issues/59)**
    - Fix initializing pack bundles in compound db ([`5a48e08`](https://github.com/yuki0iq/gitoxide/commit/5a48e085d49a191a85a9b043e34d844389c8342b))
    - Add failing test ([`d629339`](https://github.com/yuki0iq/gitoxide/commit/d629339834479553ceef27c15e5115e820b875ee))
    - Move pack fixtures into place which resembles an actual object db ([`fb5cea4`](https://github.com/yuki0iq/gitoxide/commit/fb5cea4b9a98997f105a6ccb9729371be994af3c))
 * **[#63](https://github.com/yuki0iq/gitoxide/issues/63)**
    - Impl == and != for common combinations of ObjectId/oid ([`2455178`](https://github.com/yuki0iq/gitoxide/commit/24551781cee4fcf312567ca9270d54a95bc4d7ae))
 ...
 * **[#67](https://github.com/yuki0iq/gitoxide/issues/67)**
    - Assure pack-ids are actually unique, the simple way… ([`0509b4f`](https://github.com/yuki0iq/gitoxide/commit/0509b4fb5a78a3e4bfcacbeb661d262f8592884a))
    - The very first version of complete pack writing ([`4d76d53`](https://github.com/yuki0iq/gitoxide/commit/4d76d53aabb956ed7c8a45c883486ec5596bcaa3))
    - A sketch of the pack::generation function signature ([`21b0aab`](https://github.com/yuki0iq/gitoxide/commit/21b0aab81e7304da964dbef90c806134073ccef3))
 ...
 * **[#724](https://github.com/yuki0iq/gitoxide/issues/724)**
    - Fix typo proper ([`ffc99b8`](https://github.com/yuki0iq/gitoxide/commit/ffc99b8edaacdb20c940624549acb4a4ee7f8c66))
 * **[#XXX](https://github.com/yuki0iq/gitoxide/issues/XXX)**
 ...
 * **Uncategorized**
    ...
    - Remove locate(…) -> Option<Result<…>> in favor of Result<Option<…>> ([`40ee743`](https://github.com/yuki0iq/gitoxide/commit/40ee7438a98c4094c0fd04977cd4904668087512))
    - A locate returning Result<Option<Object>> for compound DB ([`a1dafa6`](https://github.com/yuki0iq/gitoxide/commit/a1dafa64b4e26dd1456d38f94d58eaadf19abfd3))
    - Use Result<Option<Object>> in Bundle::locate() ([`2dfef8f`](https://github.com/yuki0iq/gitoxide/commit/2dfef8f71da456c5c494e1530040589582a046b1))
    - A trial for Result<Option<Object>>  for loose object databases ([`3842859`](https://github.com/yuki0iq/gitoxide/commit/3842859c5bddb8b4583443685c26dcae3f8db558))
