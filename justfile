...
unit-tests:
    ...
    env GIX_TEST_FIXTURE_HASH=sha1 cargo nextest run -p gix --no-default-features --no-fail-fast
    env GIX_TEST_FIXTURE_HASH=sha256 cargo nextest run -p gix --no-default-features --no-fail-fast
