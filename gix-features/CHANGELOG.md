 ...
 * **Uncategorized**
    ...
    - Don't box compression/decompression type and avoid indirections and allocs ([`e5a7487`](https://github.com/yuki0iq/gitoxide/commit/e5a74876fd01ce89071701a7bb682642f7932418))
    - Remove unused and previously deprecated `zlib` related features. ([`f47f3e4`](https://github.com/yuki0iq/gitoxide/commit/f47f3e42b9d64274d210953c6fbd903b2d300f1f))
 ...
 * **Uncategorized**
    ...
    - Walkdir_sorted_new adds max_depth parameter ([`6c77b54`](https://github.com/yuki0iq/gitoxide/commit/6c77b541b476656827ee0542a650b9731ba549cf))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1960 from joshtriplett/zlib-rs ([`f3684a4`](https://github.com/yuki0iq/gitoxide/commit/f3684a4f67f98c0e3884e2d348cb092f48ca443a))
    - Fix documentation of zlib-rs feature: no longer conflicts with other zlibs ([`8ece02a`](https://github.com/yuki0iq/gitoxide/commit/8ece02aeda4b3044dd68dd8a6c20ea4ee4ed1bda))
    ...
    - `gix-features` uses and republishes `bytesize` version 2 ([`7882907`](https://github.com/yuki0iq/gitoxide/commit/788290717da8ec396635aec386af99e1917bf3a0))
    ...
    - Merge pull request #1944 from GitoxideLabs/dependabot/cargo/cargo-ea4584273b ([`79dabb0`](https://github.com/yuki0iq/gitoxide/commit/79dabb0a062a795b1dc5c9c840d67474dc6b343b))
    - Bump crossbeam-channel from 0.5.14 to 0.5.15 in the cargo group ([`1792178`](https://github.com/yuki0iq/gitoxide/commit/1792178cbed5abf4782370bc46207a8c5d113615))
 ...
 * **Uncategorized**
    ...
    - Refactor ([`7e6e751`](https://github.com/yuki0iq/gitoxide/commit/7e6e7518c78ba925382c0d4654b9e11b4cd641e9))
 ...
 * **Uncategorized**
    ...
    - Move hashing API to `gix_hash` ([`e4439aa`](https://github.com/yuki0iq/gitoxide/commit/e4439aa9a6969e14b7a03bea6b0b771534510edd))
    - Detect SHA‐1 collision attacks ([`f253f02`](https://github.com/yuki0iq/gitoxide/commit/f253f02a6658b3b7612a50d56c71f5ae4da4ca21))
    ...
    - `fs::walkdir_sorted_new` now returns files first. ([`7b1b5bf`](https://github.com/yuki0iq/gitoxide/commit/7b1b5bf864e74706aefeb1213e8bdb0545d5464a))
 ...
 * **Uncategorized**
    ...
    - Rename `hash::Sha1` to `hash::Hasher` and `Sha1Digest` to `Digest`. ([`cdf2a63`](https://github.com/yuki0iq/gitoxide/commit/cdf2a6320e208bac69b9b1152c10f0b81b238c3e))
    ...
    - Lint fix, just file adjustment ([`7b6e176`](https://github.com/yuki0iq/gitoxide/commit/7b6e1764dc3b1dad30738fcb16b7428d880d4203))
    ...
    - Update `flate2` to a version which hopefully runs on Windows by default. ([`77e808b`](https://github.com/yuki0iq/gitoxide/commit/77e808bbce4177bf78df68aec0a8e906d8c7d1cf))
...
<csr-read-only-do-not-edit/>
 ...
 - 1 commit was understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#917](https://github.com/yuki0iq/gitoxide/issues/917)
 ...
 * **[#917](https://github.com/yuki0iq/gitoxide/issues/917)**
    - Assure high-speed SHA1 assembly is only used in not on Windows ([`2683235`](https://github.com/yuki0iq/gitoxide/commit/268323587faeada1abdd7f933d616af3165a37cf))
 * **Uncategorized**
 ...
 * **Uncategorized**
    ...
    - Add `fs::read_dir::DirEntry` with precompose_unicode support. ([`24d081a`](https://github.com/yuki0iq/gitoxide/commit/24d081a0861cca1f3fa657297ad58a937b2d903d))
    - Support `precompose_unicode` flag in `fs::walkdir` types. ([`47e2fec`](https://github.com/yuki0iq/gitoxide/commit/47e2fec0db6c55d673c953d26f01fd88ac0f118e))
</details>
 ...
 * **Uncategorized**
    ...
    - Fix ununsed imports warning on nightly ([`f130f63`](https://github.com/yuki0iq/gitoxide/commit/f130f631593f73eb00cf6dc132ee147ad8b5e970))
</details>
 ...
 * **Uncategorized**
    ...
    - Fix formatting ([`5d8b5f4`](https://github.com/yuki0iq/gitoxide/commit/5d8b5f4e5b3792b310f7a23907a205b5db427420))
    - Merge pull request #1134 from alexanderkjall/gix-features-i386-test-failure ([`a12682d`](https://github.com/yuki0iq/gitoxide/commit/a12682d7a8bd263a18471f4a26d8af67b1cd4c1e))
    - Review feedback, use an 'if cfg' construct instead ([`1d45f05`](https://github.com/yuki0iq/gitoxide/commit/1d45f056263ba9c69612abc81fdd3783f95de4ca))
    - Test size_of_sha1 reports wrong size on i386 ([`5c2d615`](https://github.com/yuki0iq/gitoxide/commit/5c2d615548dd27f23586e4fe5cfa8c6507635694))
    ...
    - Merge pull request #1115 from martinvonz/push-vuzxvuvlztxy ([`c65b80b`](https://github.com/yuki0iq/gitoxide/commit/c65b80b048769bc999be5f3002c4d708da550d3c))
    - Fix pointer aliasing in in_parallel.rs ([`1383b0d`](https://github.com/yuki0iq/gitoxide/commit/1383b0df14134b0e0f1a2fbfccb4526130c84a03))
 ...
 * **Uncategorized**
    ...
    - Add `hash::bytes_with_header()`, also make it 32bit compatible. ([`4c03fdb`](https://github.com/yuki0iq/gitoxide/commit/4c03fdbc831349ea7f45b68331f554ade859abf5))
</details>
 ...
 * **Uncategorized**
    ...
    - Add `threading::make_mut()` to allow obtaining a mutable reference to shared data. ([`5197196`](https://github.com/yuki0iq/gitoxide/commit/51971969d2cf13587d4bfbd4cb047f2377b8bc0f))
    - Parallel utilities that create thread-state now use `FnOnce`. ([`70c7c29`](https://github.com/yuki0iq/gitoxide/commit/70c7c29266bc4396c968c7aa311c9721929a7cab))
    - Merge pull request #1024 from Byron/nix-adjustments ([`14e0763`](https://github.com/yuki0iq/gitoxide/commit/14e0763cbf368bda476046a0fd28be230d67b1bd))
    - Cargo-auditable build error ([`7a8f793`](https://github.com/yuki0iq/gitoxide/commit/7a8f79357ce99c4b86e22be166b54f7376c71469))
 ...
 * **Uncategorized**
    ...
    - Add `interrupt::Write` to auto-fail writes on interrupt. ([`7179509`](https://github.com/yuki0iq/gitoxide/commit/717950977fa758812bc4dd5713f96995bddc491a))
 ...
 * **Uncategorized**
    ...
    - Remove `zlib::stream::inflate::ReadBoxed`. ([`032cea3`](https://github.com/yuki0iq/gitoxide/commit/032cea3d6cfde80fdfc7bfe8722e2514d2bcb5cf))
    ...
    - Add `in_parallel_with_finalize` to support a usecase for `gix-worktree` ([`2a76929`](https://github.com/yuki0iq/gitoxide/commit/2a76929ece48c3b0fbdba7e08ae5d7e647db4d36))
</details>
 ...
 * **Uncategorized**
    ...
    - Prepare changelogs once more ([`4bf355a`](https://github.com/yuki0iq/gitoxide/commit/4bf355a8c6a7dbcdb49105af3208d56a0ed8628d))
    - Adjust `gix-trace` to the latest version. ([`353df4b`](https://github.com/yuki0iq/gitoxide/commit/353df4bf59c7aa98da48bcdcc299f947d9449f55))
</details>
 ...
 * **Uncategorized**
    ...
    - `new_thread_state()` functions are now `FnOnce` across the board. ([`bc69804`](https://github.com/yuki0iq/gitoxide/commit/bc69804d5f6cba56349b5b15a2f6d1741849a5eb))
 ...
 * **Uncategorized**
    ...
    - Add `zlib::Inflate::reset()`. ([`d81b7e3`](https://github.com/yuki0iq/gitoxide/commit/d81b7e3036371d0a2a22f02a92df3c2b2950ff22))
    ...
    - Merge pull request #865 from nyurik/fix-tests ([`3a45973`](https://github.com/yuki0iq/gitoxide/commit/3a45973c61c4816940b1c9bae4fe60af47a3f6c6))
    ...
    - Make cargo check to pass all tests ([`f4a44f7`](https://github.com/yuki0iq/gitoxide/commit/f4a44f71e894dd8a08dd898a099b743a3ccff557))
    ...
    - Make `prodash::RawProgress` available. ([`add5ea8`](https://github.com/yuki0iq/gitoxide/commit/add5ea8b83d00972b560536da82f9914ef6080d3))
</details>
 ...
 * **Uncategorized**
    ...
    - Use `std::thread::scope()` instead of `crossbeam-utils::thread::scope()`. ([`571ec0d`](https://github.com/yuki0iq/gitoxide/commit/571ec0d7c3e1eb167d55daa6551bd2b27d3c5b25))
</details>
 ...
 * **Uncategorized**
    ...
    - Make `bytesize` available in `progress`. ([`7a44231`](https://github.com/yuki0iq/gitoxide/commit/7a442313c57f58fec5217484f268516711c3d52b))
    - Add `progress::count_with_decimals()` and `progress-unit-*` feature toggles. ([`7f6a807`](https://github.com/yuki0iq/gitoxide/commit/7f6a807ea506358b6dc4fd0c7a648770f1dc91e9))
    - Use new `dep:` syntax to hide optional features from feature-set. ([`0cc5480`](https://github.com/yuki0iq/gitoxide/commit/0cc548041a861be21001462cbe0ef29b1d61d1c4))
    - Remove `num_cpus` in favor of `std::thread::available_parallelism()`. ([`264f78a`](https://github.com/yuki0iq/gitoxide/commit/264f78a508d3030cb346623f57ac75add7682169))
    - Replace `quick-error` with `thiserror` ([`cce96ee`](https://github.com/yuki0iq/gitoxide/commit/cce96ee1382d3d56d77820a2aba6e2d17b52f91c))
...
<csr-read-only-do-not-edit/>
 ...
 - 21 unique issues were worked on: [#198](https://github.com/yuki0iq/gitoxide/issues/198), [#222](https://github.com/yuki0iq/gitoxide/issues/222), [#259](https://github.com/yuki0iq/gitoxide/issues/259), [#263](https://github.com/yuki0iq/gitoxide/issues/263), [#266](https://github.com/yuki0iq/gitoxide/issues/266), [#279](https://github.com/yuki0iq/gitoxide/issues/279), [#287](https://github.com/yuki0iq/gitoxide/issues/287), [#293](https://github.com/yuki0iq/gitoxide/issues/293), [#298](https://github.com/yuki0iq/gitoxide/issues/298), [#301](https://github.com/yuki0iq/gitoxide/issues/301), [#329](https://github.com/yuki0iq/gitoxide/issues/329), [#331](https://github.com/yuki0iq/gitoxide/issues/331), [#333](https://github.com/yuki0iq/gitoxide/issues/333), [#366](https://github.com/yuki0iq/gitoxide/issues/366), [#427](https://github.com/yuki0iq/gitoxide/issues/427), [#450](https://github.com/yuki0iq/gitoxide/issues/450), [#470](https://github.com/yuki0iq/gitoxide/issues/470), [#503](https://github.com/yuki0iq/gitoxide/issues/503), [#524](https://github.com/yuki0iq/gitoxide/issues/524), [#63](https://github.com/yuki0iq/gitoxide/issues/63), [#691](https://github.com/yuki0iq/gitoxide/issues/691)
 ...
 * **[#198](https://github.com/yuki0iq/gitoxide/issues/198)**
    ...
    - New changelogs for actor and features crates ([`e0d437c`](https://github.com/yuki0iq/gitoxide/commit/e0d437c4cfa06e0792609f41ed5876c390634921))
 ...
 * **[#263](https://github.com/yuki0iq/gitoxide/issues/263)**
    ...
    - Add threading primitives with feature toggle ([`7e95d8a`](https://github.com/yuki0iq/gitoxide/commit/7e95d8ab29051ffc892f2dcbaf5369e8c7e7b294))
 * **[#266](https://github.com/yuki0iq/gitoxide/issues/266)**
    - Update sha-1 dependency to 0.10 ([`361892c`](https://github.com/yuki0iq/gitoxide/commit/361892ca15aa648802f6701ab6a5a30aedde3449))
    - Remove slow/unnecessary threading utilities ([`269b7ef`](https://github.com/yuki0iq/gitoxide/commit/269b7efc47bb1d6380b2059f63bd0c53fcd285de))
 * **[#279](https://github.com/yuki0iq/gitoxide/issues/279)**
    - Add `progress::Write` to automatically pass bytes written to a progress instance ([`0a749a2`](https://github.com/yuki0iq/gitoxide/commit/0a749a22057b5513a8cefa0e26b0a9a268c769d3))
    - Renamed `progress::Read::reader` -> `progress::Read::inner` ([`61e5cfe`](https://github.com/yuki0iq/gitoxide/commit/61e5cfece4d8f405e35fc1957b00ce1da7526c26))
 ...
 * **[#293](https://github.com/yuki0iq/gitoxide/issues/293)**
    ...
    - Fix docs ([`3f89b63`](https://github.com/yuki0iq/gitoxide/commit/3f89b6336e79bc12bc31d40b74221e79a72d2b36))
    ...
    - Add InOrderIter to 'parallel' module ([`cb7e4e7`](https://github.com/yuki0iq/gitoxide/commit/cb7e4e784d615f9fa3d6fb9c36240f0592403358))
    - Make a scope-like abstraction available ([`ca095ed`](https://github.com/yuki0iq/gitoxide/commit/ca095ed881db2a8f06a6b067dbaac17e923b0945))
    ...
    - Decoding of variable int numbers. ([`b8400ed`](https://github.com/yuki0iq/gitoxide/commit/b8400ed80543d67a5895c975ba9b1fc28427411c))
 ...
 * **[#301](https://github.com/yuki0iq/gitoxide/issues/301)**
    ...
    - Remove `path` module in favor of `git-path` crate ([`90611ce`](https://github.com/yuki0iq/gitoxide/commit/90611ce1527618bcc738440bfc1ccc7a45319974))
    - Mild refactor of paths module to waste less on unix ([`d078d6e`](https://github.com/yuki0iq/gitoxide/commit/d078d6ee76a80d1dfaf71608c12d8a402bd670d4))
    - Refactor ([`8345b7c`](https://github.com/yuki0iq/gitoxide/commit/8345b7caa0cc1cd8489e41822eea89da4c539e6d))
    - More stable testing of perviously racy test for new parallelization mechanism ([`0b4b90f`](https://github.com/yuki0iq/gitoxide/commit/0b4b90fa498d9e07a55b72af2f799da4cd2da81f))
    ...
    - Use hopefully faster crossbeam channel to receive parallelized results ([`3b324b8`](https://github.com/yuki0iq/gitoxide/commit/3b324b868d9d172038797f911eeebfcba8107865))
    ...
    - `interrupt::Iter`, rename `interrupt::Iter` -> `interrupt::IterWithError` ([`8945d95`](https://github.com/yuki0iq/gitoxide/commit/8945d95f7fa88562d37ff67ac6e38bead73dd2df))
    - Fix `interrupt::Iter` ([`0f0d390`](https://github.com/yuki0iq/gitoxide/commit/0f0d390c475044a75e5db4dcd831d755e74aa3e9))
 * **[#329](https://github.com/yuki0iq/gitoxide/issues/329)**
    - In-manifest and in-lib documentation of feature toggles ([`15ff212`](https://github.com/yuki0iq/gitoxide/commit/15ff212b17087de93f259e366f4e4b821cfbc28e))
 * **[#331](https://github.com/yuki0iq/gitoxide/issues/331)**
    - Remove local-time-support feature toggle. ([`89a41bf`](https://github.com/yuki0iq/gitoxide/commit/89a41bf2b37db29b9983b4e5492cfd67ed490b23))
    - Initialize `Time` from `now_utc` and `now_local` ([`c76fde7`](https://github.com/yuki0iq/gitoxide/commit/c76fde7de278b49ded13b655d5345e4eb8c1b134))
    - A first sketch on how identity management could look like. ([`780f14f`](https://github.com/yuki0iq/gitoxide/commit/780f14f5c270802e51cf039639c2fbdb5ac5a85e))
    ...
    - Remove Option return values in favor of Result ([`493dbae`](https://github.com/yuki0iq/gitoxide/commit/493dbae434e8e4a939e90d03ec3f500744c0725a))
 ...
 * **[#333](https://github.com/yuki0iq/gitoxide/issues/333)**
    ...
    - Add new 'path' module for all path-related conversions ([`3c8581f`](https://github.com/yuki0iq/gitoxide/commit/3c8581fc294c65c9eb42698969fe3263135a864e))
 * **[#366](https://github.com/yuki0iq/gitoxide/issues/366)**
    ...
    - Cleanup bstr usage to not accidentally pull in unicode ([`8ff53af`](https://github.com/yuki0iq/gitoxide/commit/8ff53af9876a5e35bcfd076124ad776e1b6ff331))
 * **[#427](https://github.com/yuki0iq/gitoxide/issues/427)**
    ...
    - Optimize some portions of the Snapshot code for speed. ([`711fd5c`](https://github.com/yuki0iq/gitoxide/commit/711fd5c6c221440917fa68248e45d5278c780a9e))
    - More convenient API for fs::Snapshots ([`561d2e7`](https://github.com/yuki0iq/gitoxide/commit/561d2e746b1b82ac20f6f14b9c4e3910240075b4))
    - `fs::Snapshot` to on-demand reload shared resources. ([`7f199f0`](https://github.com/yuki0iq/gitoxide/commit/7f199f0e5246809efde9880110093fbd11a4f8fe))
    ...
    - Generalized port of packed-refs update logic for use in index ([`e3aff0c`](https://github.com/yuki0iq/gitoxide/commit/e3aff0c2b83720e5745f3d7a8d0f571421a26d99))
    - Turn on performance mode for sha-1 computation ([`44371a1`](https://github.com/yuki0iq/gitoxide/commit/44371a10f464f32db346aa6b8309e983cfa20933))
 * **[#450](https://github.com/yuki0iq/gitoxide/issues/450)**
    ...
    - `fs::Snapshot` can `Clone` if `T` can `Clone`. ([`9076ce3`](https://github.com/yuki0iq/gitoxide/commit/9076ce33ec167e425a0163d3e40a81a3fd0db6cd))
 * **[#470](https://github.com/yuki0iq/gitoxide/issues/470)**
    ...
    - Working progress printing ([`67ec2c7`](https://github.com/yuki0iq/gitoxide/commit/67ec2c7f9a4a6cefdf7148f5c7e48a79f201c4d2))
    - First attempt to get progress information from stat worker. ([`0947c70`](https://github.com/yuki0iq/gitoxide/commit/0947c703f9cecc31ceba101565e6ecafb00adb08))
    - Upgrade to prodash 20.1 for `Progress::counter()` feature ([`0ac4a2c`](https://github.com/yuki0iq/gitoxide/commit/0ac4a2c514aeb94d8e90ce28ae7a0e0350c21ab2))
 ...
 * **Uncategorized**
    ...
    - Rename `git-features` to `gix-features` ([`85f7e1a`](https://github.com/yuki0iq/gitoxide/commit/85f7e1a97c936f7cbebfbb3b2952f965601a7cbb))
    ...
    - Re-export `prodash::progress::(Task|Value)` directly under `progress` ([`a3bd14a`](https://github.com/yuki0iq/gitoxide/commit/a3bd14a7753716e7ad67cd56d24eee1fa099a6fd))
    - Release git-features v0.26.3 ([`1ecfb7f`](https://github.com/yuki0iq/gitoxide/commit/1ecfb7f8bfb24432690d8f31367488f2e59a642a))
    - Re-export `prodash` in `progress` module. ([`4260572`](https://github.com/yuki0iq/gitoxide/commit/426057247a80821b3da22b4ae5d67bda89ce0631))
    ...
    - Export `prodash::progress::Id` in the `progress` module for convenience. ([`c4a7634`](https://github.com/yuki0iq/gitoxide/commit/c4a7634b0b29c74625e183953e59c65987e9d66c))
    ...
    - Upgrade to prodash v23 ([`5bf0034`](https://github.com/yuki0iq/gitoxide/commit/5bf0034fb3918e57562b7089ceba83d63a1854bf))
    ...
    - Zlib::inflate::Error can now represent zlib status codes that represent failure. ([`25ad372`](https://github.com/yuki0iq/gitoxide/commit/25ad372bf500b851105f53b10369b5a689ba167e))
    ...
    - Add support for explicit non-parallel iteration. ([`0f27c67`](https://github.com/yuki0iq/gitoxide/commit/0f27c67c92fc0bc23a6712b5c4c730ad6a0156bf))
    ...
    - Upgrade to prodash v22 for API improvements ([`77ab98d`](https://github.com/yuki0iq/gitoxide/commit/77ab98dd41c3849b674d8b3794ef29219ca1447d))
    ...
    - Name spawned threads ([`6d530a1`](https://github.com/yuki0iq/gitoxide/commit/6d530a1dc77f0f4ac00622a2fd47c7bdb731a77a))
    ...
    - Thanks clippy ([`ad96233`](https://github.com/yuki0iq/gitoxide/commit/ad96233e1aa77fb7d9185f653f3e9519128cf20f))
    ...
    - Remove `fs-jwalk-single-threaded` in favor of `fs-walkdir-parallel`. ([`38446dc`](https://github.com/yuki0iq/gitoxide/commit/38446dc8824afef30ef121598de3451d13b9262c))
    - Make jwalk fully optional ([`3b29fc1`](https://github.com/yuki0iq/gitoxide/commit/3b29fc18672c0176684c797a0f16f85d09369bf8))
    ...
    - Allow discarding the state which could otherwise be used for aggregation. ([`56792fb`](https://github.com/yuki0iq/gitoxide/commit/56792fb53299d52073555c8646360ec0ae88c86d))
    - Allow input for `in_parallel_with_slice` to be mutable. ([`e928bf7`](https://github.com/yuki0iq/gitoxide/commit/e928bf7c699a7e48ad283c2cf7fd7479c37c70fc))
    - Perfect granularity for threads processing with `in_parallel_with_slice()` ([`a7c11d2`](https://github.com/yuki0iq/gitoxide/commit/a7c11d2cb5f88a4ff322d9a9848459062790d8b3))
    - Add `progress::Step|StepShared` as types of `prodash` ([`ff1db66`](https://github.com/yuki0iq/gitoxide/commit/ff1db66f2dad3afc8bc77610006bca9fea5947d2))
    ...
    - Update changelog prior to release ([`ff80042`](https://github.com/yuki0iq/gitoxide/commit/ff80042c9691e5dba5834c674174fdf6d3bdfe7d))
    - Fix git-features docs build ([`e5963fe`](https://github.com/yuki0iq/gitoxide/commit/e5963fea183d81db1fe502121b494146a58bd86e))
    ...
    - Merge branch 'dep-upgrade' ([`59767b1`](https://github.com/yuki0iq/gitoxide/commit/59767b1fc1d07b8a7a9333a719e3716746611bc4))
    - Upgrade prodash and crosstermion to latest versions ([`ab7ee5b`](https://github.com/yuki0iq/gitoxide/commit/ab7ee5b5d5c15771f431ada9c3b4f53e4be2afdd))
    - Add zlib-ng feature to allow linking against system libz-ng ([`cfe46b5`](https://github.com/yuki0iq/gitoxide/commit/cfe46b502afc3ecb312849ddbd7748007d432cd1))
    ...
    - Merge branch 'main' into filter-refs-by-spec ([`dbfa328`](https://github.com/yuki0iq/gitoxide/commit/dbfa3282cf876596b250b2040c1ec0b761741796))
    - Merge branch 'zlib-sys' ([`7b48297`](https://github.com/yuki0iq/gitoxide/commit/7b482977a556d28f5d9759e1be33cdf3d85c8665))
    - Restrict `sha1` `asm` to supported archs ([`b383fab`](https://github.com/yuki0iq/gitoxide/commit/b383fabbe10868317be51b99cfdd9b0981816042))
    - Add feature to link to traditional zlib for dynamic linking support ([`c954bbf`](https://github.com/yuki0iq/gitoxide/commit/c954bbff60ba70a0f1680e3978dd1f8fc1e3a0e7))
    ...
    - Add `fs-jwalk-single-threaded` feature to specifically decouple `jwalk` from rayon ([`f498d35`](https://github.com/yuki0iq/gitoxide/commit/f498d35baba52e40ecd47381e87c1ce49cf13285))
    ...
    - Thanks clippy! ([`c072dbb`](https://github.com/yuki0iq/gitoxide/commit/c072dbb3e203e4a42843895b7d99404d900fdccd))
    ...
    - Git-features' walkdir: 2.3.1 -> 2.3.2 ([`41dd754`](https://github.com/yuki0iq/gitoxide/commit/41dd7545234e6d2637d2bca5bb6d4f6d8bfc8f57))
    ...
    - Assure we used most recent version of crossbeam-utils ([`033f0d3`](https://github.com/yuki0iq/gitoxide/commit/033f0d3e0015b7eead6408c775d2101eb413ffbf))
    ...
    - Thanks clippy ([`380174f`](https://github.com/yuki0iq/gitoxide/commit/380174f0ad9e60ccafcd4cfb24e244f106137964))
    ...
    - Remove 'unused_mut' warning on windows ([`4733e6c`](https://github.com/yuki0iq/gitoxide/commit/4733e6c6f5ea7d5afa4dd171bbba066cf5120ddc))
    - Make fmt ([`7cf3545`](https://github.com/yuki0iq/gitoxide/commit/7cf354509b545f7e7c99e159b5989ddfbe86273d))
    - Commit to using 'unicode' feature of bstr as git-object wants it too ([`471fa62`](https://github.com/yuki0iq/gitoxide/commit/471fa62b142ba744541d7472464d62826f5c6b93))
    - Assure std::io::copy() doesn't hang when we cause an interrupt ([`234cd10`](https://github.com/yuki0iq/gitoxide/commit/234cd10ca55482ce1a840ce3244308d249895bcc))
    - Upgrade to prodash 19 ([`90c6c5a`](https://github.com/yuki0iq/gitoxide/commit/90c6c5aec4015ff969d6e2514fa4d49873ee80f5))
    - Thanks clippy ([`07a4094`](https://github.com/yuki0iq/gitoxide/commit/07a4094965ac1b4eb223da8e5ca5cc4a86c5f596))
    - Properly document optional features ([`572e57d`](https://github.com/yuki0iq/gitoxide/commit/572e57d5796692764c5c9633969aad25a6f9221a))
    ...
    - Upgrade dependencies ([`968df47`](https://github.com/yuki0iq/gitoxide/commit/968df4746729556dcf4f5039b1d1ed1a1da2705a))
    ...
    - Release git-features v0.16.4 ([`fd189c7`](https://github.com/yuki0iq/gitoxide/commit/fd189c7d973ad2a639d319f3761f37aa90712ef6))
    ...
    - [features #190] be more explicit about why sha1-asm is disabled ([`507d710`](https://github.com/yuki0iq/gitoxide/commit/507d710d837c3911a9329c1c132eee912a37e1a8))
    - [various #190] rename 'local-offset' to 'local-time-support' ([`3a7d379`](https://github.com/yuki0iq/gitoxide/commit/3a7d3793a235ac872437f3bfedb9dd8fde9b31b1))
    - [actor #190] methods to get an actor signature at the current time ([`6d0bedd`](https://github.com/yuki0iq/gitoxide/commit/6d0beddb20092a80b113a39c862d6b680d79deb6))
    - [features #189] simple UTC-offset support for git-features ([`b58134b`](https://github.com/yuki0iq/gitoxide/commit/b58134bbd132f9e685d1adf7859ec5219c16dd25))
    - [features #???] WIP local time ([`1388ebf`](https://github.com/yuki0iq/gitoxide/commit/1388ebf0925eb326ec3045d7f83bd5beda22a6fe))
    - [#189] Upgrade to prodash 16… ([`8e98418`](https://github.com/yuki0iq/gitoxide/commit/8e98418652926860f58906a6f21a3210e2f0183f))
    - [pack #67] Optimize caches based on cache debugging ([`1271c01`](https://github.com/yuki0iq/gitoxide/commit/1271c01d2635ab49474add61a9feb78b98bd6180))
    ...
    - [features] refactor ([`0958fc8`](https://github.com/yuki0iq/gitoxide/commit/0958fc8dbaa72dda0c1e2d40a88d74b4e18bfe39))
    - [features] refactor ([`d4605cd`](https://github.com/yuki0iq/gitoxide/commit/d4605cde6d825c0bfaf4282c4cbd85d9f07dc43f))
    - Release git-features v0.16.2 ([`42861ca`](https://github.com/yuki0iq/gitoxide/commit/42861ca4f0cc9b741d033d4ffa50147b08513b58))
    - Apply nightly rustfmt rules. ([`5e0edba`](https://github.com/yuki0iq/gitoxide/commit/5e0edbadb39673d4de640f112fa306349fb11814))
    - (cargo-release) version 0.16.1 ([`e10e55c`](https://github.com/yuki0iq/gitoxide/commit/e10e55c1bf1b40965da9b8b6c87953e6eafda09a))
    ...
    - Upgrade prodash/crosstermion ([`f109409`](https://github.com/yuki0iq/gitoxide/commit/f1094099de028deabbee3587a70291a7e625e328))
    ...
    - Refactor sha-1 specification to avoid duplication ([`e23d19c`](https://github.com/yuki0iq/gitoxide/commit/e23d19cd339f0ca5420c82e8125d2c9c7dfcb0da))
    - Resolver = 2: works! ([`6dc8779`](https://github.com/yuki0iq/gitoxide/commit/6dc877993135ce86649b239821e5b374251743d0))
    - Try windows one more time: resolver = "2" ([`69d52b8`](https://github.com/yuki0iq/gitoxide/commit/69d52b8ed7a733fe7f31826e576ba8b19619b148))
    - Fix windows, leave todo, move on ([`2de9e78`](https://github.com/yuki0iq/gitoxide/commit/2de9e78dba35de31456eb553ae703120de23cba6))
    - See if turning off "asm" support entirely fixes windows ([`b804ef2`](https://github.com/yuki0iq/gitoxide/commit/b804ef2ea6da1ebffaab4d09d0b91eae98ff70c9))
    - Try to fix build, again ([`c616627`](https://github.com/yuki0iq/gitoxide/commit/c616627cc9984e40798120a801387fc179d6640b))
    ...
    - [features] enable ASM for everyone… ([`7a1128f`](https://github.com/yuki0iq/gitoxide/commit/7a1128f594c5395a22e5e2b23772bce1d4de7a37))
    ...
    - [features] fix docs in the absence of sha1 related features ([`6ca02ac`](https://github.com/yuki0iq/gitoxide/commit/6ca02ace7552c1ffaead81929bc751d96afa713a))
    ...
    - Refactor ([`2174513`](https://github.com/yuki0iq/gitoxide/commit/21745135ced62411be535ebbc827b3638726318b))
    - Fix docs ([`e68d460`](https://github.com/yuki0iq/gitoxide/commit/e68d460716dc51c7f4757c11f3c8af6c3881e2cf))
    - Remove mentions of interrupt handling feature toggles ([`833ac04`](https://github.com/yuki0iq/gitoxide/commit/833ac0464b42bd3ecc76c6263b4b06e8ab4ff182))
    ...
    - First step towards moving git-features::interrupt… ([`8a741d0`](https://github.com/yuki0iq/gitoxide/commit/8a741d0c5423ed7c35d9382307c760a6b9460ccd))
    - Fix build ([`ea2bfac`](https://github.com/yuki0iq/gitoxide/commit/ea2bfac65f742ca7617bc77a50376c29156c4ea5))
    ...
    - Fix build ([`04d919f`](https://github.com/yuki0iq/gitoxide/commit/04d919f9228d287912554275194487870500d18c))
    ...
    - [tempfile] integrate with git-features to have a single top-level interrupt… ([`6e9400d`](https://github.com/yuki0iq/gitoxide/commit/6e9400d9cb8e370d870c3aa635718b134c82268f))
    - [features] protect interrupt handler from multi-initialization ([`592404c`](https://github.com/yuki0iq/gitoxide/commit/592404c2b24dc9d24465ff5f73216213436a277a))
    - [interrupt] remove any user mesasages as it can't be done in a handler. ([`8a10af7`](https://github.com/yuki0iq/gitoxide/commit/8a10af77db654ebce940bb05f8eefd171036ef40))
    - [tempfile] a first somewhat working version of signal-hooks for interrupt handling ([`07b3242`](https://github.com/yuki0iq/gitoxide/commit/07b3242e446cb4520dbc54308632ab6221fc19c8))
    - Update to latest prodash to get rid of ctrlc ([`c070d6f`](https://github.com/yuki0iq/gitoxide/commit/c070d6f5273d7ef9049ddd02fd26332623dc0ae6))
    - Refactor ([`2e86723`](https://github.com/yuki0iq/gitoxide/commit/2e8672312a4b1e2638e3ffe82a97cc2f87b496cf))
    - Bump crossbeam-utils from 0.8.4 to 0.8.5 ([`fce4d10`](https://github.com/yuki0iq/gitoxide/commit/fce4d107c7abc778bbdfcd37349c3075e54fd756))
    ...
    - [git-features] fix compilation ([`38c7961`](https://github.com/yuki0iq/gitoxide/commit/38c796142dc5823e1cb14906d9cd4040a8c3be3a))
    ...
    - [git-features] Remove feature that would break licensing agreements ([`cd6ce67`](https://github.com/yuki0iq/gitoxide/commit/cd6ce673308e7e5b1e86fb682ee3ace2ca9ae18c))
    - [git-features] fix typo ([`c6f342f`](https://github.com/yuki0iq/gitoxide/commit/c6f342f3d29a969a08d037f01eb24555bc03e85e))
    - [git-features] Finally zlib with feature toggles is working… ([`057016e`](https://github.com/yuki0iq/gitoxide/commit/057016e2df3138992c4857f9b65bf19dc2c9a097))
    - [git-features] And now zlib finally works! ([`6d887d5`](https://github.com/yuki0iq/gitoxide/commit/6d887d589a57e159986f049c8a9e19c52ce7b85b))
    - [git-features] simplify even more ([`ca54d97`](https://github.com/yuki0iq/gitoxide/commit/ca54d97d579dd4f16025a2325d5e39431f6e8a36))
    ...
    - [git-features] Add zlib module to allow changing implementation on the fly ([`4bdf783`](https://github.com/yuki0iq/gitoxide/commit/4bdf7833d99d3c2884b9747614f9c14a06c1e945))
    ...
    - Use crc32fast instead of `crc` ([`11955f9`](https://github.com/yuki0iq/gitoxide/commit/11955f95e200ef75e752a833952d288fbd0fc389))
    ...
    - Upgrade to prodash 13/tui 0.15 ([`1c99f51`](https://github.com/yuki0iq/gitoxide/commit/1c99f51b35b4ba85792a3b32dbb7e48052facc5e))
    ...
    - Fix compile warning for git-features ([`d457faa`](https://github.com/yuki0iq/gitoxide/commit/d457faac6bb56a229b74147c8a4cf2484026bb1a))
    - Fix doc links ([`870af2a`](https://github.com/yuki0iq/gitoxide/commit/870af2a6949bcb1f7f45bc0ff98d9e9a07014b22))
    ...
    - Remove unused dependency ([`26beb2a`](https://github.com/yuki0iq/gitoxide/commit/26beb2a5ad87e173fd3d13d17b0e9676a650cac9))
    - Don't finish the computation on drop of SteppedReduce ([`6453633`](https://github.com/yuki0iq/gitoxide/commit/6453633f1420327aee07dca2ad27abd8f96108c0))
    - Thanks clippy ([`c320761`](https://github.com/yuki0iq/gitoxide/commit/c320761821b08946a2b37e219400ded853a86408))
    ...
    - A first working version of a static parallel iterator #(67) ([`d7d5c68`](https://github.com/yuki0iq/gitoxide/commit/d7d5c6855a038a8b01571a6a16a61fe0d8036d30))
    - A way iteration won't work with 'static #(67) ([`6fda1f2`](https://github.com/yuki0iq/gitoxide/commit/6fda1f20a57b9dcc1a5818d8d0b656218b383230))
    ...
    - Less restrictive requirements: Clone instead of Copy #(67) ([`410e7d6`](https://github.com/yuki0iq/gitoxide/commit/410e7d64049b5a749113126f5412a61ae4b79887))
    - Improve Safety docs #(67) ([`15e4748`](https://github.com/yuki0iq/gitoxide/commit/15e47480054d9a517c28f47db3b5fa87968a307e))
    - A test to assure referenced input and references in 'consume' work #(67) ([`4526d82`](https://github.com/yuki0iq/gitoxide/commit/4526d82fab4d6e8f2ab05497aa5893d5a8f8b253))
    - Make iterator creation unsafe and document why #(67) ([`593d5df`](https://github.com/yuki0iq/gitoxide/commit/593d5df478e67e28f9b3d48b201ff6830208726f))
    - First seemingly working version of an iterator which allows controlling threaded work #(67) ([`4a7ef7d`](https://github.com/yuki0iq/gitoxide/commit/4a7ef7d6398c2ff5dd6aac41f8224cd2d61ee189))
    - Make the parallel SteppedReduce compile #(67) ([`017fdf4`](https://github.com/yuki0iq/gitoxide/commit/017fdf48972a6a09e5155bd76bd437d8e195dae3))
    - More docs to differentiate SteppedReduce from in_parallel() #(67) ([`153c083`](https://github.com/yuki0iq/gitoxide/commit/153c0837bbf1df3b5cb386e08265f9b06eaee2a9))
    - Serial version of SteppedReduce seems to be working #(67) ([`779542e`](https://github.com/yuki0iq/gitoxide/commit/779542e4f4c951e9b16d2310146020da9ce36859))
    - Only store thread state #(67) ([`0bf8a9b`](https://github.com/yuki0iq/gitoxide/commit/0bf8a9b3c4a086732ee04f81c6a214296d49eab9))
    - Sketch instantiation of iterator adapter #(67) ([`a3083ad`](https://github.com/yuki0iq/gitoxide/commit/a3083ad3aad7984afc6b6d343ca7453f79897062))
    - A reducer test in preparation for allow it to be used as iterator #(67) ([`1c2adf4`](https://github.com/yuki0iq/gitoxide/commit/1c2adf4a546273489bf8224eb7982dbdf3fb6aca))
    ...
    - Refactor ([`dee8c66`](https://github.com/yuki0iq/gitoxide/commit/dee8c66e300dc2a2b6e1a6d6c3674a7ce6aac687))
    - (cargo-release) version 0.11.0 ([`1aa1f5e`](https://github.com/yuki0iq/gitoxide/commit/1aa1f5e84a07427d5d7f3231735fe9c1923f506f))
    - (cargo-release) version 0.10.1 ([`0dcdfd7`](https://github.com/yuki0iq/gitoxide/commit/0dcdfd754649240f43fe0f4b6e1245e8c7b89635))
    ...
    - Assure basic 'organize' operation is working as expected ([`deb6073`](https://github.com/yuki0iq/gitoxide/commit/deb6073671ae95de674aaef7ca01e03f95b41ca8))
    - A first stab at finding git repositories ([`e4dc964`](https://github.com/yuki0iq/gitoxide/commit/e4dc96403894f1fe509335905679347ecdf535c7))
    - Upgrade 'jwalk' ([`cba048f`](https://github.com/yuki0iq/gitoxide/commit/cba048f094858388f4242e37a2409fe0822f8c07))
    - Upgrade 'bytes' ([`3934392`](https://github.com/yuki0iq/gitoxide/commit/39343922b4a1129394aa788a9591920aee077569))
    - Upgrade prodash and friends ([`50755bc`](https://github.com/yuki0iq/gitoxide/commit/50755bc83f73072dc629301bf69c5c065d5c2aa4))
    ...
    - Fix io::pipe tests ([`9604154`](https://github.com/yuki0iq/gitoxide/commit/9604154e687813a11f0eee469e408561a6a74a4e))
    - Uograde everything else ([`0cd79d0`](https://github.com/yuki0iq/gitoxide/commit/0cd79d00bce3f042b5cc849cf48739e29f95fcb0))
    - Upgrade prodash and tui ([`b5eadca`](https://github.com/yuki0iq/gitoxide/commit/b5eadca343bbaa1af86722b5f1bcd33f4e3939a6))
    - Add remaining docs to git-features using the missing_docs directive ([`f8aafd6`](https://github.com/yuki0iq/gitoxide/commit/f8aafd6c78687899a2ca3a3e6147d93fc45b8cb9))
    - (cargo-release) version 0.8.0 ([`47c00c2`](https://github.com/yuki0iq/gitoxide/commit/47c00c2228cf25c79e1fa3eb4229c7ab24de91e5))
    - Finish git-features documentation ([`934a26c`](https://github.com/yuki0iq/gitoxide/commit/934a26c5e254baf2be9178096b6dead0e4c1ed1d))
    ...
    - Docs for the git-features::pipe module ([`67a950a`](https://github.com/yuki0iq/gitoxide/commit/67a950a2e0fd56b29565668ed0a0f399d5aa989d))
    - Document git-features::parallel ([`b899227`](https://github.com/yuki0iq/gitoxide/commit/b8992275cd4310b05494be41c059e9b6049d06b1))
    - Dependency update ([`fb077f9`](https://github.com/yuki0iq/gitoxide/commit/fb077f9fecb89ed8a60d57b45726401883e838bf))
    - Finish git_features::interrupt docs ([`471a1bf`](https://github.com/yuki0iq/gitoxide/commit/471a1bf24efee70f21b15839cdc9f8ebe319f917))
    - Dependency update ([`b3b4aba`](https://github.com/yuki0iq/gitoxide/commit/b3b4aba5e05596befecd17e225067be9315b74fd))
    - Docs for git-features::hash ([`a3fdecc`](https://github.com/yuki0iq/gitoxide/commit/a3fdecc9a3587b20c01e3b3a2d51190138131c3d))
    - First sketch of filesystem docs for git-features ([`1a8141c`](https://github.com/yuki0iq/gitoxide/commit/1a8141c2c4a8bcc79d68049a35bd8aba5ab822a3))
    ...
    - [clone] test (and fix) for piped line reading ([`afe2996`](https://github.com/yuki0iq/gitoxide/commit/afe2996689b5bea915ac5f142d320056faf49899))
    ...
    - [clone] pipe allows to send errors as well ([`69286ec`](https://github.com/yuki0iq/gitoxide/commit/69286ecb3680b5071693ef0d9fb2e9345b2722d4))
    - [clone] BufRead for Reader… ([`bf1d40f`](https://github.com/yuki0iq/gitoxide/commit/bf1d40f2d44a9b04ffe2134ddcd3779985cdafc4))
    - [clone] a piped iterator ([`5148c85`](https://github.com/yuki0iq/gitoxide/commit/5148c85efc70c0ec06be3ebce267ce727c8ee4e1))
    - [clone] pipe probably shouldn't abort on empty writes ([`9cfa9b7`](https://github.com/yuki0iq/gitoxide/commit/9cfa9b79841187167f0f96abfd1c17a37b4c365d))
    - Thanks clippy ([`c4f570f`](https://github.com/yuki0iq/gitoxide/commit/c4f570fcae7e21745a37a4265b05d21e6149157b))
    - [clone] more pipe tests ([`1652a74`](https://github.com/yuki0iq/gitoxide/commit/1652a74761631cadfc6feab366adc0808d83063d))
    - [clone] first working pipe implementation ([`490a9b9`](https://github.com/yuki0iq/gitoxide/commit/490a9b96915a760e339e576d9f49737b43a8739f))
    ...
    - Fix git-features hash tests ([`35e8809`](https://github.com/yuki0iq/gitoxide/commit/35e8809f6bc7d19ed9e0bac8e3af85f433978901))
    ...
    - Add 'disable-interrupts' feature flag ([`ccd9c3e`](https://github.com/yuki0iq/gitoxide/commit/ccd9c3e2d37aa6898dc17f47a82c187baa810b03))
    ...
    - Update dependencie ([`ade06b4`](https://github.com/yuki0iq/gitoxide/commit/ade06b46bb3c16ac1e26dbbb4a7045f0c09f2d8e))
    ...
    - Remove once_cell dependency as it is really not required anymore ([`5ac9538`](https://github.com/yuki0iq/gitoxide/commit/5ac95385cc8d1c50c16da6e5fb0c66ac138f9966))
    - Make interrupt handler work reliably ([`e71da0f`](https://github.com/yuki0iq/gitoxide/commit/e71da0fce6d6eab68f7b81b13cdc78ce8e9b7ee3))
    ...
    - Refactor ([`d14f0f6`](https://github.com/yuki0iq/gitoxide/commit/d14f0f6c3b5f303df75b33aadbf16653075d2272))
    - Allow eager iterator to behave properly when used with index writing ([`66ebc5f`](https://github.com/yuki0iq/gitoxide/commit/66ebc5f1ad5f262eb464dc7ca0892ec952d34382))
    ...
    - Now it's order preserving ([`4c8711e`](https://github.com/yuki0iq/gitoxide/commit/4c8711e51efd88e0f159ad02de2692c4cb72ce27))
    ...
    - Make sure interrupt logic works even without an interrupt handler… ([`66b1644`](https://github.com/yuki0iq/gitoxide/commit/66b164472f5893f9e634ac1f9147a41dc742296d))
    ...
    - Thanks clippy ([`ed5882d`](https://github.com/yuki0iq/gitoxide/commit/ed5882d75e0a9fceb0628e84302eb49a66277fa6))
    ...
    - Interrupt support for pretty plumbing ([`bca7ce2`](https://github.com/yuki0iq/gitoxide/commit/bca7ce2e668a4be2600d2d04d00f46b21c82eee2))
    ...
    - See how big a Sha1 hasher really is ([`26b271d`](https://github.com/yuki0iq/gitoxide/commit/26b271d44863fb184b0a947c3a9da2b3252f9a78))
    ...
    - First round of number tuning done ([`a647b2d`](https://github.com/yuki0iq/gitoxide/commit/a647b2da2905c4079e646ea44cbec778f3f7c71f))
    - Somehow handle chunk size in absence of known chunk amount ([`acfccad`](https://github.com/yuki0iq/gitoxide/commit/acfccadef40ebcc67f8dea4e58c02392b7e2e7de))
    - Chunk computation seems alright, what about realistic values ([`973e6bb`](https://github.com/yuki0iq/gitoxide/commit/973e6bb3d67d89eec2faf2467a129d992b90ed72))
    - Getting there… ([`a1b5d56`](https://github.com/yuki0iq/gitoxide/commit/a1b5d565f305f0f2666fd59272d9bf9c62ae2962))
    - First step towards computing better chunk sizes and thread limits ([`1cdde7d`](https://github.com/yuki0iq/gitoxide/commit/1cdde7d339a6ed3650c54f9b48154089d7da9919))
    ...
    - (more) graceful shutdown of failing parallel tasks ([`163f50f`](https://github.com/yuki0iq/gitoxide/commit/163f50fab81b425e6e306ec54fb1eb60a7c02cf8))
    ...
    - Flume isn't actually needed for that… ([`c750022`](https://github.com/yuki0iq/gitoxide/commit/c750022394928aa37a8400611f6fdf4ee77c0f69))
    - Don't just ignore send errors - we should panic for now ([`f128117`](https://github.com/yuki0iq/gitoxide/commit/f128117138b24de780a00bb96e7c1c9f987e8aa0))
    ...
    - Upgrade to prodash version 7 ([`af02b46`](https://github.com/yuki0iq/gitoxide/commit/af02b46cc1eff5ba1da7da20d3f524a79fad686f))
    - Update prodash to verion 6.0 ([`a4731a3`](https://github.com/yuki0iq/gitoxide/commit/a4731a3aca159f8916b29d9ce5a71856089c5a6b))
    ...
    - Switch to prodash 5.0 for windows support ([`88542e1`](https://github.com/yuki0iq/gitoxide/commit/88542e117dd1c2e7606fcbe88b30c51b4c115989))
    ...
    - Avoid calling system time too often in logs, it reduced performance ([`b17bd76`](https://github.com/yuki0iq/gitoxide/commit/b17bd76d35822b3af174c74af3d6fac887889fe2))
    - Revert "ABORT: try-join with static typing works, but…" ([`b8b979b`](https://github.com/yuki0iq/gitoxide/commit/b8b979b99b5f3848e0a6884c58594ba2b481a147))
    - Try-join with static typing works, but… ([`ab6f98b`](https://github.com/yuki0iq/gitoxide/commit/ab6f98b905f13ed2a7c0c483f34fab63141fbc5b))
    ...
    - Automatically close the TUI when there is no progress anymore. ([`c416152`](https://github.com/yuki0iq/gitoxide/commit/c416152b04051958de7bd161a8a2ee42ca163275))
    - Pretty progress in a generalized form ([`caa883b`](https://github.com/yuki0iq/gitoxide/commit/caa883b96827deb63b5c8787ed820d22f2c85249))
    - Express DoOrDiscard in terms of Either (progress) ([`cb29a45`](https://github.com/yuki0iq/gitoxide/commit/cb29a45f4e73bfaa25cbf623b1cda2435673028b))
    - Provide 'either' type with implementation for Progress ([`237bb5e`](https://github.com/yuki0iq/gitoxide/commit/237bb5ee1c2b677f5bfd9ca7fdea9d9d2db865b3))
    - Better trait bounds of `in_parallel_if`… ([`6264f2f`](https://github.com/yuki0iq/gitoxide/commit/6264f2f99929ffaa4d50cdcae7bc296e1b4762f4))
    ...
    - Implement `Progress` trait for prodash::tree::Item ([`0eeb6d7`](https://github.com/yuki0iq/gitoxide/commit/0eeb6d770d58621427bc88107a20860b89b86a24))
    - Implement progress trait for logs with throttling ([`287eca9`](https://github.com/yuki0iq/gitoxide/commit/287eca91b244ccbc703cb275b1ae032bfeb02532))
    - Add 'fast-sha1' to git-features ([`b22541f`](https://github.com/yuki0iq/gitoxide/commit/b22541f0c39af470877119b136e4eb1b82dff2db))
    - A new crate to represent features that can toggle from the top-level ([`23c420c`](https://github.com/yuki0iq/gitoxide/commit/23c420cc95219dc7c04d3905aaa03281cb51724e))
</details>
