 ...
 * **Uncategorized**
    ...
    - Add a test to assure `subomdule.<name>.ignore = all` is handled correctly. ([`657dec4`](https://github.com/yuki0iq/gitoxide/commit/657dec4f10bc6babbfa71a4506b1ff1439c06eaf))
 ...
 * **Uncategorized**
    ...
    - Make sure that submodule hashes aren't attached as the parent repo is the wrong one here. ([`c96f26b`](https://github.com/yuki0iq/gitoxide/commit/c96f26b5c13581812753638a24d261c3f75dddcf))
    - Properly isolate environment variable based tests into their own binary ([`c35ddab`](https://github.com/yuki0iq/gitoxide/commit/c35ddab41ff6f18ad9cd11df44cfffee91563433))
    ...
    - Adapt to changes in `gix` ([`9fe3052`](https://github.com/yuki0iq/gitoxide/commit/9fe305291cf8ba908eaf38235f54abfa1d0ddeed))
    - Add `Worktree::pathspec()` to easily get worktree-scoped pathspec searches. ([`28249bd`](https://github.com/yuki0iq/gitoxide/commit/28249bda58b56af340c7d6af883496c3bb2d6804))
    - Add `Submodule` type to represent a declared submodule. ([`59bb3c4`](https://github.com/yuki0iq/gitoxide/commit/59bb3c4109c4e7f1977cea602293be85b7d14a8a))
    ...
    - Adapt to changes in `gix-url` ([`f8fc662`](https://github.com/yuki0iq/gitoxide/commit/f8fc6625d8c22f43e7ab5f1cdf1e8eb9a6ea34de))
    - `pathspec_search([specs])` to instantiate a search using pathspecs. ([`a7d0e44`](https://github.com/yuki0iq/gitoxide/commit/a7d0e441b2326520ae467e83e045302792e6bcd0))
    - `Repository::prefix()` is now side-effect free and won't error if CWD is outside of working tree dir. ([`430e58c`](https://github.com/yuki0iq/gitoxide/commit/430e58cd1efef0044fc36b23de019156a21f947c))
    - Merge branch 'pathspec-matching' ([`9f4dfe0`](https://github.com/yuki0iq/gitoxide/commit/9f4dfe0f0b948280692916b596923959ea2fd9da))
    - `Repository::prefix()` turns `Option<Result` into `Result<Option`. ([`b1e55d6`](https://github.com/yuki0iq/gitoxide/commit/b1e55d6f9e4c0d78f0cdeb7b85e09c2eb7032ced))
    - Make `gix-pathspec` crate available ([`77da014`](https://github.com/yuki0iq/gitoxide/commit/77da01456118227a59b654f32c15eeb1e5e19cd9))
    - Merge branch 'handlers-mt' ([`f584d76`](https://github.com/yuki0iq/gitoxide/commit/f584d7698d93836daef2000fd369034de46037f0))
    - Improve `interrupt::init_handler()` to be usable from multiple threads ([`46225c2`](https://github.com/yuki0iq/gitoxide/commit/46225c2bc399e6db5a56b522c978e0d1fac163df))
    ...
    - Add `Commit::signature()` to yield the PGP sigature of a commit, if present. ([`5c13459`](https://github.com/yuki0iq/gitoxide/commit/5c13459721eabb9d0746899a2498a104ddbdae59))
    ...
    - More idiomatic use of `config.section_by_name()` ([`0a584ee`](https://github.com/yuki0iq/gitoxide/commit/0a584eeb5c756ec4b0d54c4fd9ea3cc1497f4ba9))
 ...
 * **Uncategorized**
    ...
    - Add `Tree::decode()` and `TryFrom<Tree> for gix::objs::Tree`. ([`7c2e5c8`](https://github.com/yuki0iq/gitoxide/commit/7c2e5c8d08e4dd1ec115ae06f20f9c8f93d6d616))
