 ...
 * **Uncategorized**
    ...
    - Merge pull request #2218 from GitoxideLabs/hash ([`feccdf8`](https://github.com/yuki0iq/gitoxide/commit/feccdf88e3ae465cae2135a32e49b09a8154c8e7))
    ...
    - Improve wording of compile error in gix-hash to better match existing uses ([`4a0b84a`](https://github.com/yuki0iq/gitoxide/commit/4a0b84a26c9eda5b4ce7ab94447a3d8bc5c04a6e))
    - Mark `enum ObjectId` as non-exhaustive ([`0625bb3`](https://github.com/yuki0iq/gitoxide/commit/0625bb349b9a2b4d85187881557074fe73c93476))
    - Add feature flag `sha1` and make it the default ([`a183ed7`](https://github.com/yuki0iq/gitoxide/commit/a183ed7bb1c7042aa1a2dbdb9f9619864221fd83))
    ...
    - Merge pull request #2166 from GitoxideLabs/copilot/fix-ffb06a30-3f53-4f82-94ed-51935d63da63 ([`b4812d9`](https://github.com/yuki0iq/gitoxide/commit/b4812d9d9594bca68b71eb9b5b15bd082d398fd2))
    - Merge pull request #2165 from GitoxideLabs/copilot/fix-ceb7b1a4-93f5-4da1-a4f2-4290c8f594eb ([`772c434`](https://github.com/yuki0iq/gitoxide/commit/772c4344839e28ec76e546c4d6638a221fc91740))
    - Refactor ([`58e2d18`](https://github.com/yuki0iq/gitoxide/commit/58e2d18cd0684f2da51f94eb51e4402165e63efa))
    - Add `oid::is_empty_tree()`` and `oid::is_empty_blob()`. ([`0f20e0a`](https://github.com/yuki0iq/gitoxide/commit/0f20e0a542b168c212b72d5823e4a7e0b1d0095c))
    - Refactor ([`41c40ad`](https://github.com/yuki0iq/gitoxide/commit/41c40adf3d1a8505dd53dc49a6940c834e71e169))
    - Add `Kind::empty_blob()`` and `Kind::empty_tree()`` methods. ([`7fca001`](https://github.com/yuki0iq/gitoxide/commit/7fca001b13d22a0aa7e2196018323b3edca7586a))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1932 from EliahKagan/run-ci/32bit-size ([`269d2da`](https://github.com/yuki0iq/gitoxide/commit/269d2da3e206d216e3c5449127e2dd3e6652a41a))
    - Fix `size_of_hasher` test for 32-bit Windows ([`4cea38b`](https://github.com/yuki0iq/gitoxide/commit/4cea38bb093717b63cacb910c49e57840d07a1de))
 ...
 * **Uncategorized**
    ...
    - Add common interface for hash verification ([`b32f1f3`](https://github.com/yuki0iq/gitoxide/commit/b32f1f3243821f97f95350e21745c97fe7b1377e))
    - Drop `gix_hash::{hasher::Digest, Hasher::digest()}` ([`65aab56`](https://github.com/yuki0iq/gitoxide/commit/65aab56ebdc0b676b5ebf47fd3b102928b4ed4aa))
    ...
    - Add more tests for SHA‐1 vectors ([`25ff995`](https://github.com/yuki0iq/gitoxide/commit/25ff995fb1f7dcee4ce0fc45908df9e77b6a1a84))
 ...
 * **Uncategorized**
    ...
    - Hex-display of any object ID is now faster as `oid::hex_to_buf()` now returns `&mut str`. ([`c17aee6`](https://github.com/yuki0iq/gitoxide/commit/c17aee648c14035d094fe8e84373ee404f477d2a))
 ...
 * **Uncategorized**
    ...
    - Remove panicking version of `ObjectId::from()` in favor of `ObjectId::from_bytes_or_panic()`. ([`b2ded12`](https://github.com/yuki0iq/gitoxide/commit/b2ded125b8268fcd95d149db79279d94b2ec7e71))
 ...
 * **Uncategorized**
    ...
    - Add `Oid::is_null()` - previously it was only available on `ObjectId`. ([`20e56b3`](https://github.com/yuki0iq/gitoxide/commit/20e56b3d635a46eb2f42b9ccfb171fbbf01b96ef))
 ...
 * **Uncategorized**
    ...
    - Add another doc-alias for a commonly used hash method ([`ed458c0`](https://github.com/yuki0iq/gitoxide/commit/ed458c08133ddf1ea3b05b3c95c6534f80763259))
</details>
 ...
 * **Uncategorized**
    ...
    - Improve hex-parsing performance. ([`bd86f83`](https://github.com/yuki0iq/gitoxide/commit/bd86f838a304e154828fb3fa1403ea2b713f95a6))
</details>
 ...
 * **Uncategorized**
    ...
    - Add `ObjectId::is_empty_tree()` as sybling of `::is_empty_blob()`. ([`8d645b0`](https://github.com/yuki0iq/gitoxide/commit/8d645b0494bb0376358fcf6e57a37b865ca91a96))
 ...
 * **Uncategorized**
    ...
    - Prepare changelogs prior to release ([`a0a938f`](https://github.com/yuki0iq/gitoxide/commit/a0a938f8fd3442259ad3008778738f91bbc6e1a9))
    - Merge branch 'patch-1' ([`b02bf24`](https://github.com/yuki0iq/gitoxide/commit/b02bf247890c873184e58f734e0912eac6c6bbae))
    - Add comment explaining `oid::hash` ([`cfd93f6`](https://github.com/yuki0iq/gitoxide/commit/cfd93f686dac752a7dc9b7fef3b7a706f265c6b0))
    - Clippy ([`b2a5b9d`](https://github.com/yuki0iq/gitoxide/commit/b2a5b9dc50ae2a26672c2ad8a586beca3e659361))
    - Make `oid` `Hash` work on 32-bit targets ([`28168ee`](https://github.com/yuki0iq/gitoxide/commit/28168eee8ea5926793ef509ad56ee1a00c230ca6))
</details>
 ...
 * **Uncategorized**
    ...
    - Merge branch 'empty-blob' ([`796f298`](https://github.com/yuki0iq/gitoxide/commit/796f2982ebc0b7682d0ee8987221fd3397e631aa))
    - Refactor ([`231b268`](https://github.com/yuki0iq/gitoxide/commit/231b268964c8e066aa58132978068be7c50b6d63))
    - Add `ObjectId::empty_blob()` to obtain the empty blob object. ([`c817626`](https://github.com/yuki0iq/gitoxide/commit/c817626a501dd3c8edd444c6e31ba04d9da31776))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 16 unique issues were worked on: [#198](https://github.com/yuki0iq/gitoxide/issues/198), [#222](https://github.com/yuki0iq/gitoxide/issues/222), [#279](https://github.com/yuki0iq/gitoxide/issues/279), [#287](https://github.com/yuki0iq/gitoxide/issues/287), [#293](https://github.com/yuki0iq/gitoxide/issues/293), [#298](https://github.com/yuki0iq/gitoxide/issues/298), [#301](https://github.com/yuki0iq/gitoxide/issues/301), [#329](https://github.com/yuki0iq/gitoxide/issues/329), [#331](https://github.com/yuki0iq/gitoxide/issues/331), [#413](https://github.com/yuki0iq/gitoxide/issues/413), [#427](https://github.com/yuki0iq/gitoxide/issues/427), [#450](https://github.com/yuki0iq/gitoxide/issues/450), [#470](https://github.com/yuki0iq/gitoxide/issues/470), [#522](https://github.com/yuki0iq/gitoxide/issues/522), [#63](https://github.com/yuki0iq/gitoxide/issues/63), [#691](https://github.com/yuki0iq/gitoxide/issues/691)
 ...
 * **[#198](https://github.com/yuki0iq/gitoxide/issues/198)**
    ...
    - Format links for commit ids ([`9426db5`](https://github.com/yuki0iq/gitoxide/commit/9426db53537162d58a65648f3f3a3a3b65f621dc))
    ...
    - Rename `oid::short_hex()` to `oid::to_hex()` ([`8be4036`](https://github.com/yuki0iq/gitoxide/commit/8be4036dce4a857cc14a8b9467aaf2fc0fc2e827))
    ...
    - Oid::short_hex(len) for truncated hex representations ([`ed16bce`](https://github.com/yuki0iq/gitoxide/commit/ed16bce97c235e7e188444afd7a0d3f7e04a6c72))
 ...
 * **[#279](https://github.com/yuki0iq/gitoxide/issues/279)**
    - Basic multi-pack index creation ([`89428b2`](https://github.com/yuki0iq/gitoxide/commit/89428b2936fb0169606a543cf531bddaacb8187c))
    ...
    - Assign version numbers to `Kind` and implement `TryFrom<u8>` ([`84e26a7`](https://github.com/yuki0iq/gitoxide/commit/84e26a7f3cbae31210e100880a48d3b3e6d04013))
    ...
    - Remove `Kind:Efrom_len_in_bytes()` from public API ([`1b75541`](https://github.com/yuki0iq/gitoxide/commit/1b75541c00b8a18000336a8a7eceae5beba1058d))
    - Remove `ObjectId::null_sha1()` from public API ([`b12ee8a`](https://github.com/yuki0iq/gitoxide/commit/b12ee8a97904e6e90b6c08ad9e6804ee969bff41))
    - Rename `Kind::null()` to `null_ref()` and `Kind::null_owned()` to `null()` ([`eaf48bd`](https://github.com/yuki0iq/gitoxide/commit/eaf48bd75a3b778e31695257aedfbd008769f7bb))
    - Remove `Kind::new_sha1()` from public API ([`60a4eb5`](https://github.com/yuki0iq/gitoxide/commit/60a4eb5dd7f50949799c558a225146d442dcf936))
    - Kind::from_len_in_bytes() is infallible ([`c079fbe`](https://github.com/yuki0iq/gitoxide/commit/c079fbe2099bd0ba43e811e987a80ae14e15e131))
    - Refactor ([`7331e99`](https://github.com/yuki0iq/gitoxide/commit/7331e99cb88df19f7b1e04b1468584e9c7c79913))
    - Remove `ObjectId::from_20_bytes()` from public API ([`2a799e6`](https://github.com/yuki0iq/gitoxide/commit/2a799e662aa172c243b54d1df0dfc78501cb024f))
    - Fix docs ([`cd981e2`](https://github.com/yuki0iq/gitoxide/commit/cd981e222af237c47fcfb74258de8fdfc04dfc1b))
    - Remove various SHA1 specific hex utilities in favor of unspecific new ones ([`53c748d`](https://github.com/yuki0iq/gitoxide/commit/53c748d7f438f57e8119cdf04402bfeaa9f2a286))
    - `oid::null_sha1()` replaced with `Kind::null()` ([`67652cb`](https://github.com/yuki0iq/gitoxide/commit/67652cb5cf01c45291d6e117c31290c585bab9d1))
    - Remove `ObjectId::from_borrowed_sha1()` ([`3363f1e`](https://github.com/yuki0iq/gitoxide/commit/3363f1e61295810964ddb0c255eed87a87fe6539))
    - Remove `ObjectId::to_sha1_hex_string()` ([`75b901e`](https://github.com/yuki0iq/gitoxide/commit/75b901eff177dade43a28e770920a2b2206ded69))
    - SIZE_OF_SHA1_DIGEST is now private ([`b596fa0`](https://github.com/yuki0iq/gitoxide/commit/b596fa0dbbb3cc1d3ac386458ef52e2db9bca55c))
    - Rename `Kind::to_hex()` to `Kind::to_hex_with_len()`; add `Kind::to_hex()` ([`3373946`](https://github.com/yuki0iq/gitoxide/commit/3373946d27c91169172e62a637a305ef1e5fbb9e))
    - Add `Kind::from_len_in_bytes()` const fn ([`ce673bf`](https://github.com/yuki0iq/gitoxide/commit/ce673bfd9afee4a7872c6bcae1c39006b1747be7))
    - `Kind::len_in_bytes()` method ([`9a0d8b8`](https://github.com/yuki0iq/gitoxide/commit/9a0d8b810050f2acabca988c5ab24ebe93a5d260))
 ...
 * **[#298](https://github.com/yuki0iq/gitoxide/issues/298)**
    ...
    - Refactor; add docs ([`837db62`](https://github.com/yuki0iq/gitoxide/commit/837db626b88b08567c059f9f6687ad3124117ed3))
    - Git-hash::Prefix::from_id() ([`cb83bee`](https://github.com/yuki0iq/gitoxide/commit/cb83beedd1aa389f6774e2296f79273e8c8f14f4))
    - Implement Display for hash kind ([`bc89fc7`](https://github.com/yuki0iq/gitoxide/commit/bc89fc77354f7d8af6628364be18550c4a45c789))
 * **[#301](https://github.com/yuki0iq/gitoxide/issues/301)**
    ...
    - `Commit::short_id()` ([`1be00cf`](https://github.com/yuki0iq/gitoxide/commit/1be00cf9e00ce9428ffddb2c79b2373926069b13))
 ...
 * **[#413](https://github.com/yuki0iq/gitoxide/issues/413)**
    - Don't hardcode Sha1 ([`521c894`](https://github.com/yuki0iq/gitoxide/commit/521c894faf8b1875f449c04aa87003066d4c04ff))
    - Refactor ([`85b9f13`](https://github.com/yuki0iq/gitoxide/commit/85b9f13eb29359a34597fb615805d0fa5aac075b))
    - Refactor ([`073d3a1`](https://github.com/yuki0iq/gitoxide/commit/073d3a104725b06279dbfca6d1a35531fa9cb5c5))
    - `Prefix::from_hex()` ([`535411f`](https://github.com/yuki0iq/gitoxide/commit/535411f94dcab7e7d9cab6324ac30a4c70298bb2))
 * **[#427](https://github.com/yuki0iq/gitoxide/issues/427)**
    - `Prefix::from(ObjectId)` ([`0579438`](https://github.com/yuki0iq/gitoxide/commit/05794383cb7c903ab30b5d6ef0178dffdf66feee))
    - Expose `Prefix::MIN_HEX_LEN`. ([`652f228`](https://github.com/yuki0iq/gitoxide/commit/652f228bb7ec880856d4e6ee1c171b0b85a735e2))
 * **[#450](https://github.com/yuki0iq/gitoxide/issues/450)**
    - Refactor ([`93ac4c3`](https://github.com/yuki0iq/gitoxide/commit/93ac4c38e5837250e158613820a6ac1bb7119ba0))
 ...
 * **[#522](https://github.com/yuki0iq/gitoxide/issues/522)**
    - Don't assume hex-only characters in `ObjectId::from_hex(…)`. ([`aaed7ea`](https://github.com/yuki0iq/gitoxide/commit/aaed7eaf4887d5e499437d45c8284bc8941da2ac))
    - Refactor ([`f3bcddf`](https://github.com/yuki0iq/gitoxide/commit/f3bcddff931e50472e7a3e8c2c60f3cd565bfa56))
    - Refactor ([`0f0de2b`](https://github.com/yuki0iq/gitoxide/commit/0f0de2ba7837e2044e22a16b6d5e20b3137e9691))
 * **[#63](https://github.com/yuki0iq/gitoxide/issues/63)**
    - Revert "Add additional variant for Sha256 in ObjectId" ([`bb24dc4`](https://github.com/yuki0iq/gitoxide/commit/bb24dc44beb6354fe2d96d2318d4d3219f06ae85))
    - Add additional variant for Sha256 in ObjectId ([`3dd7c43`](https://github.com/yuki0iq/gitoxide/commit/3dd7c4350e140b72c21598f95a4557e6115d3124))
    - Make ObjectId into an enum to soon hold more bytes (and type) ([`4bf0c1a`](https://github.com/yuki0iq/gitoxide/commit/4bf0c1a5a5c23bb0c0836ab8cea41eb06a232906))
    ...
    - Remove now unused gith-hash::borrowed::Id ([`59ab1bd`](https://github.com/yuki0iq/gitoxide/commit/59ab1bd9a8ea57e1770caf8841a0af5d38905bec))
    - More general to-hex for ObjectId ([`e2be868`](https://github.com/yuki0iq/gitoxide/commit/e2be868ad4a131682d4aae629ca5b3a5b7ed0d5f))
    - Fix incorrectly implemented display for `oid` ([`c4186b0`](https://github.com/yuki0iq/gitoxide/commit/c4186b0a986b4b49f8aa70308b492063bd33285c))
    - Git-commitgraph uses `oid` now ([`0b72966`](https://github.com/yuki0iq/gitoxide/commit/0b72966249523b97fce1bc7b29082ac68fa86a4f))
    - Notes about future proofing `oid` type… ([`658c896`](https://github.com/yuki0iq/gitoxide/commit/658c896690f9a5b63f08484e90837bd1338420a5))
    ...
    - Oid with even more conversions and better hex-display ([`eecd664`](https://github.com/yuki0iq/gitoxide/commit/eecd6644b10ba1e2e8481287db85c67ea6268674))
    ...
    - Add quality-of-life parse() support for hex input ([`6f97063`](https://github.com/yuki0iq/gitoxide/commit/6f97063b14eb3b38a36e418657fd50f80db7f905))
    - Make ObjectId/oid happen! ([`ca78d15`](https://github.com/yuki0iq/gitoxide/commit/ca78d15373ec988d909be8f240baefe75555e077))
    - A seemingly complete implementation of a referenced borrowed Id ([`b3fc365`](https://github.com/yuki0iq/gitoxide/commit/b3fc36565157a7f9d2fc9cf1a3c009a20c66e661))
    - Fix doc string naming ([`59c3d45`](https://github.com/yuki0iq/gitoxide/commit/59c3d454b61e6932aee0fce0f709ac214db08633))
 ...
 * **Uncategorized**
    ...
    - Rename `git-hash` to `gix-hash` ([`416d1dc`](https://github.com/yuki0iq/gitoxide/commit/416d1dcb71b40ca8a23e8793af4d44bbe9847c27))
    ...
    - Prepare changelogs prior to git-hashtable release ([`3bafb79`](https://github.com/yuki0iq/gitoxide/commit/3bafb795afb901768ac0f3db99c9d2341a3e170f))
    ...
    - Fix docs ([`71cb9ea`](https://github.com/yuki0iq/gitoxide/commit/71cb9eaefb792656b6380fdcc760c2234f9b9fa7))
    - Replace `quickerror` with `thiserror` ([`7926f47`](https://github.com/yuki0iq/gitoxide/commit/7926f47ebc34e11c769acfd3441ab391fc1b9b36))
    - Some more tests ([`400c6cb`](https://github.com/yuki0iq/gitoxide/commit/400c6cb14fe24b5e947f0c7f3a105deecd3b2f84))
    ...
    - Merge branch 'kalkin-improve-prefix' ([`0866e89`](https://github.com/yuki0iq/gitoxide/commit/0866e89ad498f85478dccfabeb3b3f0b75d65442))
    - Implement `TryFrom<&str>` for `Prefix` ([`89f1b27`](https://github.com/yuki0iq/gitoxide/commit/89f1b27af9acf46744501f4d31cd1298aeff039b))
    ...
    - Don't use panicking const fn just yet to not require rust 1.57 ([`d2e2ea0`](https://github.com/yuki0iq/gitoxide/commit/d2e2ea0a9b9c5f756d8b02b4872e6950faa03b3e))
    ...
    - Better not have items within items in changelogs ([`6946125`](https://github.com/yuki0iq/gitoxide/commit/69461254b1bfda5e60911164096e4a061e241296))
    ...
    - Break delete me ([`c5213d2`](https://github.com/yuki0iq/gitoxide/commit/c5213d2b701ca71af5f3c987647e2a0c5c4d42dd))
    ...
    - Release git-hash v0.5.1 ([`d826370`](https://github.com/yuki0iq/gitoxide/commit/d826370b88d45fd2a421d3a59c232ed1504c6b0c))
    ...
    - Nicer debug printing for oids, too ([`b4f94f8`](https://github.com/yuki0iq/gitoxide/commit/b4f94f8af662bf6cdc001ca7b59478c701a40e36))
    - A new failing test ([`86b6c24`](https://github.com/yuki0iq/gitoxide/commit/86b6c2497cfa17bf3f822792e3afe406f7968ee7))
    - Fix git-hash docs ([`327a107`](https://github.com/yuki0iq/gitoxide/commit/327a107afd696f7496e04bd6285c217cd8cdc136))
    - (cargo-release) version 0.2.0 ([`4ec09f4`](https://github.com/yuki0iq/gitoxide/commit/4ec09f4d2239ea1d44f7145027e64191bf2c158c))
    - (cargo-release) version 0.1.2 ([`d1b4436`](https://github.com/yuki0iq/gitoxide/commit/d1b44369bcca34516c8bf86a540a4591d64ec9ba))
    - Update tasks and dependencies ([`96938be`](https://github.com/yuki0iq/gitoxide/commit/96938be512efd6d6ad26238f258865d7488098f4))
    ...
    - (cargo-release) version 0.1.1 ([`4224c5b`](https://github.com/yuki0iq/gitoxide/commit/4224c5b5ceeb6bd1dbe4aac46018be5cc82b77df))
    ...
    - First incarnation of git-hash to separate concerns and resolve cycle ([`9803041`](https://github.com/yuki0iq/gitoxide/commit/9803041c29c18f2976531c9b487e63cd90fa3e72))
</details>
