 ...
 * **Uncategorized**
    ...
    - Ignore `.gitignore` files that are directories ([`31ade4a`](https://github.com/yuki0iq/gitoxide/commit/31ade4a66141a4ce465ea7edfb9ec56636e77da4))
</details>
 ...
 * **Uncategorized**
    ...
    - Add recursion depth limit to avoid runaway runtimes or stackoverflows. ([`16cab84`](https://github.com/yuki0iq/gitoxide/commit/16cab8428ac40fb027e8d3770c571eabdbe46d13))
    - Merge branch 'gix-glob-recursion' ([`3c65ea3`](https://github.com/yuki0iq/gitoxide/commit/3c65ea3bffc38e57c4101f85bc348fe0ffe80d9d))
    - Adjust logic to properly deal with match groups to prevent endless loops. ([`ac57855`](https://github.com/yuki0iq/gitoxide/commit/ac578554a31670428117b4dd67ada51afd1914a5))
 ...
 * **Uncategorized**
    ...
    - Be sure to allow `ENDS_WITH` optimization if shellglobs are enabled ([`ddb593b`](https://github.com/yuki0iq/gitoxide/commit/ddb593b4c6acffe2fcbb458d0551998f91c97f8b))
    ...
    - Add `Pattern::from_bytes_without_negation()` ([`2b48686`](https://github.com/yuki0iq/gitoxide/commit/2b4868617a90eac818a150a2c3a027a71a8e420a))
    - `Pattern::matches_repo_relative_path(..., wildmatch::Flags)` allows controlling base flags. ([`63ef011`](https://github.com/yuki0iq/gitoxide/commit/63ef011b9a7ae5e8574acd5bdeff4f27c37fb5f8))
    - `search::Pattern::may_use_glob_pattern()` removed ([`d9126eb`](https://github.com/yuki0iq/gitoxide/commit/d9126ebb7686f667a02146c32006902ad4a82ff3))
</details>
 ...
 * **Uncategorized**
    ...
    - When reading pattern files, don't fail if the directory doesn't exist. ([`532c222`](https://github.com/yuki0iq/gitoxide/commit/532c222faf7d3df1fe5c46209595647c3197a656))
</details>
 ...
 * **Uncategorized**
    ...
    - Add `search::pattern::strip_base_recompute_basename_pos()`. ([`313599d`](https://github.com/yuki0iq/gitoxide/commit/313599df0a7527d8f9d4b86239c22dfd5f354cd4))
    ...
    - Add utilities for stack-based searching with pattern matching. ([`042154b`](https://github.com/yuki0iq/gitoxide/commit/042154b9076dc44e4378339e16875208c8125213))
    - Remove whitespace related processing from glob parsing and don't copy parsed input. ([`e3f8c4b`](https://github.com/yuki0iq/gitoxide/commit/e3f8c4bcda263728a5c2d5171b2b9941297ba629))
 ...
 * **Uncategorized**
    ...
    - Fix compile by using `BStr::as_bytes()` instead of `BStr::as_ref()`. ([`bf6cce7`](https://github.com/yuki0iq/gitoxide/commit/bf6cce76475329b7abc81c5032f2a8eee92202d0))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 5 unique issues were worked on: [#301](https://github.com/yuki0iq/gitoxide/issues/301), [#384](https://github.com/yuki0iq/gitoxide/issues/384), [#450](https://github.com/yuki0iq/gitoxide/issues/450), [#470](https://github.com/yuki0iq/gitoxide/issues/470), [#691](https://github.com/yuki0iq/gitoxide/issues/691)
 ...
 * **[#301](https://github.com/yuki0iq/gitoxide/issues/301)**
    ...
    - `fmt::Display` impl for `Pattern`. ([`455a72e`](https://github.com/yuki0iq/gitoxide/commit/455a72eb0c01c158f43d9b9a1180886f677bad00))
    - Adapt to changes in git-path ([`cc2d810`](https://github.com/yuki0iq/gitoxide/commit/cc2d81012d107da7a61bf4de5b28342dea5083b7))
    - Add `Default` impl for `pattern::Case` ([`2c88b57`](https://github.com/yuki0iq/gitoxide/commit/2c88b575630e1b179955dad578e779aad8dd58d8))
    - Cleanup ([`1ab4705`](https://github.com/yuki0iq/gitoxide/commit/1ab470589450ecda45826c38417616f227e3031b))
    ...
    - Adjust baseline to only handle patterns that work without a dir stack ([`fb65a39`](https://github.com/yuki0iq/gitoxide/commit/fb65a39e1826c331545b7141c0741904ed5bb1a4))
    - Discover an entirely new class of exclude matches… ([`f8dd5ce`](https://github.com/yuki0iq/gitoxide/commit/f8dd5ce8ce27cd24b9d81795dcf01ce03efe802d))
    ...
    - `Pattern::matches()` is now private ([`568f013`](https://github.com/yuki0iq/gitoxide/commit/568f013e762423fc54a8fb1daed1e7b59c1dc0f0))
    ...
    - A slightly ugly way of not adjusting input patterns too much ([`3912ee6`](https://github.com/yuki0iq/gitoxide/commit/3912ee66b6117681331df5e6e0f8345335728bde))
    ...
    - A failing test to show that the absolute pattern handling isn't quite there yet ([`74c89eb`](https://github.com/yuki0iq/gitoxide/commit/74c89ebbd235e8f5464e0665cc7bc7a930a8eb76))
    - Remove `base_path` field from `Pattern` ([`f76a426`](https://github.com/yuki0iq/gitoxide/commit/f76a426833530c7a7e787487cfceaba2c80b21ac))
    - Make fmt ([`5fc5459`](https://github.com/yuki0iq/gitoxide/commit/5fc5459b17b623726f99846c432a70106464e970))
    - Cleanup tests ([`16570ef`](https://github.com/yuki0iq/gitoxide/commit/16570ef96785c62eb813d4613df097aca3aa0d8f))
    - Case-insensitive tests for baseline path matching ([`bc928f9`](https://github.com/yuki0iq/gitoxide/commit/bc928f9c00b5f00527a122c8bf847278e90ffb04))
    - Invert meaning of `wildcard::Mode::SLASH_IS_LITERAL` ([`8fd9f24`](https://github.com/yuki0iq/gitoxide/commit/8fd9f24e2f751292a99b4f92cc47df67e17ab537))
    - Make glob tests work on windows for now… ([`29738ed`](https://github.com/yuki0iq/gitoxide/commit/29738edc56da6dbb9b853ac8f7482672eafd5050))
    - See if being less pedantic yields the correct results ([`18953e4`](https://github.com/yuki0iq/gitoxide/commit/18953e4c367ef1d3c2b28a0b027acc715af6372f))
    - `parse()` returns a `Pattern`. ([`6ce3611`](https://github.com/yuki0iq/gitoxide/commit/6ce3611891d4b60c86055bf749a1b4060ee2c3e1))
    - Docs for git-glob ([`8f4969f`](https://github.com/yuki0iq/gitoxide/commit/8f4969fe7c2e3f3bb38275d5e4ccb08d0bde02bb))
    - All wildmatch tests succeed ([`d3a7349`](https://github.com/yuki0iq/gitoxide/commit/d3a7349b707911670f17a92a0f82681544ebc769))
    - Add all character classes sans some of the more obscure ones ([`538d41d`](https://github.com/yuki0iq/gitoxide/commit/538d41d51d7cdc472b2a712823a5a69810f75015))
    - Frame for character classes ([`6b8d0d2`](https://github.com/yuki0iq/gitoxide/commit/6b8d0d20b449f6adffd403d0555596041a6c1903))
    - Fix all remaining bracket tests… ([`3afe2d2`](https://github.com/yuki0iq/gitoxide/commit/3afe2d2b862c9a22b90cbfbf75da6c84ca91ebf4))
    - More bracket-range tests succeed ([`c64f71c`](https://github.com/yuki0iq/gitoxide/commit/c64f71c38ff404e9c9f150e3e6d3e02ca11e9235))
    - Make bracket matching work better ([`97aa9ed`](https://github.com/yuki0iq/gitoxide/commit/97aa9ed22ccb927147a1e456ee6e3510ecc9f90a))
    - Refactor ([`fa0440f`](https://github.com/yuki0iq/gitoxide/commit/fa0440fb3c80f8052e08526cf260e929722ccf02))
    - First steps towards bracket matching ([`54fe029`](https://github.com/yuki0iq/gitoxide/commit/54fe0294e36e6ae9a025ef8661d5e21fd488dc87))
    - Adjust wildmatch corpus expectations as it won't match our preprocessor ([`48990af`](https://github.com/yuki0iq/gitoxide/commit/48990af81110a411ad07e199916005a8885db920))
    - Fix another issue around double-star ([`d15c2fb`](https://github.com/yuki0iq/gitoxide/commit/d15c2fb0119edc7635efc174a703101e100c0b4c))
    - Fix another special case ([`09095df`](https://github.com/yuki0iq/gitoxide/commit/09095dfb123f419a3df715d48e60e1f8ec62d060))
    - Fix double-star matches ([`43371b6`](https://github.com/yuki0iq/gitoxide/commit/43371b6fa0d6e62d9cde0399f1c9dd3e76b95d99))
    - Fix single-level double-star ([`e5a7995`](https://github.com/yuki0iq/gitoxide/commit/e5a79951dc32d336ae5b6c4230b3058ed80456d6))
    - Fix backslash handling; improve star handling ([`7907cb4`](https://github.com/yuki0iq/gitoxide/commit/7907cb4e12b56bdbea6abdc59f1022a508a83c87))
    - New wildcard tests to help fix star matching ([`d21c654`](https://github.com/yuki0iq/gitoxide/commit/d21c6541959b0fe34a3882ffcb9e657d6c685734))
    - All our simple wildmatches are working, a good start ([`321c4d2`](https://github.com/yuki0iq/gitoxide/commit/321c4d2011617f2b13e29109cafe4566e53bfde3))
    - Maybe even working double-star handling ([`48c57ff`](https://github.com/yuki0iq/gitoxide/commit/48c57ff3299928fd427bfae3e4eeadf5a9ca8109))
    - Slowly move towards star/double-star ([`4efd215`](https://github.com/yuki0iq/gitoxide/commit/4efd21560c754062f09870d253b6a2809cb0efb1))
    - Question mark support ([`e83c8df`](https://github.com/yuki0iq/gitoxide/commit/e83c8df03e801e00571f5934331e004af9774c7f))
    - Very basic beginnings of wildmatch ([`334c624`](https://github.com/yuki0iq/gitoxide/commit/334c62459dbb6763a46647a64129f89e27b5781b))
    - Fix logic in wildmatch tests; validate feasibility of all test cases ([`1336bc9`](https://github.com/yuki0iq/gitoxide/commit/1336bc938cc43e3a2f9e47af64f2c9933c9fc961))
    - Test corpus for wildcard matches ([`bd8f95f`](https://github.com/yuki0iq/gitoxide/commit/bd8f95f757e45b3cf8523d3e11503f4571461abf))
    - Frame for wildmatch function and its tests ([`04ca834`](https://github.com/yuki0iq/gitoxide/commit/04ca8349e326f7b7505a9ea49a401565259f21dc))
    - More tests for early exit in case no-wildcard prefix doesn't match ([`1ff348c`](https://github.com/yuki0iq/gitoxide/commit/1ff348c4f09839569dcd8bb93699e7004fa59d4a))
    - More non-basename shortcuts, and only wildcard matches left ([`45c6259`](https://github.com/yuki0iq/gitoxide/commit/45c62597b50c3c4bac34e20cd2040b08833584cc))
    - Make much clearer how base-path works and put in safe-guards ([`5bf503a`](https://github.com/yuki0iq/gitoxide/commit/5bf503af86ce0dd4d0a79c9b1a451cf89b494a6e))
    - Test that bases are ignored for basenames ([`1b26848`](https://github.com/yuki0iq/gitoxide/commit/1b2684892419f234e6006b0f3820341f162dc28b))
    - Refactor ([`056b368`](https://github.com/yuki0iq/gitoxide/commit/056b3683eb2d4d4c478ae2655e6ef067d4d0d1e7))
    - A way to set a globs base path ([`3d58db8`](https://github.com/yuki0iq/gitoxide/commit/3d58db8a9abfb91600216b8fc6f4109f5289d776))
    - Get to the point where globs probably should have a base ([`2632988`](https://github.com/yuki0iq/gitoxide/commit/263298876d1b10b12011c2a221b67126d6d8202d))
    - Refactor ([`f2f3f53`](https://github.com/yuki0iq/gitoxide/commit/f2f3f53574b4c0b5ba85780b134825f9128fa64f))
    - Prepare for handling absolute patterns ([`df9778b`](https://github.com/yuki0iq/gitoxide/commit/df9778b924610f6a82d93cdf12cfddda60e61789))
    ...
    - Basename parsing with simple pattern skips ([`d18ef14`](https://github.com/yuki0iq/gitoxide/commit/d18ef14e7cbf9c6d316086d6c88b5676c4b7516c))
    - Git-baseline now acts like a massive regression test ([`fe3d0a7`](https://github.com/yuki0iq/gitoxide/commit/fe3d0a778210a46d46a7db15cc8d213706e45fee))
    - Adjust signatures to know enough to implement git-like matching ([`b947ff9`](https://github.com/yuki0iq/gitoxide/commit/b947ff9d2c5ae8810547066096c91c745d1466fe))
    - Refactor; roughly sort regex by simplicity ([`a7c3a63`](https://github.com/yuki0iq/gitoxide/commit/a7c3a630cd5661f26220b494f01e50c9f2dbd2e2))
    ...
    - Refactor ([`f285ca0`](https://github.com/yuki0iq/gitoxide/commit/f285ca03094655590d7014770ffb6f6a77d02289))
    - Basic infrastructure for running git-baseline against our implementation ([`027869d`](https://github.com/yuki0iq/gitoxide/commit/027869d57bd7fcb7234e814d1a22197cb64c05cf))
    - Baseline tests for matches and no-matches ([`621c2ca`](https://github.com/yuki0iq/gitoxide/commit/621c2cac7eed822cc8226c7b9aa8becf3db6872c))
    - Bring in all ~140 tests for git pattern matching, git-ignore styile ([`f9ab830`](https://github.com/yuki0iq/gitoxide/commit/f9ab830df2920387c1cffec048be3a4089f4aa40))
    - Refactor ([`dbe7305`](https://github.com/yuki0iq/gitoxide/commit/dbe7305d371c7dad02d8888492b60b882b418a46))
    - Refactor ([`8a54341`](https://github.com/yuki0iq/gitoxide/commit/8a543410e10326ce506b8a7ba65e662641835849))
    - Prepare changelog prior to release ([`2794bb2`](https://github.com/yuki0iq/gitoxide/commit/2794bb2f6bd80cccba508fa9f251609499167646))
    - Add git-glob crate with pattern matching parsing from git-attributes::ignore ([`b3efc94`](https://github.com/yuki0iq/gitoxide/commit/b3efc94134a32018db1d6a2d7f8cc397c4371999))
 * **[#384](https://github.com/yuki0iq/gitoxide/issues/384)**
    ...
    - Make sure existing files aren't written into ([`9b5a8a2`](https://github.com/yuki0iq/gitoxide/commit/9b5a8a243d49b6567d1db31050d3bf3123dd54d3))
 ...
 * **[#450](https://github.com/yuki0iq/gitoxide/issues/450)**
    - Fix git-glob tests ([`0c17681`](https://github.com/yuki0iq/gitoxide/commit/0c17681602ef74cb5e9329d489df6fd7a07d546d))
    - Frame for baseline for fetch-matching ([`2569da5`](https://github.com/yuki0iq/gitoxide/commit/2569da5988a055372a1b85660f93185603900dbe))
 ...
 * **Uncategorized**
    ...
    - Rename `git-glob` to `gix-glob` ([`32cce5f`](https://github.com/yuki0iq/gitoxide/commit/32cce5f411f1d5d9ee3c98fb4f6b0e8f2a0295dc))
    ...
    - Remove unused and empty file ([`e7bc5f2`](https://github.com/yuki0iq/gitoxide/commit/e7bc5f279fc3bc931b904b5b902b8fc1d1d4f67e))
    ...
    - Thanks clippy ([`74f6420`](https://github.com/yuki0iq/gitoxide/commit/74f64202dfc6d9b34228595e260014708ec388e3))
    ...
    - Thanks clippy ([`b1a6100`](https://github.com/yuki0iq/gitoxide/commit/b1a610029e1b40600f90194ce986155238f58101))
    - Thanks clippy ([`1393403`](https://github.com/yuki0iq/gitoxide/commit/1393403b826cf4a2fbaf6ef58d505c5c62fd5e0a))
    - Thanks clippy ([`683233e`](https://github.com/yuki0iq/gitoxide/commit/683233e86dab36cc438bed0f8b0338eb767f57a0))
    - Release git-glob v0.1.0 ([`0f66c5d`](https://github.com/yuki0iq/gitoxide/commit/0f66c5d56bd3f0febff881065911638f22e71158))
</details>
