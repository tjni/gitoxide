 ...
 * **Uncategorized**
    ...
    - Merge pull request #2208 from cruessler/add-commit-signing ([`8699d0f`](https://github.com/yuki0iq/gitoxide/commit/8699d0f010458155f7f5e19c8018ea5e58079963))
    ...
    - Use constant instead of hardcoded value ([`e9cd429`](https://github.com/yuki0iq/gitoxide/commit/e9cd4293a719d524f640f845292d06408ec14297))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2098 from dscho/fix-parsing-of-legacy-git.git-commit ([`ef73c6b`](https://github.com/yuki0iq/gitoxide/commit/ef73c6b6631a3308b7bf5d15b69f4f14767a23d5))
    - Refactor ([`8ad43f1`](https://github.com/yuki0iq/gitoxide/commit/8ad43f13012c7c8b05887d9f3d32f011d0c46274))
    - Allow empty-valued commit headers in more places ([`a0660fe`](https://github.com/yuki0iq/gitoxide/commit/a0660fe3b4227b206dc6df099f55ec5bb41edce0))
    - Work around parse errors of a bogus git.git commit ([`a86f67b`](https://github.com/yuki0iq/gitoxide/commit/a86f67b46edec7cd2789ceaaee395a8ecca5c5b0))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2030 from ralphmodales/trailer-conviences ([`3820a0f`](https://github.com/yuki0iq/gitoxide/commit/3820a0ff32cc543a5f389a20e2bc1c6efd1cd009))
    - Refactor ([`6c6dfd0`](https://github.com/yuki0iq/gitoxide/commit/6c6dfd0204b65a03bbe464c312d7decce78e7c98))
    - Add convenience methods for common Git trailers ([`c9a312e`](https://github.com/yuki0iq/gitoxide/commit/c9a312edce09f968ece7ed51a4cf68fdcab43e8a))
...
<csr-read-only-do-not-edit/>
 ...
 - 1 unique issue was worked on: [#1917](https://github.com/yuki0iq/gitoxide/issues/1917)
 ...
 * **[#1917](https://github.com/yuki0iq/gitoxide/issues/1917)**
    - Refactor ([`103819d`](https://github.com/yuki0iq/gitoxide/commit/103819dbe2d86790a6ac4c6be3f21e5d4455dfd2))
 * **Uncategorized**
    ...
    - Store the raw time in Commit ([`c97d1d4`](https://github.com/yuki0iq/gitoxide/commit/c97d1d4e350db9d1499fb58db13afe8ffc9ebae6))
    ...
    - Merge pull request #1922 from pierrechevalier83/make_email_with_spaces_roundtrip ([`c13a403`](https://github.com/yuki0iq/gitoxide/commit/c13a403e8f306430220c209b1024d408c3c0a4f8))
    - Adapt to changes in gix-actor. ([`38e1055`](https://github.com/yuki0iq/gitoxide/commit/38e1055ae8b7d9ab630f70d5e1e50928ab7cda83))
    ...
    - Allow round-tripping for Trees ([`5bfc2f5`](https://github.com/yuki0iq/gitoxide/commit/5bfc2f540aac5be997159e93783d56ed147b0a2f))
    - Hide the internal representation of EntryMode ([`a168807`](https://github.com/yuki0iq/gitoxide/commit/a168807b2d354bdcd51f1c4758d2407dab98362f))
 ...
 * **Uncategorized**
    ...
    - Drop migration shims for fallible hashing ([`a68f115`](https://github.com/yuki0iq/gitoxide/commit/a68f1156b4a24e49ceb165bdaa9f4fa8e4c70cd9))
    ...
    - Make `gix_object::compute_hash` fallible ([`b5ac93a`](https://github.com/yuki0iq/gitoxide/commit/b5ac93a9a02c97bd611d455091c60bfbd5f49efa))
    ...
    - Add fallible `gix_object::try_compute_hash` for migration ([`f2b07c0`](https://github.com/yuki0iq/gitoxide/commit/f2b07c0783ac98a08f648836e743cb0e6b4fdc7c))
    ...
    - Use `gix_object::compute_hash` in a test and benchmark ([`7805ffe`](https://github.com/yuki0iq/gitoxide/commit/7805ffe7ac0af6a413b491efeacdd7e4616df86b))
    - Factor out private `gix_object::object_hasher` helper ([`cf261d5`](https://github.com/yuki0iq/gitoxide/commit/cf261d5b0ef647d389fce7c901d076cd9f9dd8e2))
    - Merge pull request #1908 from EliahKagan/run-ci/scripts ([`c8c42b4`](https://github.com/yuki0iq/gitoxide/commit/c8c42b4b86e8bf7d8f0f7130d2da98dfed246be9))
    - Fix a few ShellCheck warnings and stylistic inconsistencies ([`e5e2c6f`](https://github.com/yuki0iq/gitoxide/commit/e5e2c6fbf9337219edb79ce97b56b3be91bc14e5))
    ...
    - Merge pull request #1903 from pierrechevalier83/tag_end_of_line ([`6caee49`](https://github.com/yuki0iq/gitoxide/commit/6caee4922c96c864a28eb9b1b52a013d2c11cd4e))
    - Support empty tags with or without trailing NL ([`f69890c`](https://github.com/yuki0iq/gitoxide/commit/f69890cafd08db95231a02d08fbbcb02689e99c4))
    ...
    - Add `commit::ExtraHeaders::find_pos()`, and expose "gpgsig" header name. ([`bf85128`](https://github.com/yuki0iq/gitoxide/commit/bf851283f9d451a2a5c55a44c0474126baa2b8fb))
    ...
    - Add `CommitRef|TagRef|BlobRef::into_owned()` as shortcut. ([`527fd3d`](https://github.com/yuki0iq/gitoxide/commit/527fd3d19a307fe878fd8e3ca54ed10140ac6fa7))
    ...
    - Switch to ModalParser ([`0e71412`](https://github.com/yuki0iq/gitoxide/commit/0e71412e9b92166a5adcd2d9685d7c3ddbbd7014))
 ...
 * **Uncategorized**
    ...
    - Add conversion from `tree::Entry` to `EntryRef` with `From` ([`9f26645`](https://github.com/yuki0iq/gitoxide/commit/9f2664533b0e44fdebe72102e6f2ab3410e1265d))
    ...
    - Add `TreeRefIter::offset_to_next_entry()`. ([`8141765`](https://github.com/yuki0iq/gitoxide/commit/8141765fcfaebe7eab28cb41be5cae7bb948d46a))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1686 from cruessler/move-lookup-entry-to-gix-object ([`39227a9`](https://github.com/yuki0iq/gitoxide/commit/39227a90ca4590b08dc7d782728be2e9a3054618))
    - Refactors ([`d7f4991`](https://github.com/yuki0iq/gitoxide/commit/d7f49916037efb0c95cf1a4d58be215bee67eb0d))
    - Add test for entry that does not exist ([`54e399f`](https://github.com/yuki0iq/gitoxide/commit/54e399f38002689eb2694c2d59799fc4c2f019ff))
    - Match on complete entry ([`08a86dc`](https://github.com/yuki0iq/gitoxide/commit/08a86dc39edb5b57247faf069bbc332126f41f66))
    - Deduplicate tests ([`2de935d`](https://github.com/yuki0iq/gitoxide/commit/2de935dc1fbd22eb9f98eb145a3160c3b5d48b7f))
    - Replace FindExt by Find ([`579a6f2`](https://github.com/yuki0iq/gitoxide/commit/579a6f217290fb5b6b6d10b4c0414ea87012235e))
    - Move lookup_entry, lookup_entry_by_path to TreeRefIter ([`32632e9`](https://github.com/yuki0iq/gitoxide/commit/32632e94530b6fd6e10cd05d61d3bbbda5ccaa00))
    - Remove superfluous trait bound ([`1c6e4ae`](https://github.com/yuki0iq/gitoxide/commit/1c6e4ae103abc56352ff0e596b2236eab1809e60))
    - Don't recurse, use loop instead ([`7e66a4a`](https://github.com/yuki0iq/gitoxide/commit/7e66a4ab83d9532dba39e0d76e7d6dc98918d885))
    - Sketch recursive lookup ([`0cf6d3a`](https://github.com/yuki0iq/gitoxide/commit/0cf6d3a307caa411f34337a0384a104489d1490a))
    - Add lookup_entry, lookup_entry_by_path to TreeRef ([`d121fe7`](https://github.com/yuki0iq/gitoxide/commit/d121fe7ac850964aeafa8b27070b4514c5648016))
 ...
 * **Uncategorized**
    ...
    - Octal Debug representation of `tree::EntryMode`. ([`cd61c25`](https://github.com/yuki0iq/gitoxide/commit/cd61c25369d3e39b6160bac4b332b177dabddf4b))
    ...
    - Move `gix-odb::Write` trait to `gix-object::Write`. ([`7325c58`](https://github.com/yuki0iq/gitoxide/commit/7325c584c3f0973975935b307630e29bc36ef5c7))
    - `FindExt` now supports empty trees and empty blobs natively. ([`29aad45`](https://github.com/yuki0iq/gitoxide/commit/29aad45ec93b19aca6aca06bc525277e0fc0d728))
    - Add `tree::Editor::get()` to get entries directly from the editor. ([`e2ea398`](https://github.com/yuki0iq/gitoxide/commit/e2ea398d1fb789cb180a1cf9d81f2d9fbb010927))
...
<csr-read-only-do-not-edit/>
 ...
 - 1 unique issue was worked on: [#1542](https://github.com/yuki0iq/gitoxide/issues/1542)
 ...
 * **[#1542](https://github.com/yuki0iq/gitoxide/issues/1542)**
    - Be lenient to missing timestamp in signature ([`059c9f9`](https://github.com/yuki0iq/gitoxide/commit/059c9f9ece4edf631e3ca5f8298ce2660cba946b))
    - Add test for tag missing timestamp in tagger ([`ce5d79c`](https://github.com/yuki0iq/gitoxide/commit/ce5d79c181babfdb8aa4a0c4cc1db29bfb1dc21a))
 * **Uncategorized**
    ...
    - Merge pull request #1617 from Byron/commit-roundtrip ([`f35b109`](https://github.com/yuki0iq/gitoxide/commit/f35b1096c6db73842a55e089187d27d1287075ad))
    - Modernize integration tests ([`7fcf91a`](https://github.com/yuki0iq/gitoxide/commit/7fcf91aeeb05dc628979d3d0422922fd77592729))
    - Keep multi-line header value newlines verbatim ([`4a6bbb1`](https://github.com/yuki0iq/gitoxide/commit/4a6bbb1b79991f400be814c68fb45e8e5980a00c))
    - Reproduce roundtrip failure for commit that looks good otherwise ([`9db3f9c`](https://github.com/yuki0iq/gitoxide/commit/9db3f9c93edf9316c71a47a103cdf4047e9284b0))
    ...
    - `TreeRef::to_owned()` and `Tree::into_owned()` for a convenient way to get a fully-owned `Tree` ([`7c48556`](https://github.com/yuki0iq/gitoxide/commit/7c485561582c583ce0d929680e7f9abf5ceeea60))
    - Use a standard HashMap instead of one based on SHA1 ([`39d8e03`](https://github.com/yuki0iq/gitoxide/commit/39d8e03047df09db0102246071015505652bec8b))
    - Add benchmarks for the tree editor and the tree-editor cursor ([`b5dc45f`](https://github.com/yuki0iq/gitoxide/commit/b5dc45f2854012981cb6071f511e5d987020a003))
    - `Tree|TreeRef::write_to()` will now assure the most basic sanity of entry names. ([`a085b7e`](https://github.com/yuki0iq/gitoxide/commit/a085b7e435317f566f6763f4155243ba3309cd82))
    - Add `tree::Editor::cursor()` to allow speedier creation of sub-trees. ([`91fa478`](https://github.com/yuki0iq/gitoxide/commit/91fa4786df7fe25f2da3d78ef0fc14d53b69b846))
    - Add `tree::Editor` ([`14dfcf0`](https://github.com/yuki0iq/gitoxide/commit/14dfcf01dc4a6e48fbd363f4f1c8cf08c1e7f6e2))
    - Add `Default` implementation to `Tree` ([`71bf808`](https://github.com/yuki0iq/gitoxide/commit/71bf80883e010f242460e9e36d5ea27a14e6494b))
    ...
    - Merge branch 'issue-1542' ([`c3f173c`](https://github.com/yuki0iq/gitoxide/commit/c3f173c94968907ecc685c5383f2fe24c02dcfbf))
    - Make binary-search based test more robust ([`1b600f3`](https://github.com/yuki0iq/gitoxide/commit/1b600f31db5b5061764e7a845ac24def57faf144))
    - Adjust expectation now that author parsing is more lenient. ([`bfd5009`](https://github.com/yuki0iq/gitoxide/commit/bfd50091d7ec5784f0af8581d1c14c463e9e9417))
    - Merge pull request #1540 from NobodyXu/patch-1 ([`f4898b9`](https://github.com/yuki0iq/gitoxide/commit/f4898b986741934d0f5366ef9cf175446f621cec))
    - Fix winnow version requirement in gix-object ([`0a3ce48`](https://github.com/yuki0iq/gitoxide/commit/0a3ce48a1749247c0aa78988e2876acc5f230dad))
...
<csr-read-only-do-not-edit/>
 ...
 - 0 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#1438](https://github.com/yuki0iq/gitoxide/issues/1438)
 ...
 * **[#1438](https://github.com/yuki0iq/gitoxide/issues/1438)**
    - Reproduce failure when parsing malformed commit ([`6c5861d`](https://github.com/yuki0iq/gitoxide/commit/6c5861dff0986ca68c474be65738eda47ca28927))
 * **Uncategorized**
    ...
    - Adapt to changes in `gix-actor` ([`8dca2d4`](https://github.com/yuki0iq/gitoxide/commit/8dca2d4de9f40839148fe545cf2f52d2fb9fa496))
...
<csr-read-only-do-not-edit/>
 ...
 - 1 commit was understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#1322](https://github.com/yuki0iq/gitoxide/issues/1322)
 ...
 * **[#1322](https://github.com/yuki0iq/gitoxide/issues/1322)**
    - Allow parsing of commits with broken timestamp. ([`ab21083`](https://github.com/yuki0iq/gitoxide/commit/ab210836ac4558c88cc5f19fdddfb5c8eeb29754))
 * **Uncategorized**
...
<csr-read-only-do-not-edit/>
 ...
 - 1 unique issue was worked on: [#1259](https://github.com/yuki0iq/gitoxide/issues/1259)
 ...
 * **[#1259](https://github.com/yuki0iq/gitoxide/issues/1259)**
    - Allow the creation of any `EntryMode`. ([`82e85fd`](https://github.com/yuki0iq/gitoxide/commit/82e85fd192f59bc62bb27de13360a543971e8167))
    - `EntryMode` canonicalization ([`67833df`](https://github.com/yuki0iq/gitoxide/commit/67833dfd18c49ed8073e7a3c0461579c0a5c2017))
 * **Uncategorized**
    ...
    - Move off deprecated take_until[01] ([`52ede06`](https://github.com/yuki0iq/gitoxide/commit/52ede0634067de81d7db66728257d8242c14654e))
    ...
    - Merge branch 'entry-mode-fixes' ([`35d2083`](https://github.com/yuki0iq/gitoxide/commit/35d2083e242314d623c3e79f68fa8ac03bf4355a))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 2 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#1185](https://github.com/yuki0iq/gitoxide/issues/1185)
 ...
 * **[#1185](https://github.com/yuki0iq/gitoxide/issues/1185)**
    - Fix tree-parse issue found by fuzzer ([`7d81a76`](https://github.com/yuki0iq/gitoxide/commit/7d81a769f895b21716e92fb63298b9d547a5cca4))
 * **Uncategorized**
    ...
    - Merge pull request #1199 from silvergasp/fuzz-git-object ([`7d21ce9`](https://github.com/yuki0iq/gitoxide/commit/7d21ce9fa0e10549b5340a92da32f70f9a3f7d62))
    - Add corpus builders for tree/tags ([`5a02529`](https://github.com/yuki0iq/gitoxide/commit/5a0252964d36aaa8a4a8cdbe7d17f59f3480d1b4))
    - Merge pull request #1192 from silvergasp/fuzz-git-object ([`e2f42dd`](https://github.com/yuki0iq/gitoxide/commit/e2f42dd93a2c749f1dbf7f9b7f35b37c9ea62cd4))
    - Add fuzz_commit seed corpus builder ([`2297ca1`](https://github.com/yuki0iq/gitoxide/commit/2297ca16bad699083d69f6a99d4fb6a51956df6b))
    ...
    - Merge branch 'fuzz_object' ([`7df919b`](https://github.com/yuki0iq/gitoxide/commit/7df919b356adfc1653bcd41137fa44a7054647be))
    - Add gix-object fuzzers ([`de400fd`](https://github.com/yuki0iq/gitoxide/commit/de400fd0c4959ed60009a2fd71a88d7bcf6d5191))
...
<csr-read-only-do-not-edit/>
 ...
 - 24 commits contributed to the release.
 - 8 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#1096](https://github.com/yuki0iq/gitoxide/issues/1096)
 ...
 * **[#1096](https://github.com/yuki0iq/gitoxide/issues/1096)**
    - Adjust tree parser to deal with even more unusual trees. ([`8d05cae`](https://github.com/yuki0iq/gitoxide/commit/8d05cae3027e3731602292c9e2d8c3cd53ebeec9))
    - Assure all kinds of trees can be parsed. ([`3542cf5`](https://github.com/yuki0iq/gitoxide/commit/3542cf5f65dad92552e12cce84e47381aa58e228))
 * **Uncategorized**
    ...
    - Support for querying only the header of an object with the `FindHeader` trait. ([`1838cbd`](https://github.com/yuki0iq/gitoxide/commit/1838cbd36f4c19e07080529ec05ecf6c81218686))
    ...
    - Keep verbatim tree-entry mode, but support discretization using the new `EntryKind`. ([`3ac5d0b`](https://github.com/yuki0iq/gitoxide/commit/3ac5d0b7feed9554ddbf249748cb1591a7977d9b))
    - Report remaining input on error ([`55729a5`](https://github.com/yuki0iq/gitoxide/commit/55729a5afe582100dc2ee0fa55f8b5ce313614df))
    - Refactor Errors to track remaining Input ([`5825250`](https://github.com/yuki0iq/gitoxide/commit/58252501f876bb7123b4f9bf2a75efc3011d7d37))
    - Refactor iterating parsing so error wrapping knows where left off ([`53309be`](https://github.com/yuki0iq/gitoxide/commit/53309be2b57f880316775df9e7f7eef3ebfa6534))
    - Refactor gix-object parsers to look more winnow-ish ([`f633f9e`](https://github.com/yuki0iq/gitoxide/commit/f633f9e443ec482fecb47ec7d3eccedba4fd053f))
    - Merge branch 'fix-1096' ([`48ef17e`](https://github.com/yuki0iq/gitoxide/commit/48ef17e4d169f2b08d119c2dba51fcfd9c06fe61))
    - Restore verbose error reporting capabilities when parsing of objects fails. ([`5d78ab3`](https://github.com/yuki0iq/gitoxide/commit/5d78ab3d9e1f447f57a551561b0e773ea68b4d9a))
    - Merge branch 'gix-object-find' ([`c8bd660`](https://github.com/yuki0iq/gitoxide/commit/c8bd66065316176dfbbfe7ecaa092a25cad1854b))
    - Add `Copy` to `Data`, `BlobRef` and `TreeRefIter` ([`d25fbae`](https://github.com/yuki0iq/gitoxide/commit/d25fbae8c81a3b40614d05041aafd7fbf06f849b))
    - Add `Find` and `Exists` trait and extension `FindExt` to easily find objects. ([`f984c4c`](https://github.com/yuki0iq/gitoxide/commit/f984c4c58ca3a47469c1af66f9991c989f0d3e49))
 ...
 * **Uncategorized**
    ...
    - Add `compute_stream_hash` method as lower-level way of hashing objects. ([`5bb55de`](https://github.com/yuki0iq/gitoxide/commit/5bb55decbab55f0480165a756893b0af111e485c))
    ...
    - `encode::loose_header()` now supports large objects even on 32 bit systems. ([`9283a9d`](https://github.com/yuki0iq/gitoxide/commit/9283a9d2ec460c1380cf6c40d876f477cb552826))
</details>
 ...
 * **Uncategorized**
    ...
    - Refactor and fixes ([`02587fc`](https://github.com/yuki0iq/gitoxide/commit/02587fc879c54b2b3e62ffbe1ab4c29591ea0d80))
    ...
    - Remove From<winnow> for (small) step towards stable API ([`be1f4b5`](https://github.com/yuki0iq/gitoxide/commit/be1f4b5d2158fc73d926394d22d62bb597c5e6ce))
    - Make clippy happy ([`62f7bc6`](https://github.com/yuki0iq/gitoxide/commit/62f7bc65c1eef812baa2ef2e5b406762e117b66a))
    - Switch off deprecated VerboseError ([`93fc441`](https://github.com/yuki0iq/gitoxide/commit/93fc441c6c82086e125ace5bdda3b9403d271618))
    - Switch errors to StrContext ([`df226dd`](https://github.com/yuki0iq/gitoxide/commit/df226dd31df2c591c6470ed70098202112e13dae))
    - Minor cleanup possible with 0.5 ([`a07590c`](https://github.com/yuki0iq/gitoxide/commit/a07590cb46423cb0422c18b9fc04b153c0fd53b1))
    ...
    - Remove unused dependency: 'hex' ([`7649b18`](https://github.com/yuki0iq/gitoxide/commit/7649b185c93877e8c8b3cebedf685be8e94a0d9d))
    - Merge branch 'extract-signatures' ([`b37affe`](https://github.com/yuki0iq/gitoxide/commit/b37affefecfb30a94431cd21dae6659004ca6244))
    - Refactor ([`fb95ead`](https://github.com/yuki0iq/gitoxide/commit/fb95eadb2da12c794d41b1f6212eba60ff3dd2dc))
    - Add commit signature extraction ([`2f9c0dd`](https://github.com/yuki0iq/gitoxide/commit/2f9c0ddb7c2191789b4c0a5e8f2bf9253ac58606))
</details>
 ...
 * **Uncategorized**
    ...
    - Merge branch 'decathorpe/main' ([`422747d`](https://github.com/yuki0iq/gitoxide/commit/422747d35724a56dade73c8d68b8ebcbaa4b9b25))
    ...
    - Fix test for struct size for 32-bit architectures ([`7f7353e`](https://github.com/yuki0iq/gitoxide/commit/7f7353e4525adc308e97b82d27bd301e48da6016))
    - Add another very special commit for parsing tests ([`f852243`](https://github.com/yuki0iq/gitoxide/commit/f852243831474a3fd311a0507d11fd43e0f6e4d3))
</details>
 ...
 * **Uncategorized**
    ...
    - Merge branch 'improvements-for-crates-index' ([`7734736`](https://github.com/yuki0iq/gitoxide/commit/7734736ce7e590b2ad60f3c1d8289854931d155c))
    - `TreeRef::bisect_entry()` to correctly find an entry by name ([`424d347`](https://github.com/yuki0iq/gitoxide/commit/424d347bb2466ecdf8cfc9e0da779d604d1f9e4e))
    ...
    - `Copy` for `tree::EntryRef` ([`437fedc`](https://github.com/yuki0iq/gitoxide/commit/437fedc59c2bad57beb3cf54e4c71a470bd22ee2))
 ...
 * **Uncategorized**
    ...
    - Add classifier methods to `Kind` for easier object classification. ([`695de56`](https://github.com/yuki0iq/gitoxide/commit/695de5679904776798b4d8b9dbee771306ff39ba))
</details>
 ...
 * **Uncategorized**
    ...
    - Merge branch 'fix-848' ([`e3b146f`](https://github.com/yuki0iq/gitoxide/commit/e3b146ffdd6a1150e6deb6ddd267b81fd3c217b2))
    - Sorting of tree entries is now according to specificiation. ([`ca37915`](https://github.com/yuki0iq/gitoxide/commit/ca37915fbb0c43c7f01ae600d1da63d2f21eeb63))
    - Refactor ([`d92a588`](https://github.com/yuki0iq/gitoxide/commit/d92a588249f3f507f0b3fc05543f819c51e49c5a))
</details>
 ...
 * **Uncategorized**
    ...
    - Add `encode::compute_hash()` for an easy way to obtain object hashes. ([`ebf3fd4`](https://github.com/yuki0iq/gitoxide/commit/ebf3fd49ff2a53c99f818f4e87fbfed57db696bb))
</details>
 ...
 * **Uncategorized**
    ...
    - Prepare changelog prior to release ([`7f06458`](https://github.com/yuki0iq/gitoxide/commit/7f064583bd0e1b078df89a7750f5a25deb70f516))
 ...
 * **Uncategorized**
    ...
    - Document why EntryRef has a different comparison method. ([`c9ba1f7`](https://github.com/yuki0iq/gitoxide/commit/c9ba1f7e5bd4a24cd1e32b126955b03957f01845))
</details>
 ...
 * **Uncategorized**
    ...
    - Add `tree::EntryMode::is_blob_or_link()`. ([`c882ff0`](https://github.com/yuki0iq/gitoxide/commit/c882ff0b2cbf3484520432593968716493ffdaa1))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 20 unique issues were worked on: [#198](https://github.com/yuki0iq/gitoxide/issues/198), [#222](https://github.com/yuki0iq/gitoxide/issues/222), [#250](https://github.com/yuki0iq/gitoxide/issues/250), [#254](https://github.com/yuki0iq/gitoxide/issues/254), [#259](https://github.com/yuki0iq/gitoxide/issues/259), [#266](https://github.com/yuki0iq/gitoxide/issues/266), [#279](https://github.com/yuki0iq/gitoxide/issues/279), [#293](https://github.com/yuki0iq/gitoxide/issues/293), [#301](https://github.com/yuki0iq/gitoxide/issues/301), [#329](https://github.com/yuki0iq/gitoxide/issues/329), [#364](https://github.com/yuki0iq/gitoxide/issues/364), [#389](https://github.com/yuki0iq/gitoxide/issues/389), [#427](https://github.com/yuki0iq/gitoxide/issues/427), [#450](https://github.com/yuki0iq/gitoxide/issues/450), [#470](https://github.com/yuki0iq/gitoxide/issues/470), [#63](https://github.com/yuki0iq/gitoxide/issues/63), [#67](https://github.com/yuki0iq/gitoxide/issues/67), [#691](https://github.com/yuki0iq/gitoxide/issues/691), [#79](https://github.com/yuki0iq/gitoxide/issues/79), [#XXX](https://github.com/yuki0iq/gitoxide/issues/XXX)
 ...
 * **[#198](https://github.com/yuki0iq/gitoxide/issues/198)**
    ...
    - Feat: `BodyRef::without_trailer()` for more obvious access than `*body` or `body.as_ref()` ([`f0ea526`](https://github.com/yuki0iq/gitoxide/commit/f0ea526775793c9104e4ae27dd5d92b5a1202c5f))
    - Refactor ([`ef3fc6d`](https://github.com/yuki0iq/gitoxide/commit/ef3fc6d92c1d751d0032e072834f41d37cbb9200))
    - Feat: `CommitRef::message_trailers()` as shortcut… ([`5324391`](https://github.com/yuki0iq/gitoxide/commit/5324391f581c5ad2c09604f0beeac7df852bfb33))
    - More tests for trailers iterator ([`c3b0161`](https://github.com/yuki0iq/gitoxide/commit/c3b0161eb76aaf806a7d82232ec7ac1a304052a3))
    - Feat: `BodyRef::trailers()` allows iterating trailer tokens and values ([`175e1cb`](https://github.com/yuki0iq/gitoxide/commit/175e1cbdfebfc6f01784fffdaf0859cd6c23377e))
    - Some tests and sketch for BodyRef parsing ([`3953c24`](https://github.com/yuki0iq/gitoxide/commit/3953c245461941c636ce5d755e6a469f7fa3eabe))
    - Feat: CommitRef::summary() and `MessageRef::body()` methods ([`1714d05`](https://github.com/yuki0iq/gitoxide/commit/1714d05df812aa373da485492b342e58e9e7c17d))
    - Refactor ([`7055dc8`](https://github.com/yuki0iq/gitoxide/commit/7055dc81e9db448da89ab2ee0ba2ffe07cd00cc2))
    - Another test for footer separation, simple version ([`b439186`](https://github.com/yuki0iq/gitoxide/commit/b4391862b67a09330476a82d520bfc3a698a4fbe))
    - Return to safety ([`35313b9`](https://github.com/yuki0iq/gitoxide/commit/35313b9f7c92edd1afdbe22d1f592baabc0abc9c))
    - Omg nom parsing works… ([`cd11704`](https://github.com/yuki0iq/gitoxide/commit/cd11704dd0d469cd23d7ee6905d6219b26ba4563))
    - FAIL: not really successful to continue down the 'fold' road ([`d9afc22`](https://github.com/yuki0iq/gitoxide/commit/d9afc22f161fb60195571be09d2d816d67050575))
    - Three tests failing with nom ([`13646e8`](https://github.com/yuki0iq/gitoxide/commit/13646e8dfe97d8503d0cef935c4c303f82271aa4))
    - Revert " FAIL: try to use nom-way of the previous body parsing…" ([`d1e6f62`](https://github.com/yuki0iq/gitoxide/commit/d1e6f621c2898ad9f03b2ee712019e6a10b44035))
    - FAIL: try to use nom-way of the previous body parsing… ([`909f668`](https://github.com/yuki0iq/gitoxide/commit/909f6682ac1de6be0eb8b66015b3f250daca17cd))
    - Sketch nom version of the message parser… ([`1ec47de`](https://github.com/yuki0iq/gitoxide/commit/1ec47ded5793cac1f2633262d59bfbae4a0e14be))
    - Fix build ([`d0a956f`](https://github.com/yuki0iq/gitoxide/commit/d0a956fdb5a822dbd116792bfbe70d1532a95ec9))
    - Refactor!: Use git_object::commit::MessageRef::summary()… ([`13e7c3a`](https://github.com/yuki0iq/gitoxide/commit/13e7c3ad5e079fe778d07d115c9e41c4c6eb038f))
    - Feat(commit): A summary for commit messages suitable for logs ([`cd3fc99`](https://github.com/yuki0iq/gitoxide/commit/cd3fc99968baa827302aa9c4f5d181bc9c4f9084))
    - More message parsing tests with windows line separators ([`001e8c2`](https://github.com/yuki0iq/gitoxide/commit/001e8c2a4ede5fc025572a4c39a771cc854f8b18))
    - A manual message parse impl and more tests ([`f4b8a0d`](https://github.com/yuki0iq/gitoxide/commit/f4b8a0da787f9a16eebd2a36b342f5a2a66edabd))
    - More message parsing tests, now with legit failure… ([`625be8d`](https://github.com/yuki0iq/gitoxide/commit/625be8dbd4204ea1a7131ade9b17f63dcc7e30d7))
    - Feat(commit): Add `message()` method and `MessageRef` type… ([`6150b2d`](https://github.com/yuki0iq/gitoxide/commit/6150b2db18034d5912029deac51d1affb38ae7b2))
 ...
 * **[#266](https://github.com/yuki0iq/gitoxide/issues/266)**
    - Upgrade dependencies ([`322b290`](https://github.com/yuki0iq/gitoxide/commit/322b2901382192d3b4ac0fbae32381a9abb49fa9))
    ...
    - Add `Data` object ([`a0bb652`](https://github.com/yuki0iq/gitoxide/commit/a0bb6529216160d14e67b97206a51140099fd245))
 * **[#279](https://github.com/yuki0iq/gitoxide/issues/279)**
    - Adapt to changes in git-hash ([`5eb0230`](https://github.com/yuki0iq/gitoxide/commit/5eb0230b58c25c0aa744eee0bd878dd91410dbe1))
 * **[#293](https://github.com/yuki0iq/gitoxide/issues/293)**
    - Fix tree-entry-ordering implementation ([`ea169a6`](https://github.com/yuki0iq/gitoxide/commit/ea169a6dbbba30d9464570cb86e5c990fcaf9ae8))
 ...
 * **[#329](https://github.com/yuki0iq/gitoxide/issues/329)**
    - In-manifest and in-lib feature documentation ([`5c573bf`](https://github.com/yuki0iq/gitoxide/commit/5c573bf9abfc10227d5a900100e84d7f8f6c0504))
 ...
 * **[#364](https://github.com/yuki0iq/gitoxide/issues/364)**
    - Support for trimming of whitespace around name and email ([`a39bf71`](https://github.com/yuki0iq/gitoxide/commit/a39bf71531ee0a6c8db082758d3212c805ce2bf0))
    - `CommitRef::time()` ([`8f1b42b`](https://github.com/yuki0iq/gitoxide/commit/8f1b42b193098f6e116b3522a3df08d5d1b42a0a))
    ...
    - `CommitRefIter::(author|committer)()`, better usability ([`c51a925`](https://github.com/yuki0iq/gitoxide/commit/c51a9252f8a038bf995d50cdbfc8356362020bbc))
    - `CommitRefIter::parent_ids()` ([`91065cd`](https://github.com/yuki0iq/gitoxide/commit/91065cd790f559f4a661ecd9c2d2f649922682e3))
 * **[#389](https://github.com/yuki0iq/gitoxide/issues/389)**
    - `TagRefIter::tagger()`. ([`0d22ab4`](https://github.com/yuki0iq/gitoxide/commit/0d22ab459ce14bc57549270142595d8ebd98ea41))
 * **[#427](https://github.com/yuki0iq/gitoxide/issues/427)**
    - `tree::EntryMode::as_str()` to display itself as a string. ([`4f4bba2`](https://github.com/yuki0iq/gitoxide/commit/4f4bba23a13f11050e35887da004e48148d68aea))
    - Improve error messages related to object decoding ([`761695c`](https://github.com/yuki0iq/gitoxide/commit/761695cd10222eccb720812fa41d5295d506fce9))
 * **[#450](https://github.com/yuki0iq/gitoxide/issues/450)**
    ...
    - Remove quick-error in favor of thiserror ([`9c8a36f`](https://github.com/yuki0iq/gitoxide/commit/9c8a36f35b1e8dad66befb102e5a8670b4a6c2b2))
 ...
 * **[#63](https://github.com/yuki0iq/gitoxide/issues/63)**
    - Use new `oid` where possible in git-odb ([`68a709e`](https://github.com/yuki0iq/gitoxide/commit/68a709e0337d4969138d30a5c25d60b7dbe51a73))
    ...
    - Move git-hash::owned::Id into git-hash::Id ([`fdbe704`](https://github.com/yuki0iq/gitoxide/commit/fdbe704b6c9ace2b8f629f681a0580b24749a238))
    - Rename `git_hash::*::Digest` to `Id` ([`188d90a`](https://github.com/yuki0iq/gitoxide/commit/188d90ad463d342d715af701b03f0ed392c977fc))
 * **[#67](https://github.com/yuki0iq/gitoxide/issues/67)**
    - Describe variants ([`899c579`](https://github.com/yuki0iq/gitoxide/commit/899c57927ce4ba2e1b5d8182f9e731c2a9094cba))
    - Parse entry mode into number instead of comparing it to byte strings ([`83d591d`](https://github.com/yuki0iq/gitoxide/commit/83d591d536d1a43e8523082824ec0b95cca55d34))
    ...
    - Tree parsing now probably is twice as fast… ([`d1e2b89`](https://github.com/yuki0iq/gitoxide/commit/d1e2b8910b454dd798be8a9a43871f0b0644d503))
 ...
 * **[#79](https://github.com/yuki0iq/gitoxide/issues/79)**
    - Refactor; add test for empty tree iteration ([`6340296`](https://github.com/yuki0iq/gitoxide/commit/634029682da374f912068f5c8d5ec79d4837f7ea))
 ...
 * **Uncategorized**
    ...
    - Fix git-object tests ([`fb92865`](https://github.com/yuki0iq/gitoxide/commit/fb92865fec8c76b710c432b9e2e08ff8e9538fcd))
    ...
    - Rename `git-object` to `gix-object` ([`2320358`](https://github.com/yuki0iq/gitoxide/commit/23203589e8c1df2e0eae9d9c2e75b0d0b24fd9b5))
    ...
    - Prepare changelogs prior to release ([`d679f5b`](https://github.com/yuki0iq/gitoxide/commit/d679f5b6f018633e858d3ebbdaf1cd5098bbc5e7))
    ...
    - Merge branch 'pierrechevalier83/main' ([`a5b1d73`](https://github.com/yuki0iq/gitoxide/commit/a5b1d738d23d0a343bee1b72bcb72250b5fdae11))
    - Thanks clippy ([`0a6d888`](https://github.com/yuki0iq/gitoxide/commit/0a6d8882265eda833f4bf0252dc2c656aa05ca6f))
    - Restore original representation of `Tag` at the cost of some duplication ([`dd0a23d`](https://github.com/yuki0iq/gitoxide/commit/dd0a23d710be0eb6c7ea7f883aeb1400bcbc0709))
    - Unify pre-allocation of `parents` in `Commit` to match typical single-ancestor chains ([`7242d1f`](https://github.com/yuki0iq/gitoxide/commit/7242d1f4acb4ac0d2585295c11f36436a1215a7a))
    - Refactor ([`c02a6bd`](https://github.com/yuki0iq/gitoxide/commit/c02a6bdcc3669a48cd4b5b640280701fd089575d))
    - [refactor] Deduplicate Tag and TagRef ([`6003fa2`](https://github.com/yuki0iq/gitoxide/commit/6003fa22085b5031565c51b2b5a0a9feb1579fb0))
    ...
    - Merge branch 'pierrechevalier83/main' ([`f0dfa4c`](https://github.com/yuki0iq/gitoxide/commit/f0dfa4c17be4d4a15fb2117bfc47b2fea1bc48fb))
    - [git-object] Encode empty tags like git does ([`3bd3380`](https://github.com/yuki0iq/gitoxide/commit/3bd33802e072b06d278b93eeae8cfaed19795d6b))
    ...
    - Adapt in-memory size check to Rust 1.65 and below ([`1919e8e`](https://github.com/yuki0iq/gitoxide/commit/1919e8ec2f6bca8237a0356972b86f28c18da908))
    - `Object::try_into_blob_ref()` as alternative to consuming `*::try_into_blob()` ([`14d6133`](https://github.com/yuki0iq/gitoxide/commit/14d613303b8663daac1ab1eed8413266594050c3))
    ...
    - Merge branch 'fix-loose-parsing' ([`1dc2a5d`](https://github.com/yuki0iq/gitoxide/commit/1dc2a5db9efa2cfb90a8b9fbeaca5200d35daed9))
    - Don't panic if broken loose objects are encountered. ([`2df3c73`](https://github.com/yuki0iq/gitoxide/commit/2df3c7395a791c751b22187a936facbce9f3f168))
    - Don't panic on too short loose object ([`c89c7ff`](https://github.com/yuki0iq/gitoxide/commit/c89c7fface26660d1855915b871dbf758150ab6f))
    - Merge branch 'fix-git-features' ([`82fd251`](https://github.com/yuki0iq/gitoxide/commit/82fd251ac80d07bc9da8a4d36e517aa35580d188))
    - Merge branch 'main' into fix-odb-race ([`30712dc`](https://github.com/yuki0iq/gitoxide/commit/30712dc9ab952d29c528ec58bcc467b425489304))
    - Add `tree::EntryMode::is_blob()` to quickly determine if an entry is a blob. ([`5095df9`](https://github.com/yuki0iq/gitoxide/commit/5095df949d30b57b09bd68355743d255a897365f))
    ...
    - Refactor ([`867fc20`](https://github.com/yuki0iq/gitoxide/commit/867fc208e8542668adcc81f8c03dd4957e956ef7))
    ...
    - Erge branch 'fix-describe' ([`56d7ad7`](https://github.com/yuki0iq/gitoxide/commit/56d7ad7a2e7994545581ad5955c25feb9cefdf4e))
    - Release git-actor v0.9.0, git-object v0.18.0 ([`ef9242b`](https://github.com/yuki0iq/gitoxide/commit/ef9242bdb35c02afc36af7c59073d78091fbf504))
    ...
    - Thanks clippy ([`3079e11`](https://github.com/yuki0iq/gitoxide/commit/3079e114dc1d2552e023aa793dc10c28258b34da))
    ...
    - Merge branch 'oknozor-feat/traversal-sort-by-committer-date' ([`6add377`](https://github.com/yuki0iq/gitoxide/commit/6add3773c64a9155c236a36bd002099c218882eb))
    - Add sorting mode to ancestor traversal  #270 ([`eb36a3d`](https://github.com/yuki0iq/gitoxide/commit/eb36a3dda83a46ad59078a904f4e277f298a24e1))
    - Rename `commit::ref_iter::Token::into_id()` to `*::try_into_id()` ([`fda2a8d`](https://github.com/yuki0iq/gitoxide/commit/fda2a8d2f5f8b7d80b4cc0177d08d6a061f1b8f1))
    ...
    - Merge branch 'header-field-multi-improve' of https://github.com/xmo-odoo/gitoxide into xmo-odoo-header-field-multi-improve ([`d88e377`](https://github.com/yuki0iq/gitoxide/commit/d88e377c21e566bf86c274d5e87eff06100698b9))
    - Improve error handling of encode::header_field_multi_line & simplify ([`bab9fb5`](https://github.com/yuki0iq/gitoxide/commit/bab9fb567e47bb88d27b36f6ffa95c62c14ed80a))
    ...
    - Thanks clippy ([`d78d382`](https://github.com/yuki0iq/gitoxide/commit/d78d3828c7f80963c0b8803cb64e0ae5e08d0ba3))
    - Thanks clippy ([`4ea1126`](https://github.com/yuki0iq/gitoxide/commit/4ea11264296063278977c5539e2d68367475464a))
    - Thanks clippy ([`e56af5a`](https://github.com/yuki0iq/gitoxide/commit/e56af5a0846652f177a88771d495bff5973abde3))
    - [object #164] refactor ([`883343b`](https://github.com/yuki0iq/gitoxide/commit/883343bbbae431cfb8ffb16f0d39838b0d7636d7))
    ...
    - Thanks clippy ([`33a8fb3`](https://github.com/yuki0iq/gitoxide/commit/33a8fb34708407fd6b9a9ddabeaab51409aa1b03))
    - [object #164] Allow referenced objects to be serialized as well ([`a98d298`](https://github.com/yuki0iq/gitoxide/commit/a98d2985dae2259d72bb91a01548906862fee9f7))
    - Release git-object v0.13.1 ([`2c55ea7`](https://github.com/yuki0iq/gitoxide/commit/2c55ea759caa1d317f008966ae388b3cf0ce0f6d))
    ...
    - [object #190] consistent method naming ([`c5de433`](https://github.com/yuki0iq/gitoxide/commit/c5de433e569c2cc8e78f3f84e368a11fe95f522a))
    ...
    - [repository #190] A way to write objects and the empty tree specifically ([`7c559d6`](https://github.com/yuki0iq/gitoxide/commit/7c559d6e1b68bc89220bca426257f383bce586ae))
    ...
    - [object #177] resolve 'mutable' module ([`b201b32`](https://github.com/yuki0iq/gitoxide/commit/b201b3260e3eec98ed71716c1aab1ba4a06ab829))
    - [object #177] refactor ([`216dd0f`](https://github.com/yuki0iq/gitoxide/commit/216dd0f10add7a11ebdf96732ed7649d74815d64))
    - [object #177] refactor ([`472e13b`](https://github.com/yuki0iq/gitoxide/commit/472e13b27e97a196c644d716cad1801bd62fac71))
    - [object #177] Commit::write_to migration ([`60b9365`](https://github.com/yuki0iq/gitoxide/commit/60b936553bef3c9126d46ece9779f08b5eef9a95))
    ...
    - [object #177] refactor tag write_to ([`7f19559`](https://github.com/yuki0iq/gitoxide/commit/7f1955916ae9d7e17be971170c853487e3755169))
    ...
    - [smart-release #162] use TreeRef capabilities to lookup path ([`51d1943`](https://github.com/yuki0iq/gitoxide/commit/51d19433e6704fabb6547a0ba1b5c32afce43d8b))
    - [repository #162] what could be a correct implementation of a tree path lookup ([`1f638ee`](https://github.com/yuki0iq/gitoxide/commit/1f638eee0aa5f6e1cc34c5bc59a18b5f22af4cbc))
    - Release git-object v0.12.2 ([`6e58edd`](https://github.com/yuki0iq/gitoxide/commit/6e58edde2d7c881a6b957b7efafb63e2f517c9b4))
    - [object] argh, remove these tests for now no time for this ([`13d627d`](https://github.com/yuki0iq/gitoxide/commit/13d627d19aae3bb9d44ed0e9304e373e90f51547))
    - [object] simply exclude the feature from testing for now… ([`adba3b9`](https://github.com/yuki0iq/gitoxide/commit/adba3b982c4b21889615afafcfcaa7ae1f91661d))
    - [object] fix magically smaller object size expectation ([`bf4d2d7`](https://github.com/yuki0iq/gitoxide/commit/bf4d2d7c0a33a3f35646f776edce4b829f086f66))
    - Apply nightly rustfmt rules. ([`5e0edba`](https://github.com/yuki0iq/gitoxide/commit/5e0edbadb39673d4de640f112fa306349fb11814))
    - Release git-object v0.12.1 ([`086baa2`](https://github.com/yuki0iq/gitoxide/commit/086baa261d0874e541e374d51d427727aa37a8ee))
    ...
    - [ref] fix build (bad find&replace) ([`467395f`](https://github.com/yuki0iq/gitoxide/commit/467395f19ce13ff8cd62499573d3cd4cb2e7797f))
    ...
    - Thanks clippy ([`c437304`](https://github.com/yuki0iq/gitoxide/commit/c43730496ac5e1f7e66ee226099a4e99e151e97d))
    - [object] Add feature toggle for verbose errors… ([`4b63d8a`](https://github.com/yuki0iq/gitoxide/commit/4b63d8a8709a2674d287879c4d6538a74cd7869b))
    - [object] support for verbose errors for object parsing ([`8156f10`](https://github.com/yuki0iq/gitoxide/commit/8156f1037b87424864db73888108be12dedb5169))
    - [object] refactor ([`6f63983`](https://github.com/yuki0iq/gitoxide/commit/6f639835362224bade27dd4f45c275544a39625d))
    - [object] Generalize nom error handling and use nom-errors instead of custom ones ([`47c8a97`](https://github.com/yuki0iq/gitoxide/commit/47c8a97194c9e401ee311234a269f8b8f3650ba1))
    - [object] remove unused dependencies ([`2f01e46`](https://github.com/yuki0iq/gitoxide/commit/2f01e46a9b30f1231adf1e79c5923843e63cad86))
    - [object] cleanup parsing error handling by removing NomDetail ([`e91cb40`](https://github.com/yuki0iq/gitoxide/commit/e91cb405381d84bc1021c3ac30dfe6061788f9b1))
    - [object] refactor ([`1ddb5c0`](https://github.com/yuki0iq/gitoxide/commit/1ddb5c07b75aa2b9a9536125fbba1fc862b7fe34))
    - [object] replace custom context impl with the one by nom ([`9a6692d`](https://github.com/yuki0iq/gitoxide/commit/9a6692d034976dbcf011b587140c7f47fbc583e2))
    - [object] refactor ([`8205429`](https://github.com/yuki0iq/gitoxide/commit/8205429b2ac160525a7449e50edf04aaf027f12c))
    ...
    - (cargo-release) version 0.2.0 ([`1327894`](https://github.com/yuki0iq/gitoxide/commit/132789475400abe660b30ef6d2c5ff57821dd2c4))
    - [git-object] use git-validate crate ([`4ba98e8`](https://github.com/yuki0iq/gitoxide/commit/4ba98e824417d1c58998fabee88549700a714bcf))
    - [git-object] refactor ([`d64d326`](https://github.com/yuki0iq/gitoxide/commit/d64d3266167ee224b651cc24c4dbc8d88c9c9876))
    ...
    - [git-ref] clear it out and move existing functionality to git-object ([`fa548ce`](https://github.com/yuki0iq/gitoxide/commit/fa548ce94db3dd3969add494756fcc34e48985a3))
    - (cargo-release) version 0.5.0 ([`b6b5856`](https://github.com/yuki0iq/gitoxide/commit/b6b58560b7c3bc88e2b8b780be5ceb4cb508a346))
    - [pack-gen] refactor ([`61554e2`](https://github.com/yuki0iq/gitoxide/commit/61554e2effcbafef9cff0b407351c2fae0d2916c))
    ...
    - [pack-gen] more tests for Tag iterator ([`b69d6d6`](https://github.com/yuki0iq/gitoxide/commit/b69d6d6590ea9d8de4a50e31ab9f331a2e21faab))
    ...
    - Allow empty trees when parsing them at once, fixes #79 ([`d34fd19`](https://github.com/yuki0iq/gitoxide/commit/d34fd19db5b3802ae9c677a6cf481f42e8a7e073))
    - Refactor ([`9870923`](https://github.com/yuki0iq/gitoxide/commit/9870923ce02d20beb98be5e4bb76ff8081804054))
    - [hours-demo] computation seems to work better now ([`26ecca2`](https://github.com/yuki0iq/gitoxide/commit/26ecca2133af287ddc9146fb3a3fc73dddc945e9))
    - Refactor ([`2d00c4e`](https://github.com/yuki0iq/gitoxide/commit/2d00c4ed6be5baa1c3389a61102e25eb7d543465))
    - [hours-demo] Maybe the pinnacle of performance… ([`f70c61a`](https://github.com/yuki0iq/gitoxide/commit/f70c61ab56b4153030d524da69a514a667c6abb7))
    - Remove debug-assert which doesn't hold - it's OK to have empty commit messages ([`13abc2d`](https://github.com/yuki0iq/gitoxide/commit/13abc2d70c9aa42fb76e71d44c9c711e2780a5ba))
    - And it's a wrap for git-diff docs for now ([`9e09dd5`](https://github.com/yuki0iq/gitoxide/commit/9e09dd560a23d52d0469ce4fc13de01f7efce227))
    - [traversal] first impl based on git-odb::traver ([`76a3017`](https://github.com/yuki0iq/gitoxide/commit/76a3017b60d41957f5fea56bf7b2b2bf41aae0d5))
    - A new crate: git-traverse ([`1a9af50`](https://github.com/yuki0iq/gitoxide/commit/1a9af50f1fca0e7e939f339b885c66dcb95e44e5))
    ...
    - [traversal] add CommitIter::tree_id() convenience method ([`6affd9d`](https://github.com/yuki0iq/gitoxide/commit/6affd9d90d56d89774fcd4843638309a198815bf))
    - [traversal] trying to get things done with gitoxide shows some teeth… ([`3fee661`](https://github.com/yuki0iq/gitoxide/commit/3fee661af8d67e277e8657606383a670f17e7825))
    - Refactor; better iter error handling tests ([`9fe139b`](https://github.com/yuki0iq/gitoxide/commit/9fe139b85c350c8cbb78975a94f4548130764b1c))
    ...
    - Test error handling of commit iteration ([`fcec4b4`](https://github.com/yuki0iq/gitoxide/commit/fcec4b43f7c1d72680431ec3522b0db94728507f))
    - Thanks clippy ([`41418ed`](https://github.com/yuki0iq/gitoxide/commit/41418ede15be9d0d18e49c34e4482c5701851404))
    - Fix serde support for commit iter token ([`3bfcb49`](https://github.com/yuki0iq/gitoxide/commit/3bfcb49814ed5f14dd66206a54a9b85f13edd9d9))
    - [tree-diff] all the tests for commit iter ([`7ebea87`](https://github.com/yuki0iq/gitoxide/commit/7ebea87b91c7cae3378fa3a5780d6c58e319c006))
    - [tree-diff] more tests ([`4f81450`](https://github.com/yuki0iq/gitoxide/commit/4f81450b13bfc14cede1bec3234d33ec0844ac3d))
    - [tree-diff] And there is a working commit iterator, needs more tests ([`d991847`](https://github.com/yuki0iq/gitoxide/commit/d99184782e9e79b517b7703ab41fefdc2424994e))
    - [tree-diff] A complete nearly working impl of a Commit iterator ([`4711821`](https://github.com/yuki0iq/gitoxide/commit/4711821dd54193737cff76ce904b18d29b518ac2))
    - Frame for Commit iterator ([`796b74a`](https://github.com/yuki0iq/gitoxide/commit/796b74a09cf1b4c8c4694d877a76da94d425bdc0))
    - First failing test for commit iterator; store two parents without alloc ([`8337514`](https://github.com/yuki0iq/gitoxide/commit/8337514378148d72dc7f6d7474d6d0b794759589))
    - [tree-diff] one more test green + refactor ([`bc5549d`](https://github.com/yuki0iq/gitoxide/commit/bc5549db2ad16222761219d8652caf64867a889f))
    ...
    - [tree-diff] prototype an immutable tree iterator to avoid entry allocs ([`f38e5cd`](https://github.com/yuki0iq/gitoxide/commit/f38e5cdcd072873707a21f0b73c491ef1f1c7a8f))
    - [tree-diff] A step closer to handling additions in a directory ([`a11f210`](https://github.com/yuki0iq/gitoxide/commit/a11f210bec2c6c55bcf8cebe00e116e835306360))
    - Refactor ([`a4d5f99`](https://github.com/yuki0iq/gitoxide/commit/a4d5f99c8dc99bf814790928a3bf9649cd99486b))
    - Refactor ([`633cba7`](https://github.com/yuki0iq/gitoxide/commit/633cba7c1ff1f63c32613bedf963d1bd89afaee1))
    - First sketch of diff API ([`fc3f2b7`](https://github.com/yuki0iq/gitoxide/commit/fc3f2b7066538e31f8d4bb1053d70dcabd5fbab1))
    ...
    - Thanks clippy ([`8295548`](https://github.com/yuki0iq/gitoxide/commit/829554805520170f69cadc61e6be5e7255737cff))
    - Refactor ([`9d03843`](https://github.com/yuki0iq/gitoxide/commit/9d03843eeae388738d70b4251166081542893749))
    - Fix debug assert, thanks gitpython ([`fe954b9`](https://github.com/yuki0iq/gitoxide/commit/fe954b9f6d26bd8629f24a01bd2a06f9800deed0))
    - More explicit expectations towards entries in mutable Trees ([`d94f84c`](https://github.com/yuki0iq/gitoxide/commit/d94f84ceac637d2b6495be01dfc8eeb2494922f2))
    - Refactor ([`f19ea33`](https://github.com/yuki0iq/gitoxide/commit/f19ea33709f7c31873e46d896ed7b6d06607f1e7))
    ...
    - Thanks clippy ([`cefbf3e`](https://github.com/yuki0iq/gitoxide/commit/cefbf3e02edebd1875cd2762eb231e6c379b1ebb))
    - Upgrade depdendencies ([`e4a7711`](https://github.com/yuki0iq/gitoxide/commit/e4a77112ee4f5d0ab61d0678aab8ee090335740c))
    - Improved high-level docs for git-object ([`60036f2`](https://github.com/yuki0iq/gitoxide/commit/60036f20328600f0faaaf21ca30f1b9d0275d15f))
    ...
    - First round of git-object doc proof reading ([`524ce51`](https://github.com/yuki0iq/gitoxide/commit/524ce51eb3e606b1225a23fce62df2199799d4f3))
    - (cargo-release) version 0.5.0 ([`fc7d600`](https://github.com/yuki0iq/gitoxide/commit/fc7d600ac2c438c8b6b91f67cb69b0ac5ec37675))
    - `deny(missing_docs)` for git-object ([`8525684`](https://github.com/yuki0iq/gitoxide/commit/8525684c6c69677f3e1b40a3673a817e111e9bff))
    - More docs for owned git-object ([`b79101d`](https://github.com/yuki0iq/gitoxide/commit/b79101d714f59a42a30eb47776486a212ec0f738))
    - A few more comments in git-object ([`171d269`](https://github.com/yuki0iq/gitoxide/commit/171d269e428f711b163f6644ebf0c44c1279d497))
    ...
    - More git-object docs ([`ba595f6`](https://github.com/yuki0iq/gitoxide/commit/ba595f6d4864eafc64f31460f7192cb48abd408a))
    - More docs of git-object::owned ([`0620dce`](https://github.com/yuki0iq/gitoxide/commit/0620dce7a3ac368354c73e3927eb96a6e4990f0c))
    - Docs for git-object::borrowed ([`68e524d`](https://github.com/yuki0iq/gitoxide/commit/68e524d079fe9042ebba1e33457f934a64018623))
    - Docs for git-object::borrowed::commit ([`c5c1df0`](https://github.com/yuki0iq/gitoxide/commit/c5c1df031aa391e0e65d0540f8414cbd1d1aa39f))
    ...
    - Add and use borrowed::Id::null_sha1() ([`c717492`](https://github.com/yuki0iq/gitoxide/commit/c717492d0038f55a6f21b48937b56a756890d214))
    - Updated `expect` message ([`e8d8d93`](https://github.com/yuki0iq/gitoxide/commit/e8d8d9351168b5423c44626ed8ac81cf7b013a02))
    - Update error message for type name ([`92cbb13`](https://github.com/yuki0iq/gitoxide/commit/92cbb1314657abaad560d068e7395a70769f0592))
    ...
    - Refactor ([`e4bcfe6`](https://github.com/yuki0iq/gitoxide/commit/e4bcfe6406b14feffa63598c7cdcc8ecc73222bd))
    - (cargo-release) version 0.4.0 ([`0d7b60e`](https://github.com/yuki0iq/gitoxide/commit/0d7b60e856325009431172e1df742a1cd2165575))
    - (cargo-release) version 0.4.0 ([`f9dd225`](https://github.com/yuki0iq/gitoxide/commit/f9dd225afc4aafde1a8b8148943f56f2c547a9ea))
    ...
    - Refactor ([`a0bebd1`](https://github.com/yuki0iq/gitoxide/commit/a0bebd17500bccc08ed5a1c16e2ffcde89c71052))
    ...
    - (cargo-release) version 0.2.0 ([`d350a13`](https://github.com/yuki0iq/gitoxide/commit/d350a13784685ea82b84646b18736986aeb68146))
    - Beautifully implement shared extra-header access ([`920d1ac`](https://github.com/yuki0iq/gitoxide/commit/920d1accc92d67019f0e654f8c4ab5c95d798925))
    ...
    - Make sure we write out trailing newlines properly in multi-line headers! ([`7f044c3`](https://github.com/yuki0iq/gitoxide/commit/7f044c36279aadfd7a2ebeecedd7f2c20b2b7b52))
    ...
    - Support for very special tree entry mode… ([`2be2c9d`](https://github.com/yuki0iq/gitoxide/commit/2be2c9d31563b147f0f2a5c1cd03279c79f1dd6b))
    ...
    - Abiility to read mergetags (for now only these) as extra-headers ([`bd3a2db`](https://github.com/yuki0iq/gitoxide/commit/bd3a2db1068ce7509612ef1be0a108b7bb45ed49))
    ...
    - Empty trees are allowed, and they are special, too ([`6bed200`](https://github.com/yuki0iq/gitoxide/commit/6bed200ec1a528574edabf5783e9ebfb00add56d))
    - Refactor ([`56b66ac`](https://github.com/yuki0iq/gitoxide/commit/56b66ac069f24635a8fa74b4b2231dfb0a82a1ef))
    - Basic top-level object round-tripping ([`e851cbe`](https://github.com/yuki0iq/gitoxide/commit/e851cbe585525b3e50114eb8d2a0662149bf2019))
    - Refactor ([`ec5e50f`](https://github.com/yuki0iq/gitoxide/commit/ec5e50f607d59302d6db3944f6ea7b667f820927))
    - Implement blob ([`f30caf4`](https://github.com/yuki0iq/gitoxide/commit/f30caf4ff69fee36e65a2e404910b88e06d539bc))
    - Refactor ([`335e98a`](https://github.com/yuki0iq/gitoxide/commit/335e98ab3a2e9c05141f1cd218197079bb51cfa5))
    - Tree roundtrip ([`8b26a0e`](https://github.com/yuki0iq/gitoxide/commit/8b26a0e16c838270290cb3ac02b029100afe6b46))
    ...
    - Manual deserialize implementation, for now ([`9f46efd`](https://github.com/yuki0iq/gitoxide/commit/9f46efd625d45a9ad947e9f7bc6f31f4426f3cfc))
    ...
    - Commit round-tripping works with multi-line signatures ([`b692b0a`](https://github.com/yuki0iq/gitoxide/commit/b692b0aa3f38507697096e671c990700d25933c8))
    - First attempts to roundtrip signatures shows I parse it wrongly :D ([`1b48367`](https://github.com/yuki0iq/gitoxide/commit/1b48367d02fde977ed4acab63e295c0c5feec357))
    ...
    - First attempt to round-trip multi-line headers ([`645ef94`](https://github.com/yuki0iq/gitoxide/commit/645ef946653caf2eed571d83c61e8b7d7c1cf4b4))
    - Single-line header support ([`478c09e`](https://github.com/yuki0iq/gitoxide/commit/478c09e54cc73dcc5cce7aea6bc0702882c5f882))
    - The first basic version of commit serialization ([`5319f64`](https://github.com/yuki0iq/gitoxide/commit/5319f64036e09bce97285db19f30f988a5039761))
    - Make reusing round-trip code easier ([`3b9d66c`](https://github.com/yuki0iq/gitoxide/commit/3b9d66c932075feb08cdf2967f7698daef9fd3ff))
    - Refactor ([`987787e`](https://github.com/yuki0iq/gitoxide/commit/987787e3084bbfc948ed3ca464909a2912f7b653))
    - Fix tests on windows, by ignoring them ([`512ed6c`](https://github.com/yuki0iq/gitoxide/commit/512ed6c915b3db2cd3353ea23b945652ad1bef50))
    ...
    - Tags can write signatures ([`a48275e`](https://github.com/yuki0iq/gitoxide/commit/a48275e65bee7f544c19bc81307660ed4f60b8fa))
    - Tags can write a message properly ([`b590b77`](https://github.com/yuki0iq/gitoxide/commit/b590b779a6f168db377bf5b4b796a4813bd19ccb))
    - Green tests as basic tags can now be serialied ([`62a02b4`](https://github.com/yuki0iq/gitoxide/commit/62a02b490055d9b95a5aae3cbe1641f42ff69df8))
    - More tests for signature serialization ([`5000f30`](https://github.com/yuki0iq/gitoxide/commit/5000f30bd0085c0afacf2c32d8a31224ec7337d0))
    - Time serialization ([`1eb1e36`](https://github.com/yuki0iq/gitoxide/commit/1eb1e36992f9973977b4d94d55348b7a3eecd3fb))
    - Prepare writing of time as part of signature ([`f560bc5`](https://github.com/yuki0iq/gitoxide/commit/f560bc50a2a2e4c9697c17b59ec5cf4122992fab))
    - Add new 'git-ref' crate; place ref name validation code there ([`1a0e84e`](https://github.com/yuki0iq/gitoxide/commit/1a0e84e627b17be1b1fb53b4dc98ab78e9cfb9a7))
    - Refactor ([`b4392e8`](https://github.com/yuki0iq/gitoxide/commit/b4392e880ed67464af9e8cfa2e343d10f23a949f))
    - Some more boilerplate to actually implement complete ref name checking ([`087857a`](https://github.com/yuki0iq/gitoxide/commit/087857a56654537fdfb5bfa6c66745184027517f))
    - Very basic first steps of validated serialization ([`d3fd5ff`](https://github.com/yuki0iq/gitoxide/commit/d3fd5ffe10015e2a13200a1fef5bd903532f81af))
    - It's probably OK to consume the borrowed objects when converting them to owned ([`101ddd5`](https://github.com/yuki0iq/gitoxide/commit/101ddd586d4250aa5b3c8c6f8076456ae997faec))
    - Try basics of roundtrip without consuming the source object ([`581794e`](https://github.com/yuki0iq/gitoxide/commit/581794efcf4577c21f2ff078ba7844a71b47c0aa))
    - Refactor ([`bca1f16`](https://github.com/yuki0iq/gitoxide/commit/bca1f16a6f3da497e3488e333d5ebc99e39ee689))
    - First sketch of owned Tag in preparation for round-tripping ([`fa2745a`](https://github.com/yuki0iq/gitoxide/commit/fa2745a5d5f7b6c4e02177e4080db7df6603b9fc))
    - Refactor ([`90ae25d`](https://github.com/yuki0iq/gitoxide/commit/90ae25d39aa4540fc2785eb7cb189eee102895c0))
    - Refactor ([`256581b`](https://github.com/yuki0iq/gitoxide/commit/256581bad6692a458b331b712d16ce2d5143cb75))
    ...
    - Apply cargo-diet (better late than never :D) ([`295fc81`](https://github.com/yuki0iq/gitoxide/commit/295fc81a2e0e31d6d83eba7e169dc4ed05038083))
    ...
    - Fixup text file tests on windows ([`2288088`](https://github.com/yuki0iq/gitoxide/commit/22880881d5e442acdeb8dd0cfb5ecc4f62783951))
    ...
    - Cut back on onnecessary annnotations: serde(borrow) ([`759915c`](https://github.com/yuki0iq/gitoxide/commit/759915c75e473f65d35ba926aaca8303e5a77f9a))
    - Serde support for all git-object types, incl. test ([`1ae8f9c`](https://github.com/yuki0iq/gitoxide/commit/1ae8f9c8b6b699c3f4928905358f42187bef07a7))
    - Learn from the best: with-serde -> serde1 ([`d651c21`](https://github.com/yuki0iq/gitoxide/commit/d651c218bfb7af5fc67ca4b9763703fb29788017))
    ...
    - Add support for miniserde ([`f806647`](https://github.com/yuki0iq/gitoxide/commit/f80664769e4fdbab3d1ffa56510ba87e570ae9b0))
    - First gentle test of adding serde support selectively. ([`78d9bc0`](https://github.com/yuki0iq/gitoxide/commit/78d9bc0f54504dc809651aeb0d24e7ac6a3f0bb3))
    ...
    - Implement object Id as newtype for more convenenience and… ([`b7a4d17`](https://github.com/yuki0iq/gitoxide/commit/b7a4d17d886d555b080e4182d49dc648e201ad13))
    - Rename grit to 'gitoxide', CLI name is 'gio' ([`9d6007f`](https://github.com/yuki0iq/gitoxide/commit/9d6007f83b3b018d736d58aa0722b83b9cffb228))
    ...
    - Even better trait derives ([`e78f9f6`](https://github.com/yuki0iq/gitoxide/commit/e78f9f64c8d52402197b1f946bcd32f0d83e6c7d))
    - Better trait support for basic types ([`6617386`](https://github.com/yuki0iq/gitoxide/commit/6617386e37b69f6e036ab27280c946e271c99540))
    ...
    - Refactor ([`2ffd7fa`](https://github.com/yuki0iq/gitoxide/commit/2ffd7fa6c4e5a88042b7ee1d56ec8d8515f0991f))
    - Refacto ([`ffc0089`](https://github.com/yuki0iq/gitoxide/commit/ffc0089fd7f4ffd3eeb0d0411b6857a28b388001))
    ...
    - Move git-object tests to top-level for separation and cleanness ([`df42a01`](https://github.com/yuki0iq/gitoxide/commit/df42a012bcc489b78320126e51b1f121abe7c018))
    - Prefer integration level tests, but use unit-tests where appropriate ([`ec3be19`](https://github.com/yuki0iq/gitoxide/commit/ec3be19c8d007565b814b4757f17811ec0e9de2c))
    - Run previously unused method of Tree ([`0d159c2`](https://github.com/yuki0iq/gitoxide/commit/0d159c2b76f2a8fc3c391fd990d8e7a4eeffc913))
    - Actually use the Tree object ([`635e735`](https://github.com/yuki0iq/gitoxide/commit/635e735419af906579de681dbc27b36fd826406d))
    ...
    - Handle tags without newline; document fixture processing step ([`344a562`](https://github.com/yuki0iq/gitoxide/commit/344a5622953047e6f2a543bfb0355fb060a4b1e8))
    - Don't assume newlines in trees anymore ([`45d7c36`](https://github.com/yuki0iq/gitoxide/commit/45d7c365072a9bada3a6e0b77ced7669fe5533a3))
    - Found huge issue with newlines polluting fixtures. ([`f182d22`](https://github.com/yuki0iq/gitoxide/commit/f182d22caf1dd9c262cdca6a1834478556a74f31))
    - First tree implementation, which seems to work well ([`9694fcb`](https://github.com/yuki0iq/gitoxide/commit/9694fcbeb7bea6ebf814119ba5757110ae33bc55))
    - Boilerplate for tree parsing ([`48c4c07`](https://github.com/yuki0iq/gitoxide/commit/48c4c07098d807b3d62e540e06459c66fef94355))
    - Refactor ([`d48cafa`](https://github.com/yuki0iq/gitoxide/commit/d48cafa7edc4c6d977c396df4a26d235a3bd662c))
    - Add conversion traits for Object<->Tag|Commit ([`7dcbd5d`](https://github.com/yuki0iq/gitoxide/commit/7dcbd5dc764a07685a66594e3ae5514a9df83082))
    ...
    - Use smallvec to save memory in the common case (single parent) ([`263835b`](https://github.com/yuki0iq/gitoxide/commit/263835b7e14e94bfb641067e8188e23d81bc9cac))
    - More tests ([`56248fe`](https://github.com/yuki0iq/gitoxide/commit/56248fe9a351572478cecda8520c25ec25664bc3))
    - Now gpg-signature parsing works correctly - thanks to peek(…) ([`7078dac`](https://github.com/yuki0iq/gitoxide/commit/7078dac0fc27594c63cd9550c8b8b4ac7a52a627))
    - First somewhat working version of single/multi-line signature parsing ([`dab5c65`](https://github.com/yuki0iq/gitoxide/commit/dab5c6581dc218ee9a7f049c5499975f762d81cf))
    - Support single-line gpg signatures ([`71330b5`](https://github.com/yuki0iq/gitoxide/commit/71330b526614a78e20e739aa8b1cd31b5cf2ce0e))
    - Support for commit encoding field ([`40bffe9`](https://github.com/yuki0iq/gitoxide/commit/40bffe9b36f5afcb9b3f147d47b94b5e82acaae8))
    - More commit tests, next up: encoding ([`ca4d3aa`](https://github.com/yuki0iq/gitoxide/commit/ca4d3aad8f91189890b8445680406fddb6544af4))
    - First successful parsing of commit ([`b44765a`](https://github.com/yuki0iq/gitoxide/commit/b44765ad08f53a7062def35ecb7fe7624827df85))
    - Parse BStr versions of hex-shas directly ([`e3a2b77`](https://github.com/yuki0iq/gitoxide/commit/e3a2b7782fa48f474c2e1d51a6b8c2ea2c561549))
    - Parse parents ([`696e0a3`](https://github.com/yuki0iq/gitoxide/commit/696e0a3c48e72373cb540d16b640ddb6fc2a2dcf))
    - Use BStr instead of Id to avoid parsing into something we might not use/need ([`7c97471`](https://github.com/yuki0iq/gitoxide/commit/7c97471c34362c9d3d56ccada252d3058aea6697))
    - Factor out hex sha parsing ([`d650dd2`](https://github.com/yuki0iq/gitoxide/commit/d650dd26a168ab5a8d679dfb4b93a7f2863a20f0))
    - Refactor ([`0104f4c`](https://github.com/yuki0iq/gitoxide/commit/0104f4c8a8449c2549bfcfeacfeb20f14b2ddc2d))
    - First stab at factoring header parsing into sub-parser ([`6f6ee8f`](https://github.com/yuki0iq/gitoxide/commit/6f6ee8f721df9f3caf4db54346e7653f341552e3))
    - First fixtures for commit parsing ([`551f2d1`](https://github.com/yuki0iq/gitoxide/commit/551f2d1f8e32e7e64a0d19e9e7d3b3ea63e9b449))
    ...
    - Add remaining tag tests, along with some fixes ([`06e22fb`](https://github.com/yuki0iq/gitoxide/commit/06e22fb8aea281676e53f786ddb808dd77d3b702))
    - Use bstr were possible ([`01dd4e2`](https://github.com/yuki0iq/gitoxide/commit/01dd4e2a978a9f5bd773dae6da7aa4a5ac1cdbbc))
    ...
    - Refactor ([`683360a`](https://github.com/yuki0iq/gitoxide/commit/683360a6932f7d5e216dc0fdafa5890c6708d1e8))
    - Move all tests into the top-level for nicer names basically :D ([`598901a`](https://github.com/yuki0iq/gitoxide/commit/598901a768fec768b2519e7925ac623cb66582d6))
    - Refactor ([`0f01e9f`](https://github.com/yuki0iq/gitoxide/commit/0f01e9fff39fb7f1234f57c6689c0e114d9aece7))
    - Refactor ([`87bbea4`](https://github.com/yuki0iq/gitoxide/commit/87bbea48d247b7938e74672e1a5cb1b8b5cc6a9f))
    - Refactor; add more signature parsing tests ([`ba9c7de`](https://github.com/yuki0iq/gitoxide/commit/ba9c7de7ca93ac42d3c57315d743b321f8f9e3b5))
    - Cleanup; all tests work! ([`7c96603`](https://github.com/yuki0iq/gitoxide/commit/7c9660354484869681356a8c4ef8057313e864f2))
    - Fix whitespace ([`ebaaa00`](https://github.com/yuki0iq/gitoxide/commit/ebaaa00d9508141746a7c20e5d25d877f38733e9))
    ...
    - Implement parse_signature with nom, starting to like it ([`ebdf205`](https://github.com/yuki0iq/gitoxide/commit/ebdf205038b66108c0331aa590388431427493b7))
    - First part of parsing tagger signatures ([`5b43270`](https://github.com/yuki0iq/gitoxide/commit/5b432703cf1c44bbf29e8bf89b297ea29c959be6))
    - Generalize with Boxed error cause ([`824cd2c`](https://github.com/yuki0iq/gitoxide/commit/824cd2cfbfaef605e953f0af193a036ef74bcac7))
    - First seemingly awkward way of not discarding too much error information… ([`6f9a636`](https://github.com/yuki0iq/gitoxide/commit/6f9a636da5c2f33a612395a25e8b92e557d06e83))
    - Refactor ([`fb287af`](https://github.com/yuki0iq/gitoxide/commit/fb287af33fcb75c01ac25dd484f529cbb49f3e6f))
    - The first sketch of parsing a tag with Nom and half-decent errors ([`4498dff`](https://github.com/yuki0iq/gitoxide/commit/4498dff1cf63abe53ae17b59d3658ab52235630d))
    - Use git-object in git-odb ([`07f7c31`](https://github.com/yuki0iq/gitoxide/commit/07f7c318d55603e3731f08cb04d3da8ac2fcfea6))
    - Move all object related code into own crate… ([`605ef20`](https://github.com/yuki0iq/gitoxide/commit/605ef20ec5ccf66e4f42df6d0140e4087aa13053))
</details>
