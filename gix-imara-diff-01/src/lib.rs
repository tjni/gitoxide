...
//!
//! ```
//! use gix_imara_diff_01::intern::InternedInput;
//! use gix_imara_diff_01::{diff, Algorithm, UnifiedDiffBuilder};
//!
...
//! ```
//! use gix_imara_diff_01::intern::InternedInput;
//! use gix_imara_diff_01::sink::Counter;
//! use gix_imara_diff_01::sources::lines_with_terminator;
//! use gix_imara_diff_01::{diff, Algorithm, UnifiedDiffBuilder};
//!
//! let before = "foo";
//! let after = "foo\n";
