 ...
 * **[#450](https://github.com/yuki0iq/gitoxide/issues/450)**
    ...
    - `fetch::Ref::unpack()` returns `Option<oid>`. ([`cd867ad`](https://github.com/yuki0iq/gitoxide/commit/cd867ade55eaec138029c0cf17fa83e0679ef7fc))
 ...
 * **Uncategorized**
    ...
    - [protocol] start trying LsRefsAction::Abort(Box<dyn Error>)… ([`660b9dc`](https://github.com/yuki0iq/gitoxide/commit/660b9dcc4e5249506a7656b038333f64b109261d))
